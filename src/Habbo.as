package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_6:String = "client.init.swf.error";
      ...
      public static const const_19:String = "crash_time";
      
      public static const const_17:String = "error_ctx";
      
      public static const const_13:String = "flash_version";
      ...
      public static const const_20:String = "error_cat";
      ...
      public static const const_7:String = "byteBarSprite";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_19] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_17] = _loc7_;
            _loc6_[const_13] = Capabilities.version;
            _loc6_[const_15] = 0;
            _loc6_[const_12] = param1;
            _loc6_[const_20] = String(param2);
            if(param3 != null)
            {
      ...
      {
         trackLoginStep(const_6);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_9,const_8,null);
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc10_:Sprite = _loc9_.getChildByName(const_7) as Sprite;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
