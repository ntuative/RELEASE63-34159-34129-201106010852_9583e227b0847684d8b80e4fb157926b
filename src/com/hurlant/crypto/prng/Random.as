package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      private var var_168:ByteArray;
      
      private var psize:int;
      
      private var var_120:int;
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_168 = new ByteArray();
         this.var_120 = 0;
         while(this.var_120 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_120++;
            this.var_168[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_168[_loc4_ = this.var_120++] = _loc2_ & 255;
         }
         this.var_120 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_120++;
         this.var_168[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_120++;
         this.var_168[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_168[_loc4_ = this.var_120++] = this.var_168[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_168[_loc5_ = this.var_120++] = this.var_168[_loc5_] ^ param1 >> 24 & 255;
         this.var_120 %= this.psize;
         this.var_2632 = true;
      }
      ...
      public function nextByte() : int
      {
         if(!this.ready)
         {
            ...
            this.state.init(this.var_168);
            this.var_168.length = 0;
            this.var_120 = 0;
            this.ready = true;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_168[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_168.length = 0;
         this.var_168 = null;
