package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1789 = param1.invDigit();
         this.var_1790 = this.var_1789 & 32767;
         this.var_2445 = this.var_1789 >> 15;
         this.var_2444 = 131071;
         this.var_2443 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_184) > 0)
         {
