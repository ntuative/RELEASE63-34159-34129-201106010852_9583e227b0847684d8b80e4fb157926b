package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_29 = new Array();
         this.var_576 = new Array();
         this.var_1099 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_481 = new AssetLibrary("lib-" + this.var_583++);
         this.var_29.push(this.var_481);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1099;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_583++);
         this.var_576.push(_loc3_);
      ...
      {
         return this.var_481.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_576.length > 0)
         {
            (this.var_576.pop() as IAssetLibrary).dispose();
         }
         while(this.var_29.length > 0)
         {
            (this.var_29.pop() as IAssetLibrary).dispose();
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            super.dispose();
            _loc1_ = uint(this.var_29.length);
            _loc3_ = 0;
            while(_loc3_ < _loc1_)
            {
               _loc2_ = this.var_29.pop();
               _loc2_.dispose();
               _loc3_++;
            }
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_576.length)
            {
               _loc3_ = this.var_576[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_576.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
            this.var_29.push(_loc3_);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:uint = this.var_29.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_ = this.var_29[_loc4_];
      ...
      {
         if(this.var_29.indexOf(param1) == -1)
         {
      ...
      {
         return this.var_481.loadAssetFromFile(param1,param2,param3);
      }
      ...
      public function getAssetsByName(param1:String) : Array
      {
         ...
         var _loc4_:* = null;
         var _loc2_:* = [];
         for each(_loc4_ in this.var_29)
         {
      ...
      public function getAssetByIndex(param1:uint) : IAsset
      {
         var _loc2_:* = 0;
         var _loc3_:* = 0;
         var _loc4_:uint = this.var_29.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc2_ += IAssetLibrary(this.var_29[_loc5_]).numAssets;
            if(_loc2_ <= param1)
            {
               return IAssetLibrary(this.var_29[_loc5_]).getAssetByIndex(param1 - _loc3_);
            }
            _loc3_ = uint(_loc2_);
            _loc5_++;
         }
      ...
      {
         return this.var_481.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_481.createAsset(param1,param2);
      }
      ...
      {
         return this.var_481.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_481.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc4_ = this.var_29[_loc6_];
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_481.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_481.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      private function getNumAssets() : uint
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ += IAssetLibrary(this.var_29[_loc3_]).numAssets;
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private function getAssetNameArray() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ = _loc1_.concat(IAssetLibrary(this.var_29[_loc3_]).nameArray);
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      {
         var _loc1_:Array = new Array();
         var _loc2_:int = this.var_29.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(IAssetLibrary(this.var_29[_loc3_]).manifest);
            _loc3_++;
         }
         return _loc1_;
      }
