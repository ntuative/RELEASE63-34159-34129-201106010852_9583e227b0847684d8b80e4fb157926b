package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_1078[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2900);
      }
      ...
      public function loadLocalizationFromURL(param1:String) : void
      {
         ...
         _loc4_.addEventListener(AssetLoaderEvent.const_29,this.onLocalizationReady);
         _loc4_.addEventListener(AssetLoaderEvent.const_40,this.onLocalizationFailed);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_180));
         }
      }
      ...
      {
         var _loc3_:Localization = this.var_64[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_64[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_64[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_2065);
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_64)
         {
      ...
      {
         var _loc5_:Localization = this.var_64[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_64[param1] = _loc5_;
         }
      ...
      {
         return this.var_64[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_64)
         {
            if(_loc2_.raw.indexOf("%predefined%") >= 0)
            {
               _loc2_.registerParameter("predefined",this.var_2065);
            }
         }
      }
   }
