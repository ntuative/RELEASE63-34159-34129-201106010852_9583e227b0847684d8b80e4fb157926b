package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_446:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1260:uint = 4;
       
      
      protected var var_817:uint = 0;
      ...
      private var var_552:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_552 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_552.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_552.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1373 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1373);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1632 & const_1260)
         {
            if(_loc3_ == 0)
            {
               if(this.var_552.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1046 = false;
            this._events.dispatchEvent(new LockEvent(const_446,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_817 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_552.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_552.getStructByIndex(_loc8_);
