package com.sulake.core.runtime
{
   ...
   final class InterfaceStructList implements IDisposable
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:uint = this.var_60.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_)
         {
            _loc2_ = this.var_60.pop();
            _loc2_.dispose();
            _loc3_++;
         }
         this.var_60 = null;
      ...
      {
         var _loc2_:* = null;
         if(param1 < this.var_60.length)
         {
            _loc2_ = this.var_60[param1];
            this.var_60.splice(param1,1);
            return _loc2_;
         }
      ...
      public function find(param1:IID) : IUnknown
      {
         ...
         var _loc3_:uint = this.var_60.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc3_)
         {
            _loc4_ = this.var_60[_loc5_] as InterfaceStruct;
      ...
      public function getStructByInterface(param1:IID) : InterfaceStruct
      {
         var _loc3_:* = null;
         var _loc2_:String = getQualifiedClassName(param1);
         var _loc4_:uint = this.var_60.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc3_ = this.var_60[_loc5_] as InterfaceStruct;
      ...
      public function mapStructsByInterface(param1:IID, param2:Array) : uint
      {
         ...
         var _loc4_:int = 0;
         var _loc6_:uint = this.var_60.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc5_ = this.var_60[_loc7_] as InterfaceStruct;
      ...
      public function getStructByImplementor(param1:IUnknown) : InterfaceStruct
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc2_ = this.var_60[_loc4_] as InterfaceStruct;
      ...
      public function mapStructsByImplementor(param1:IUnknown, param2:Array) : uint
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         var _loc5_:uint = this.var_60.length;
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc4_ = this.var_60[_loc6_] as InterfaceStruct;
      ...
      {
         return param1 < this.var_60.length ? this.var_60[param1] : null;
      }
