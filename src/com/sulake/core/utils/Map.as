package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_150)
            {
               delete this.var_150[_loc1_];
            }
            this.var_150 = null;
         }
         this._length = 0;
      ...
      {
         if(this.var_150[param1] != null)
         {
            return false;
         }
         this.var_150[param1] = param2;
         this.var_32.unshift(param2);
      ...
      public function add(param1:*, param2:*) : Boolean
      {
         ...
         this.var_150[param1] = param2;
         this.var_32[this._length] = param2;
      ...
      {
         return this.var_150[param1];
      }
      
      public function remove(param1:*) : *
      {
         var _loc2_:Object = this.var_150[param1];
         if(_loc2_ == null)
         {
            return null;
         }
         var _loc3_:int = this.var_32.indexOf(_loc2_);
         if(_loc3_ >= 0)
         {
            this.var_32.splice(_loc3_,1);
            this._keys.splice(_loc3_,1);
            --this._length;
         }
         delete this.var_150[param1];
         return _loc2_;
      }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(this._singleWrite)
         {
            if(this.var_150[param1] != null)
            {
               Core.error("Trying to write to a single write Map. Key: " + param1 + ", value: " + param2,true,Core.const_1905);
            }
         }
         this.var_150[param1] = param2;
         ...
         {
            this.var_32.splice(_loc3_,1,param2);
         }
      }
