package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1307:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1374:String = "_COLORIZE";
      
      protected static const const_1373:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1109:Point = new Point();
      ...
      protected var var_717:Function;
      ...
      private var var_392:Rectangle;
      
      private var var_2831:uint;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_392 = new Rectangle();
         if(_loc12_ != null)
         {
            var_407 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_62 = var_407.clone();
            var_11 = var_407.clone();
            ...
            var_62.x = param6.x;
            var_62.y = param6.y;
            var_62.width = param6.width;
            var_62.height = param6.height;
         }
         var _loc13_:DefaultAttStruct = param5.getWindowFactory().getDefaultsByTypeAndStyle(param2,param3);
         if(_loc13_)
         {
            _blend = _loc13_.blend;
            var_482 = _loc13_.var_2948;
            if(var_483 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_246 != _loc13_.color)
            {
               this.color = _loc13_.color;
            }
            if(_loc13_.hasRectLimits())
            {
               var_75.assign(_loc13_.width_min,_loc13_.width_max,_loc13_.height_min,_loc13_.height_max);
            }
         }
         if(param9)
         {
      ...
      {
         return this.var_717 != null ? this.var_717 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_483 = param1;
         var_246 = !!var_483 ? uint(var_246 | var_577) : uint(var_246 & 16777215);
         this.var_177 = this.var_177 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_246 = !!var_483 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_577 = param1 << 24;
         var_246 = !!var_483 ? uint(var_577 | var_246) : uint(16777215 & var_246);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1268);
      }
      ...
      {
         var_482 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_876);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_83)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1373) == -1)
               {
                  _loc4_.style = var_83;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_392 = this._parent.rectangle.clone();
               var_62.x = var_11.x;
               var_62.y = var_11.y;
               var_62.width = var_11.width;
               var_62.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_549,this,this._parent);
            ...
            else
            {
               this.var_392.x = 0;
               this.var_392.y = 0;
               this.var_392.width = 0;
               this.var_392.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1669,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_801,var_11);
            this.var_21.visible = var_327;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_20,_context,var_11,null,this.var_717,this.properties,var_885.concat(),_id) as WindowController;
         _loc2_.var_482 = var_482;
         _loc2_.var_177 = this.var_177;
         _loc2_._debug = this._debug;
         _loc2_.var_392 = this.var_392.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_407 = var_407.clone();
         _loc2_.var_62 = var_62.clone();
         ...
         _loc2_.var_246 = var_246;
         _loc2_.var_577 = var_577;
         _loc2_.var_706 = var_706;
         _loc2_.var_327 = var_327;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2831 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_568)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_484)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_514)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_100))
         {
            if(this._parent != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1265,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_430,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param2 != null)
         {
            param2.x = var_62.x;
            param2.y = var_62.y;
            param2.width = var_62.width;
            param2.height = var_62.height;
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_921))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1354;
                  if(testParamFlag(WindowParam.const_424))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_248))
                        {
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_307))
                        {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  _context.invalidate(this,var_11.union(var_62),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_899,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_216,WindowParam.const_171))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_205,WindowParam.const_186))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_587))
                        {
                        ...
                        var_20 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_119,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_430:
                  _loc6_ = var_11.union(var_62);
                  if(this._parent)
                  {
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1163);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1709,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_197,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_580:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1177,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_320,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_549:
                  if(testParamFlag(WindowParam.const_216,WindowParam.const_171))
                  {
                     this.updateScaleRelativeToParent();
                  }
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_899:
                  this._parent.getRegionProperties(null,this.var_392);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_356:
      ...
      public function method_4(param1:Point) : void
      {
         param1.x = var_11.x;
         param1.y = var_11.y;
      }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_482);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_482);
      }
         ...
         if(this.var_177 && var_482 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1109,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1109,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         var _loc7_:*;
         var_83 = !!param2 ? (_loc7_ = var_83 | param1, var_83 |= param1, uint(_loc7_)) : (_loc7_ = var_83 & ~param1, var_83 &= ~param1, uint(_loc7_));
         if(var_83 != _loc3_)
         {
            _loc4_ = new Array();
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1373) == -1)
               {
                  _loc6_.style = var_83;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_148,WindowParam.const_171);
         var _loc2_:* = !testParamFlag(WindowParam.const_144,WindowParam.const_186);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_392.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_380)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_407)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_216)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_392.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_349)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_241)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_205)
               {
         ...
         else if(testParamFlag(WindowParam.const_100))
         {
            _loc3_ = var_11.clone();
            if(this._parent != null)
            {
      ...
      {
         if(_state == WindowState.const_547)
         {
            return true;
         }
         _state = WindowState.const_547;
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_345,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1751,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1840,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1731,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1732,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1921,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1934,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_580,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1831,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_630,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1959,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_68,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1925,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1846,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_821,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_255,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_997,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_240,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1689,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_347,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1765,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1308 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_356,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1308 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_356,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_443,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
