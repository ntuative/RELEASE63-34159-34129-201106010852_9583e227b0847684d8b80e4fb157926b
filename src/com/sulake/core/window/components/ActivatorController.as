package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_320)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1177)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_894;
         if(this.var_894 != param1)
         {
            if(this.var_894 != null)
            {
               if(!this.var_894.disposed)
               {
                  this.var_894.deactivate();
               }
            }
            this.var_894 = param1;
