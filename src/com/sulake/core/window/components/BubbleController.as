package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_1993:String = "_POINTER_UP";
      
      private static const const_1991:String = "_POINTER_DOWN";
      
      private static const const_1992:String = "_POINTER_LEFT";
      
      private static const const_1990:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_718,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_718:
