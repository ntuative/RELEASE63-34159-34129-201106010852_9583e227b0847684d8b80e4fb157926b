package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_445:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_445);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               case WindowEvent.const_119:
                  width = 0;
                  break;
               case WindowEvent.const_255:
                  try
                  {
                     getChildByName(const_445).blend = getChildByName(const_445).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_240:
                  try
                  {
                     getChildByName(const_445).blend = getChildByName(const_445).blend - 0.5;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1291:
                  type = "null";
                  break;
               case WindowTouchEvent.const_904:
                  type = "null";
            }
