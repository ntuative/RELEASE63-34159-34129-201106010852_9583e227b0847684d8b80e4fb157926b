package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_445:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_189:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_335,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_659 = param1;
            this.closeMenuView();
            _loc2_ = WindowEvent.allocate(WindowEvent.const_49,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      {
         if(this.var_189 != null && !this.var_189.disposed)
         {
      ...
      {
         return getChildByName(DropMenuController.const_445) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_189 == null || this.var_189.disposed)
         {
            this.var_189 = context.create(name + "::submenu","",WindowType.const_571,var_83,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_189.setGlobalRectangle(_loc1_);
         }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_189.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1022 = false;
            this.getTitleLabel().text = this.var_659 < this.var_268.length && this.var_659 > -1 ? this.var_268[this.var_659] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_530,var_83,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_418,var_83,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_659 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_659).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_904)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1291:
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowTouchEvent.const_710:
      ...
      {
         if(getStateFlag(WindowState.const_102))
         {
            return true;
         }
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1684,this,null);
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1962,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1855,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1715,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_268.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_745,this.var_268,PropertyStruct.const_140,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_745)
            {
