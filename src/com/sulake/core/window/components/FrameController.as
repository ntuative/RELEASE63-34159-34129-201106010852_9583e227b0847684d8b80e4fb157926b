package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1420:String = "_TITLE";
      
      private static const const_1577:String = "_HEADER";
      
      private static const const_1576:String = "_CONTENT";
      
      private static const const_1575:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1538:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1420) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1538 = findChildByTag(const_1577) as IHeaderWindow;
            if(!this.var_1538)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_178 = findChildByTag(const_1576) as IWindowContainer;
            if(!this.var_178)
            {
      ...
      {
         return findChildByTag(const_1575) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1107 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_307);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_264);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_291);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_264,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_264,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_291,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_291,false);
            }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_293,_loc3_.left,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,_loc3_.top,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_285,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         return _loc1_;
      }
