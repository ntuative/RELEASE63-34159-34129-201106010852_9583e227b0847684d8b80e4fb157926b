package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_919:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_732:String;
      
      private var var_1141:String = null;
      
      private var var_1708:StyleSheet = null;
      ...
      {
         this.var_732 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1141 == param2)
         {
            return;
         }
         param1.var_1141 = param2;
         param1.var_1708 = null;
         if(param1.var_1141 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1141);
            param1.var_1708 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_917.indexOf(param1) > -1)
         {
            this.var_732 = param1;
         }
      }
      ...
      {
         return this.var_732 == LinkTarget.const_30 ? defaultLinkTarget : this.var_732;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1708;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1197)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_732 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_847,this.var_732,PropertyStruct.const_53,true,PropertyDefaults.const_917));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_847)
            {
               this.var_732 = _loc2_.value as String;
               break;
            }
