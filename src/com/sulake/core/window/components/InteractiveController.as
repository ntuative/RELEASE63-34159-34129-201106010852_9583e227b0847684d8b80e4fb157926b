package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1637 = PropertyDefaults.const_701;
         this.var_1361 = PropertyDefaults.const_421;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_421)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_964:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_421)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_964,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1884);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_701)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_773,param1.toolTipDelay,PropertyStruct.const_245,true));
         }
         else
         {
      ...
      {
         this.var_1361 = param1 == null ? "null" : param1;
      }
