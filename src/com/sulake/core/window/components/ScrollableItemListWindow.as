package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1229:IItemListWindow;
      
      private var var_445:IScrollbarWindow;
      
      private var var_1887:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_85))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_445)
         {
            this.var_445.removeEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            this.var_445.removeEventListener(WindowEvent.const_240,this.scrollBarEventProc);
            this.var_445 = null;
         }
         if(this.var_1229)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1229)
         {
            this.var_1229 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_445)
         {
            this.var_445 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_445)
            {
               this.var_445.addEventListener(WindowEvent.const_255,this.scrollBarEventProc);
               this.var_445.addEventListener(WindowEvent.const_240,this.scrollBarEventProc);
            }
         }
         return this.var_445;
      }
      ...
      {
         if(param1.type == WindowEvent.const_255)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_240)
         {
            this.hideScrollBar();
         }
      }
