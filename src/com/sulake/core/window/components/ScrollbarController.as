package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1467:String = "increment";
      
      private static const const_1468:String = "decrement";
      
      private static const const_1055:String = "slider_track";
      
      private static const const_655:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_708:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_177 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_607;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_599,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_599,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_966 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1055) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_655) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_655:
         ...
         if(param2.type == WindowEvent.const_549)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_339)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_708;
                  }
                  else
                  {
                     this.scrollV -= this.var_708;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_904)
         {
            ...
            else if(param2.name == const_1468)
            {
               if(this.var_18)
               {
                  this.var_1190 = true;
            ...
            else if(param2.name == const_1055)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_655).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_339)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_966) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_966) as IScrollableWindow;
               if(_loc1_)
               {
