package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      {
         return testStateFlag(WindowState.const_56);
      }
      
      public function set isSelected(param1:Boolean) : void
      {
         setStateFlag(WindowState.const_56,param1);
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param2.type == WindowEvent.const_580)
         {
            if(_parent)
            {
               if(!(_parent is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc4_ = WindowEvent.allocate(WindowEvent.const_320,this,null);
      ...
      {
         if(getStateFlag(WindowState.const_56))
         {
            return true;
         }
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_335,this,null);
         ...
         _loc1_.recycle();
         setStateFlag(WindowState.const_56,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_49,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         activate();
         return true;
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_629,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         setStateFlag(WindowState.const_56,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_524,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
