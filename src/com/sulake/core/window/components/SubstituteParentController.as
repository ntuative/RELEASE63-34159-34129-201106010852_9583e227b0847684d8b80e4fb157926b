package com.sulake.core.window.components
{
   ...
   public class SubstituteParentController extends WindowController
   {
      ...
      {
         super("_CONTEXT_SUBSTITUTE_PARENT",0,0,WindowParam.const_34,param1,new Rectangle(0,0,2000,2000),null,null,null,null,0);
         var_177 = false;
      }
      ...
      private function childParamUpdated(param1:WindowEvent) : void
      {
         ...
         {
            if(!_loc2_.testParamFlag(WindowParam.const_34))
            {
