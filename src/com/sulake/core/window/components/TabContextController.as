package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1376:String = "_SELECTOR";
      
      private static const const_1377:String = "_CONTENT";
       
      
      protected var var_1098:ITabSelectorWindow;
      
      protected var var_2167:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1098 = findChildByTag(const_1376) as ITabSelectorWindow;
            if(this.var_1098 != null)
            {
               this.var_1098.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2167 == null)
         {
            this.var_2167 = findChildByTag(const_1377) as IWindowContainer;
         }
      ...
      {
         return this.var_1098.numSelectables;
      }
