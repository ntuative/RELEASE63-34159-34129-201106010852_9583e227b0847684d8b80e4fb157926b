package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1371:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_887:Number;
      
      protected var var_579:Number;
      
      protected var var_578:Boolean;
      
      protected var var_41:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_132:Boolean = false;
      
      protected var var_1103:Boolean = false;
      
      private var var_432:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_432,this._explicitStyle);
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_132)
         {
            param1.context.removeLocalizationListener(param1.var_17.slice(2,param1.var_17.indexOf("}")),param1);
            param1.var_132 = false;
         }
         param1.var_17 = param2;
         if(param1.var_17.charAt(0) == "$" && param1.var_17.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_17.slice(2,param1.var_17.indexOf("}")),param1);
            param1.var_132 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_17;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_432 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_432,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_210);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_735 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_432);
      }
      ...
      {
         this.var_887 = param1;
         this._field.scrollH = this.var_887 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_579)
         {
            this.var_579 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_579)
         {
            this.var_579 = param1;
      ...
      {
         return new Rectangle(this.var_887 * this.maxScrollH,this.var_579 * this.maxScrollV,width,height);
      }
      ...
      protected function immediateClickHandler(param1:Event) : void
      {
         ...
         while(_loc4_.length > 0)
         {
            ...
            if(_loc6_.getParamFlag(WindowParam.const_31))
            {
               return;
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_432);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_928,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1216));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1331 ? new PropertyStruct(PropertyDefaults.const_825,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1342) : PropertyDefaults.const_1879);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_245,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1134 ? new PropertyStruct(PropertyDefaults.const_1274,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1188) : PropertyDefaults.const_1928);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_860) ? new PropertyStruct(PropertyDefaults.const_423,this._field.textColor,PropertyStruct.const_157,true) : PropertyDefaults.const_1232);
         _loc1_.push(this.var_432 != TextStyleManager.const_210 ? new PropertyStruct(PropertyDefaults.const_383,this.var_432,PropertyStruct.const_53,true,PropertyDefaults.const_767) : PropertyDefaults.const_1234);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_931 ? new PropertyStruct(PropertyDefaults.const_293,this.var_41.left,PropertyStruct.const_42,true) : PropertyDefaults.const_703);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_983 ? new PropertyStruct(PropertyDefaults.const_243,this.var_41.top,PropertyStruct.const_42,true) : PropertyDefaults.const_731);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_732 ? new PropertyStruct(PropertyDefaults.const_285,this.var_41.right,PropertyStruct.const_42,true) : PropertyDefaults.const_908);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_975 ? new PropertyStruct(PropertyDefaults.const_266,this.var_41.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_955);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1156 ? new PropertyStruct(PropertyDefaults.const_782,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1666);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_42,this._field.maxChars != 0));
