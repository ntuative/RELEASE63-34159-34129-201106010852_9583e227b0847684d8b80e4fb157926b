package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1637:uint = 500;
      
      protected var var_1361:String = "";
      
      protected var var_1371:Boolean = false;
      
      protected var var_858:Boolean = false;
      ...
      {
         this.var_1361 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1276,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_858 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_192,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_401,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_346,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_113,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_795,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1839);
         _loc1_.push(this.var_1371 != PropertyDefaults.const_1192 ? new PropertyStruct(PropertyDefaults.const_770,this.var_1371,PropertyStruct.const_36,true) : PropertyDefaults.const_1714);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1139 ? new PropertyStruct(PropertyDefaults.const_926,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1874);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1151 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1810);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_770:
                  this.var_1371 = _loc2_.value as Boolean;
                  if(this.var_1371)
                  {
               ...
               case PropertyDefaults.const_795:
                  ...
                  break;
               case PropertyDefaults.const_1229:
