package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_432);
         if(_loc1_)
         {
      ...
      {
         if(this.var_432 != param1.name)
         {
            this.var_432 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2797 = _loc2_.textWidth;
         this.var_2796 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_390 != _loc2_.color : this.var_390 != null && this.var_390 != PropertyDefaults.const_860) ? new PropertyStruct(PropertyDefaults.const_423,this.var_390,PropertyStruct.const_157,true) : PropertyDefaults.const_1232);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_931)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_293,this.var_41.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_703);
            }
            if(this.var_41.top != PropertyDefaults.const_983)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,this.var_41.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_731);
            }
            if(this.var_41.right != PropertyDefaults.const_732)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_285,this.var_41.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_908);
            }
            if(this.var_41.bottom != PropertyDefaults.const_975)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,this.var_41.bottom,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_955);
            }
         }
         else
         {
