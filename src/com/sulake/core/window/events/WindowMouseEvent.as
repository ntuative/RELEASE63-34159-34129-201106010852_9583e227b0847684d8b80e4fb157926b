package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2227:String = "WME_MIDDLE_CLICK";
      
      public static const const_2091:String = "WME_MIDDLE_DOWN";
      
      public static const const_2049:String = "WME_MIDDLE_UP";
      ...
      public static const const_219:String = "WME_UP_OUTSIDE";
      
      public static const const_339:String = "WME_WHEEL";
      
      public static const const_2170:String = "WME_RIGHT_CLICK";
      
      public static const const_2166:String = "WME_RIGHT_DOWN";
      
      public static const const_2206:String = "WME_RIGHT_UP";
      
      public static const const_1864:String = "WME_ROLL_OUT";
      
      public static const const_1947:String = "WME_ROLL_OVER";
      
      public static const const_2229:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_716 = param3;
         _loc13_.var_487 = false;
         _loc13_.var_715 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_490 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
