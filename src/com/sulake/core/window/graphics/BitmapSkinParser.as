package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_102:String = "default";
      
      public static const const_89:String = "active";
      
      public static const const_84:String = "focused";
      
      public static const const_88:String = "hovering";
      
      public static const const_56:String = "selected";
      
      public static const const_96:String = "pressed";
      
      public static const const_85:String = "disabled";
      
      public static const const_68:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_333 = SkinLayoutEntity.const_559;
                  break;
               case "move":
                  _loc5_.var_333 = SkinLayoutEntity.const_310;
                  break;
               case "strech":
                  _loc5_.var_333 = SkinLayoutEntity.const_479;
                  break;
               case "tiled":
                  _loc5_.var_333 = SkinLayoutEntity.const_348;
                  break;
               case "center":
                  _loc5_.var_333 = SkinLayoutEntity.const_609;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_334 = SkinLayoutEntity.const_559;
                  break;
               case "move":
                  _loc5_.var_334 = SkinLayoutEntity.const_310;
                  break;
               case "strech":
                  _loc5_.var_334 = SkinLayoutEntity.const_479;
                  break;
               case "tiled":
                  _loc5_.var_334 = SkinLayoutEntity.const_348;
                  break;
               case "center":
                  _loc5_.var_334 = SkinLayoutEntity.const_609;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_89:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_102:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_84:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_85:
               _loc10_ = 0;
               break;
            ...
            case BitmapSkinParser.const_96:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_56:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_68:
               _loc10_ = 0;
               break;
            default:
