package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1719:uint = 0;
      
      public static const const_801:uint = 1;
      
      public static const const_1276:uint = 2;
      
      public static const const_846:uint = 4;
      
      public static const const_1743:uint = 8;
      
      public static const const_1897:uint = 16;
      
      public static const const_2161:uint = 64;
      
      public static const const_2105:uint = 128;
      
      public static const const_1258:uint = 256;
      
      protected static var var_583:uint = 0;
      
      protected static var var_341:uint = 0;
       
      
      protected var var_222:DisplayObjectContainer;
      
      protected var var_2187:Boolean;
      
      protected var var_889:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1276:
               ...
               break;
            case GraphicContext.const_1743:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1897:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_846:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1258:
               break;
            case GraphicContext.const_1719:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_222.numChildren > 0)
               {
                  this.var_222.removeChildAt(0);
               }
            }
            this.var_222 = null;
            while(numChildren > 0)
         ...
         if(this.var_889)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_341 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2187,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2187,16777215);
                  }
                  var_341 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_889)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_341 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_222 == null)
         {
            this.var_222 = new Sprite();
            this.var_222.name = this.name + " - Child Container";
            this.var_222.mouseEnabled = false;
            addChild(this.var_222);
         }
         return this.var_222;
      }
      ...
      {
         return this.var_222 != null ? int(this.var_222.numChildren) : 0;
      }
