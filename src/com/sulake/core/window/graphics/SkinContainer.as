package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1566:String = "skin";
      
      private static const const_1565:String = "bitmap";
      
      private static const const_1564:String = "fill";
      
      private static const const_1561:String = "text";
      
      private static const const_1563:String = "label";
      
      private static const const_1562:String = "shape";
      ...
      private var var_2709:Dictionary;
      
      private var var_2708:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1953 = new Dictionary();
         this.var_2710 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1953,this.var_2710);
         this.var_2709 = new Dictionary();
         this.var_2708 = new Dictionary();
         StateCodeTable.fillTables(this.var_2709,this.var_2708);
         this.var_450 = new Dictionary();
         this.var_450[const_1566] = BitmapSkinRenderer;
         this.var_450[const_1565] = BitmapDataRenderer;
         this.var_450[const_1564] = FillSkinRenderer;
         this.var_450[const_1561] = TextSkinRenderer;
         this.var_450[const_1563] = LabelRenderer;
         this.var_450[const_1562] = ShapeSkinRenderer;
         this.var_450[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_450[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_342 == null)
         {
            var_342 = new Array();
            var_342.push(WindowState.const_68);
            var_342.push(WindowState.const_85);
            var_342.push(WindowState.const_96);
            var_342.push(WindowState.const_56);
            var_342.push(WindowState.const_88);
            var_342.push(WindowState.const_84);
            var_342.push(WindowState.const_89);
            var_342.push(WindowState.const_102);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2948 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1953[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1030[param1] = new Array(const_1088);
         }
         this.var_1030[param1][param2] = param3;
         if(this.var_1029[param1] == null)
         {
            this.var_1029[param1] = new Array(const_1088);
         }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_155)
            {
               _loc4_ = _loc3_["null"];
            }
         }
