package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_892:Dictionary;
      
      protected var var_893:Dictionary;
      
      private var var_267:Matrix;
      ...
      {
         super(param1);
         this.var_892 = new Dictionary(false);
         this.var_893 = new Dictionary(false);
         this.var_267 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_267 = null;
            this.var_810 = null;
            for(_loc1_ in this.var_892)
            {
               _loc2_ = this.var_892[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_892[_loc1_];
            }
            this.var_892 = null;
            for(_loc1_ in this.var_893)
            {
               _loc2_ = this.var_893[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_893[_loc1_];
            }
            this.var_893 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_486[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_810.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_810.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_810.blueMultiplier = (param1.color & 255) / 255;
               this.var_810.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_810);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_333 == SkinLayoutEntity.const_310)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_479)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_348)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_609)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_334 == SkinLayoutEntity.const_310)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_479)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_348)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_609)
                  {
                  ...
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_348 || _loc10_.var_333 == SkinLayoutEntity.const_348)
                  {
                  ...
                  {
                     this.var_267.a = REGION.width;
                     this.var_267.d = REGION.height;
                     this.var_267.tx = REGION.x;
                     this.var_267.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_267,ALPHA);
                  }
                  else
                  {
                     this.var_267.a = 0 / _loc18_.width;
                     this.var_267.d = 0 / _loc18_.height;
                     this.var_267.tx = 0;
                     this.var_267.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_267);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_267,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_333 == SkinLayoutEntity.const_310)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_334 == SkinLayoutEntity.const_310)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_892[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_893[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
