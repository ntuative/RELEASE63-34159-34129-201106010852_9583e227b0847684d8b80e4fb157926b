package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_580:Dictionary;
      
      protected var var_486:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_580)
            {
               ISkinLayout(this.var_580[_loc1_]).dispose();
               delete this.var_580[_loc1_];
            }
            this.var_580 = null;
            this.var_486 = null;
            for(_loc1_ in this.var_409)
            {
               ISkinTemplate(this.var_409[_loc1_]).dispose();
               delete this.var_409[_loc1_];
            }
            this.var_409 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_409[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_580[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_580[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_409[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_486)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_486[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_580[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_409[param1.name];
         }
         return param1;
      }
   }
