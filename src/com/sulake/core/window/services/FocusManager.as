package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      private var var_147:Stage;
      
      public function FocusManager(param1:DisplayObject)
      {
         this.var_147 = param1.stage;
         this.var_147.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_147.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_147.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_147.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_147.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_147.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_147.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_147.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_147 = null;
            this._disposed = true;
            var_32 = null;
         }
