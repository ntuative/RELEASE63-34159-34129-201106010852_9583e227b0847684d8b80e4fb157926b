package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_714:Point;
      
      protected var var_1632:uint;
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         {
            this.var_154.addEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
            this.var_154.addEventListener(MouseEvent.MOUSE_UP,this.handler,false);
            this.var_154.addEventListener(Event.ENTER_FRAME,this.handler);
            this._mouse.x = this.var_154.mouseX;
            this._mouse.y = this.var_154.mouseY;
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            ...
            {
               this.var_154.removeEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
               this.var_154.removeEventListener(MouseEvent.MOUSE_UP,this.handler,false);
               this.var_154.removeEventListener(Event.ENTER_FRAME,this.handler);
      ...
      protected function handler(param1:Event) : void
      {
         ...
         if(this._working)
         {
            if(param1.type == Event.ENTER_FRAME)
            {
               ...
               else if(this._mouse.x != this.var_154.mouseX || this._mouse.y != this.var_154.mouseY)
               {
                  this.operate(this.var_154.mouseX,this.var_154.mouseY);
                  this._mouse.x = this.var_154.mouseX;
                  this._mouse.y = this.var_154.mouseY;
               }
               return;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_714);
         this._window.offset(this.var_714.x - this._offset.x,this.var_714.y - this._offset.y);
      }
