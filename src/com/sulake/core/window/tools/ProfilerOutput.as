package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1471:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1470:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_162:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_162 = this.profiler;
         this._windowManager = param2;
         this.var_924 = param3;
         var _loc4_:ByteArray = new var_1471() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_162)
         {
            this.var_162.removeStopEventListener(this.refresh);
            this.var_162 = null;
         }
         if(!this.var_162 && param1)
         {
            this.var_162 = param1;
            this.var_162.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_524)
            {
               this.var_1822 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_162.getProfilerAgentsInArray();
         ...
         if(this.var_1822)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_162.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_162.numBitmapAssetInstances + " / " + this.var_162.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_924.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_162.numTrackedBitmapDataInstances + " / " + this.var_162.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1470() as ByteArray;
