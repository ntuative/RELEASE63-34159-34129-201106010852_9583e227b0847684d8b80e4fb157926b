package com.sulake.core.window.utils
{
   public class ChildEntityArrayReader implements IChildEntityArrayReader
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:uint = this.var_32.length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_ = this.var_32[_loc4_];
            if(_loc3_.id == param1)
            {
               return _loc3_;
            }
      ...
      {
         return this.var_32.indexOf(param1);
      }
      ...
      public function groupChildrenWithID(param1:uint, param2:Array) : uint
      {
         ...
         var _loc6_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:uint = this.var_32.length;
         _loc6_ = 0;
         while(_loc6_ < _loc5_)
         {
            _loc3_ = this.var_32[_loc6_];
            if(_loc3_.id == param1)
            {
               param2.push(_loc3_);
               _loc4_++;
