package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_949:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_949[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         if(!param1)
         {
            param1 = TextStyleManager.getStyle(TextStyleManager.const_210);
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_735 ? true : null;
         ...
         _loc2_.antiAliasType = param1.antiAliasType == AntiAliasType.ADVANCED ? "null" : AntiAliasType.NORMAL;
         _loc2_.sharpness = !!param1.sharpness ? Number(param1.sharpness as int) : Number(0);
         _loc2_.thickness = !!param1.thickness ? Number(param1.thickness as int) : Number(0);
