package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_210:String = "regular";
      ...
      private static var var_536:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_669:String = "{";
      
      private static const const_668:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_210],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_210] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_536.indexOf(_loc4_.name) == -1)
            {
               var_536.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_668);
         if(countSubStrings(param1,const_669) != countSubStrings(param1,const_668))
         {
            throw new Error("Mismatching amount of \"" + const_669 + "\" versus \"" + const_668 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1528) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1527) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_669)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
