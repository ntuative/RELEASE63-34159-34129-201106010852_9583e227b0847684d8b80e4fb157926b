package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1278:String = "_EXCLUDE";
      
      public static const const_2052:String = "_INCLUDE";
      
      public static const const_2080:String = "_TEMP";
      
      private static const const_1482:String = "layout";
      
      private static const const_1063:String = "window";
      
      private static const const_1061:String = "variables";
      
      private static const const_1062:String = "filters";
      
      private static const const_648:String = "name";
      
      private static const const_1479:String = "style";
      
      private static const const_661:String = "params";
      
      private static const const_1478:String = "tags";
      ...
      private static const const_1484:String = "visible";
      
      private static const const_1481:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1268:String = "blend";
      
      private static const const_1475:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1474:String = "treshold";
      
      private static const const_1477:String = "children";
      
      private static const const_1480:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1476:String = "height_min";
      
      private static const const_1472:String = "height_max";
      
      private static const const_660:String = "true";
      
      private static const const_184:String = "0";
      
      private static const const_1473:String = "$";
      
      private static const const_1485:String = ",";
      
      private static const const_51:String = "";
      
      private static const const_1483:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1486:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1366:Dictionary;
      
      protected var var_1367:Dictionary;
      
      protected var var_1104:Dictionary;
      
      protected var var_1644:Dictionary;
      
      protected var var_2184:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1366 = new Dictionary();
         this.var_1367 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1366,this.var_1367);
         this.var_1104 = new Dictionary();
         this.var_1644 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1104,this.var_1644);
         this.var_2184 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1486,const_51);
         return param1.replace(const_1483,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1366)
            {
               delete this.var_1366[_loc1_];
            }
            for(_loc1_ in this.var_1367)
            {
               delete this.var_1367[_loc1_];
            }
            for(_loc1_ in this.var_1104)
            {
               delete this.var_1104[_loc1_];
            }
            for(_loc1_ in this.var_1644)
            {
               delete this.var_1644[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1482)
         {
            ...
            _loc9_ = param1.child(const_1062).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1063);
         ...
         if(param1.localName() == const_1063)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var params:uint = 0;
         var tag:String = const_51;
         var id:int = 0;
         type = this.var_1366[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_648,variables,"")));
         style = uint(this.parseAttribute(xml,const_1479,variables,style));
         params = uint(this.parseAttribute(xml,const_661,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1478,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_184));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_184));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_184));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_184));
         visible = this.parseAttribute(xml,const_1484,variables,visible.toString()) == const_660;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_661).length() > 0)
         {
            list = xml.child(const_661).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_648,variables,"") as String;
               if(this.var_1104[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_648)) + "\"!");
               }
               params |= this.var_1104[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1481,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1485);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1480,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1476,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1472,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_660;
         blend = Number(this.parseAttribute(xml,const_1268,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1475,variables,window.clipping.toString()) == const_660;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1474,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1062).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_216)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1367[param1.type];
         ...
         _loc2_ += "<" + _loc3_ + " x=\"" + param1.x + "\"" + " y=\"" + param1.y + "\"" + " width=\"" + param1.width + "\"" + " height=\"" + param1.height + "\"" + " params=\"" + param1.param + "\"" + " style=\"" + param1.style + "\"" + (param1.name != const_51 ? " name=\"" + escape(param1.name) + "\"" : const_51) + (param1.caption != const_51 ? " caption=\"" + escape(param1.caption) + "\"" : const_51) + (param1.id != 0 ? " id=\"" + param1.id.toString() + "\"" : const_51) + (param1.color != 16777215 ? " color=\"0x" + param1.alpha.toString(16) + param1.color.toString(16) + "\"" : const_51) + (param1.blend != 1 ? " blend=\"" + param1.blend.toString() + "\"" : const_51) + (param1.visible != true ? " visible=\"" + param1.visible.toString() + "\"" : const_51) + (param1.clipping != true ? " clipping=\"" + param1.clipping.toString() + "\"" : const_51) + (param1.background != false ? " background=\"" + param1.background.toString() + "\"" : const_51) + (param1.mouseThreshold != 10 ? " treshold=\"" + param1.mouseThreshold.toString() + "\"" : const_51) + (param1.tags.length > 0 ? " tags=\"" + escape(param1.tags.toString()) + "\"" : const_51) + (_loc6_.minWidth > int.MIN_VALUE ? " width_min=\"" + _loc6_.minWidth + "\"" : const_51) + (_loc6_.maxWidth < int.MAX_VALUE ? " width_max=\"" + _loc6_.maxWidth + "\"" : const_51) + (_loc6_.minHeight > int.MIN_VALUE ? " height_min=\"" + _loc6_.minHeight + "\"" : const_51) + (_loc6_.maxHeight < int.MAX_VALUE ? " height_max=\"" + _loc6_.maxHeight + "\"" : const_51) + ">\r";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1278) == -1)
                  {
