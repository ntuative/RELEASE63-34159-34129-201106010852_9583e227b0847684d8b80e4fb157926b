package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1317:BitmapData = null;
      
      private var var_1318:BitmapData = null;
      ...
      public function AdManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(AdImageEvent.const_179,this.onLoadAdImage);
      }
      ...
      {
         this.var_249 = param2 as IHabboCommunicationManager;
         if(this.var_249 == null)
         {
            return;
         }
         this._connection = this.var_249.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2861 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2860 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2863 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2045 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_243 != null && this.var_243.running)
         {
            this.var_243.reset();
            return false;
         }
         if(this.var_1319 == 0)
         {
            this.var_1319 = getTimer();
            return false;
         }
         if(this.var_2045 > 0 && this.var_2046 >= this.var_2045)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1319;
         if(_loc1_ > this.var_2860)
         {
            ++this.var_2046;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1584 = _loc2_.imageUrl;
         this.var_2862 = _loc2_.clickUrl;
         this.var_1319 = getTimer();
         if(this.var_1584 != "")
         {
            _loc3_ = this.var_1584;
            ...
            {
               this.var_243 = new Timer(this.var_2863,1);
               this.var_243.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_243.running)
            {
               this.var_243.reset();
            }
            this.var_243.start();
            _loc4_ = new URLRequest(this.var_1584);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_515,0,0,param1.bitmapData,this.var_2862));
            this.var_1319 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_2044 = _loc2_.clickUrl;
         if(this.var_1585 != "" && this.var_2044 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_567,0,0,_loc4_,_loc2_.assetName,this.var_2044,this.var_1317,this.var_1318));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1317 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1318 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdImageEvent(AdImageEvent.const_179,param3,param4,param1,param2));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_677.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_677.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_40,this.onBillboardImageLoadError);
      }
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_677.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_827,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_677.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_960,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
