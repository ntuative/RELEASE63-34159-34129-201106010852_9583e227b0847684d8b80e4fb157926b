package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_2068:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_3;
         this._assets = param4;
         this.var_856 = String(param1);
         this._revision = String(param2);
         this.var_1332 = param3 + this.var_856 + ".swf";
         this.var_1332 = this.var_1332.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_856 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_856);
            this._state = name_4;
         }
      }
      ...
      {
         this._state = var_2068;
         var _loc1_:URLRequest = new URLRequest(this.var_1332);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_856 + " from URL " + this.var_1332,false,Core.const_1269);
      }
      ...
      {
         var _loc1_:String = this.var_856;
