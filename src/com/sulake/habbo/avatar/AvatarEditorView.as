package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1356:IWindowContainer;
      
      public static var var_1635:IWindowContainer;
      
      public static var var_2141:int = 6710886;
      ...
      private var var_367:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_537:IFrameWindow;
      
      private var var_447:Timer;
      
      private var var_2599:Number = 0;
      
      private var var_2600:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1239 = [];
         this.var_1506 = [AvatarEditorFigureCategory.const_891,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_292,AvatarEditorFigureCategory.const_769,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_106];
         super();
         ...
         if(var_1356 == null)
         {
            ...
            var_1356 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1635 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1635 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_447 = new Timer(1000);
         this.var_447.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1506;
         }
         for each(_loc6_ in param4)
         {
            this.var_1239.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_447.stop();
            this.var_447.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_447 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1506);
         }
         if(param1.length != this.var_1239.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1239.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2600 = this.canChangeOutfit();
            this.var_447.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_367 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_367.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_367.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1239.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_367.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_367.numSelectables)
               {
                  this.var_367.getSelectableAt(_loc6_).x = this.var_367.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_367.setSelected(this.var_367.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1506;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_37) && this._controller.isWardrobeAllowed();
         }
         var _loc4_:String = "null";
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_37) && (this.var_1892 == AvatarEditorSideCategory.const_106 || this.var_2598))
         {
         ...
         this.setViewToCategory(this.var_400);
      }
      ...
      {
         if(this.var_1892 == AvatarEditorSideCategory.const_106)
         {
            this.var_2598 = false;
            this.setSideContent(AvatarEditorSideCategory.const_834);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_834:
               break;
            case AvatarEditorSideCategory.const_466:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_466);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_400 = param1;
         this.var_367.setSelected(this.var_367.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2599 = new Date().valueOf();
                  this.var_2600 = false;
                  this.var_447.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_537)
         {
            ...
            this.var_537 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_537.procedure = this.stripClubDialogEventProc;
            this.var_537.center();
         }
         else
         {
            this.var_537.visible = true;
            this.var_537.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2599 > 5000;
      }
   }
}
