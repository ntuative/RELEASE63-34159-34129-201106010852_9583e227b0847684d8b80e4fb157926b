package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_2093:int;
      
      protected var var_290:IActiveActionData;
      
      protected var var_1110:Boolean;
      
      protected var var_836:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_279:AvatarImageCache;
      
      protected var var_605:AvatarFigureContainer;
      
      protected var var_582:IAvatarDataContainer;
      
      protected var var_339:Array;
      ...
      private var var_2836:int = -1;
      
      private var var_2837:String = null;
      
      private var var_2838:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1110)
         {
            ...
            if(this.var_839)
            {
               for each(_loc2_ in this.var_839)
               {
                  _loc2_.dispose();
               }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52 || param1 == AvatarSetType.const_43)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_277.length == 1 && this.var_93 == this.var_2093)
         {
            return this.var_93 + this.var_557 + this.var_674 % 4;
         }
         if(this.var_277.length == 2)
         {
            for each(_loc1_ in this.var_277)
            {
               ...
               {
                  return this.var_93 + this.var_557 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_674 % 11;
                  return this.var_93 + "_" + this.var_2093 + this.var_557 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2836 || param2 != this.var_2837 || param1 != this.var_2838)
         {
            this.var_2836 = param3;
            this.var_2837 = param2;
            this.var_2838 = param1;
            this.var_2038 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_290.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1378 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1378)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_290.definition.geometryType,this.var_93);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_674);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_674);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_339.push(new ActiveActionData(param1,param2,this.var_674));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_912);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_557 = "";
         this.var_277 = this._structure.sortActions(this.var_339);
         if(this.var_277 == null)
         {
         ...
         {
            this.var_836 = this._structure.getCanvasOffsets(this.var_277,this._scale,this.var_93);
            for each(_loc4_ in this.var_277)
            {
               this.var_557 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_323)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1578 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_277)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_911 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_340 || _loc1_.actionType == AvatarAction.const_260 || _loc1_.actionType == AvatarAction.const_375)
               {
                  this.var_911 = true;
               }
            }
