package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2269:String = "hd-99999-99999";
      ...
      private var var_833:PaletteManager;
      ...
      private var var_2021:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_338 = RenderMode.const_1924;
         this.var_324 = new Map();
         this.var_109 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_120,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_109.add(AvatarType.const_120,_loc4_);
         ...
         this.var_109.add(AvatarType.const_57,_loc4_);
         ...
         this.var_833 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_323.init();
         this.var_833.init();
         _loc2_ = this.var_109.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_109.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_109.getValue(AvatarType.const_120) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_197.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_241 == null)
               {
                  ...
                  _loc6_ = this.var_197.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_197.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_995)
         {
            if(this.var_2800 && this.var_2799 && this.var_2798)
            {
               this.var_995 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_109.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2021)
         {
            this.var_2021 = new AvatarFigureContainer(this.const_2269);
         }
         this.var_241.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2021,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_324 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_324.getKeys())
         {
            _loc3_ = this.var_324.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1848)
         {
            _loc6_ = !this.var_323.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_323.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_109.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_324.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_109.getValue(AvatarType.const_57);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_324.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_324.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_109.getValue(AvatarType.const_120) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_120:
               _loc3_ = this.var_109.getValue(AvatarType.const_120) as AvatarStructure;
               break;
            case AvatarType.const_57:
               _loc3_ = this.var_109.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
