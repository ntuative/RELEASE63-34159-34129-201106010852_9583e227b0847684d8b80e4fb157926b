package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1378:String = "Default";
      
      private static const const_1380:int = 2;
      
      private static const const_1379:String = AvatarSetType.const_43;
      ...
      protected var var_290:IActiveActionData;
      
      protected var var_1110:Boolean;
      
      private var var_912:IActiveActionData;
      
      private var _assets:AssetAliasCollection;
      
      private var var_279:AvatarImageCache;
      
      private var var_674:int = 0;
      
      private var var_1680:int = 0;
      
      private var var_605:AvatarFigureContainer;
      
      private var var_675:Boolean;
      
      private var var_213:Array;
      
      private var var_582:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         if(this._scale == null)
         {
            this._scale = AvatarScaleType.const_58;
         }
         ...
         this.var_605 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_605.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1403 = this.var_1304;
         this.var_279 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1379,const_1380);
         this.var_339 = new Array();
         this.var_912 = new ActiveActionData(AvatarAction.const_386);
         this.var_912.definition = this._structure.getActionDefinition(const_1378);
         this.resetActions();
      }
      ...
      {
         return this._structure.getPartColor(this.var_605,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += this.var_1680;
         if(param2 < AvatarDirectionAngle.const_1154)
         {
            param2 = AvatarDirectionAngle.const_329 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_329)
         {
            param2 -= NaN;
         }
         if(param1 == AvatarSetType.const_52)
         {
            if((this.var_93 == 6 || this.var_93 == 0) && param2 == 7)
            {
               param2 = this.var_93;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1403);
            if(_loc3_ != null)
            {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_674,param1.id);
      }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_290.definition.geometryType);
         if(this.var_46 == null || _loc4_ != null && (this.var_46.width != _loc4_.width || this.var_46.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_290.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_290.definition.geometryType,this.var_93);
         this.var_46.lock();
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_674);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_605,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1403 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_110)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_674);
                  _loc20_ = this.var_93;
                  _loc21_ = 1;
                  switch(this.var_93)
                  {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_93 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_93 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_93 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_93 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
         ...
         {
            if(this.var_582.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc23_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_582.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_290.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_674);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_605,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_110)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_674);
                  _loc21_ = this.var_93;
                  _loc22_ = 1;
                  switch(this.var_93)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_93 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_93 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_93 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_93 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_557 = this.var_557 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_378:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1919:
                  case AvatarAction.const_1902:
                  case AvatarAction.const_1759:
                  case AvatarAction.const_1153:
                  case AvatarAction.const_1173:
                  case AvatarAction.const_1943:
                  case AvatarAction.const_1754:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_339.length)
         {
            _loc3_ = this.var_339[_loc4_];
         ...
         this.var_339.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_582 = null;
         this.var_1680 = 0;
         this.var_290 = this.var_912;
         this.var_290.definition = this.var_912.definition;
         this.setActionToParts(this.var_912);
         this.getCache().resetBodyPartCache(this.var_912);
         return true;
      }
      ...
      {
         this.var_1405 = true;
         if(this.var_1314 == this.var_557)
         {
            return;
         }
         this.var_1314 = this.var_557;
         this.var_1404 = this._structure.sortActions(this.var_339);
         if(this.var_1404 == null)
         {
            this.var_836 = new Array(0,0,0);
         }
         else
         {
            this.var_836 = this._structure.getCanvasOffsets(this.var_1404,this._scale,this.var_93);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1404)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1680 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_582 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_375)
               {
                  this.var_911 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1304 = _loc4_.id;
                     this.var_1679 = _loc4_.breed;
                     break;
                  }
               }
            }
