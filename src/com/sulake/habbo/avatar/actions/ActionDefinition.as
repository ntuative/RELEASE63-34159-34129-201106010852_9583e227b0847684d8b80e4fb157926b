package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1912:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1912 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2807 = parseInt(param1.@precedence);
         this.var_2810 = String(param1.@activepartset);
         this.var_2806 = String(param1.@assetpartdefinition);
         this.var_2809 = String(param1.@lay);
         this.var_844 = String(param1.@geometrytype);
         this.var_2808 = Boolean(parseInt(param1.@main));
         this.var_2811 = Boolean(parseInt(param1.@var_782));
         this.var_2813 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2812 = _loc6_;
            }
            else
            {
               this.var_1912[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_836.add(param1,new Map());
         }
         var _loc4_:Map = this.var_836.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_836.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1912[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2812;
         }
         return _loc2_;
      }
