package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1799:Number = 1.0;
      
      private var var_1800:Number = 1.0;
      
      private var var_1796:Number = 1.0;
      ...
      {
         super();
         this.var_1923 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2650 = parseInt(_loc2_,16);
         this.var_2648 = parseInt(_loc3_,16);
         ...
         this.var_810 = new ColorTransform(this.var_1799,this.var_1800,this.var_1796,this._alphaMultiplier);
         this.var_1248 = this.generatePaletteMapForGrayscale(this.var_2648,this.var_2650);
      }
      ...
      {
         return this.var_1248.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1248.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1248.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1248.getValue("alphas") as Array;
      }
