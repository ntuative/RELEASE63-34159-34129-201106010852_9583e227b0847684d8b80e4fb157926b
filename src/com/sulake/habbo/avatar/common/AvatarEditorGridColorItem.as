package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_986:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_688.width,this.var_688.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_688,this.var_688.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1075.width,this.var_1075.height,true,0);
            _loc5_ = this.var_1075.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_986.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_985.width,this.var_985.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_985,this.var_985.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_986)
            {
               switch(this.var_986.clubLevel)
               {
                  case HabboClubLevelEnum.const_55:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_37:
                     _loc4_.style = HabboIconType.const_708;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_45:
                     _loc4_.style = HabboIconType.const_741;
                     _loc4_.visible = true;
               }
            }
            else
