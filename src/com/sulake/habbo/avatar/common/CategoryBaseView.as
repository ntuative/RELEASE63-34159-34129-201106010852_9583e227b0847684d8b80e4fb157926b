package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_153:String = "";
      
      protected var var_47:String = "";
      
      protected var var_71:IAvatarEditorCategoryModel;
      
      protected var var_198:Boolean;
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2141);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_38[this.var_153];
         if(_loc2_ == null)
         {
            return;
         }
