package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2290:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_262)
         {
            for each(_loc2_ in this.var_262 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_236 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1008 >= 0 && this._parts.length > this.var_1008)
         {
            _loc2_ = this._parts[this.var_1008];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_236[param2],param2);
         this.var_236[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_236 || this.var_236.length == 0)
         {
            return null;
         }
         ...
         var _loc1_:Array = this.var_262[0] as Array;
         ...
         {
            _loc7_ = this.var_262[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_236[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_236[_loc5_]] as AvatarEditorGridColorItem;
      ...
      private function getSelectedColors() : Array
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_236.length)
         {
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_236[param1])
         {
            return null;
         }
         return _loc2_[this.var_236[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_262.length <= param1)
         {
            return null;
         }
         return this.var_262[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_1008] as AvatarEditorGridPartItem;
      }
