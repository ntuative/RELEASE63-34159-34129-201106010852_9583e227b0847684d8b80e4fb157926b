package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_2063:AvatarSet;
      
      private var var_853:Dictionary;
      
      private var var_2062:Dictionary;
      
      private var var_1329:Matrix4x4;
      
      private var var_1076:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_1076 = new Vector3D(0,0,10);
         super();
         this.var_1329 = new Matrix4x4();
         this.var_853 = new Dictionary();
         this.var_2062 = new Dictionary();
         this.var_2063 = new AvatarSet(param1.avatarset[0]);
         this.var_169 = new Dictionary();
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1076.x = _loc11_;
            this.var_1076.y = _loc12_;
            this.var_1076.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_853[String(_loc6_.@id)] = _loc7_;
            this.var_2062[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_2063.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_2063.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_169[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_853[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_853[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_853[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_2062[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1329 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1329);
            _loc9_ = _loc7_.getDistance(this.var_1076);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1329 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1329,this.var_1076,param4);
         }
         return [];
      }
