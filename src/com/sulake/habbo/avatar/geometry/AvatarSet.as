package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2808 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1354 = new Dictionary();
         this.var_2123 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1354[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_2123.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_2123.concat();
         for each(_loc3_ in this.var_1354)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2941 = _loc6_;
      }
      ...
      public function findAvatarSet(param1:String) : AvatarSet
      {
         ...
         for each(_loc2_ in this.var_1354)
         {
