package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_71:HotLooksModel;
      
      private var var_617:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_617 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_617.numGridItems > 0)
         {
            this.var_617.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_71 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_617.removeGridItems();
         for each(_loc2_ in this.var_71.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_617.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_617.getGridItemIndex(param2.parent);
            this.var_71.selectHotLook(_loc3_);
         }
      }
