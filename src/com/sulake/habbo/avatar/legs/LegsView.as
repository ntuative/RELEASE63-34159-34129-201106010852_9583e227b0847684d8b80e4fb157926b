   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.const_237,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.const_276,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_71 && var_153 == "")
         {
            var_71.switchCategory(FigureData.TROUSERS);
         }
      }
