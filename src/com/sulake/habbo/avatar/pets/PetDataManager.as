package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      private var var_172:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_467.getValue(_loc4_) == null)
               {
                  this.var_467.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_563 == null)
         {
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_563.length > 0)
         {
            _loc1_ = this.var_563.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_467.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
            this.assetsReady(param1,AvatarScaleType.const_58,param2);
         }
         return _loc3_;
      }
      ...
      public function createPetFigureString(param1:int, param2:int, param3:uint) : String
      {
         ...
         var _loc4_:PetData = this.var_467.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_467.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_467.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_110)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1587.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_680.getValue(_loc6_) == null)
               {
                  ...
                  this.var_680.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_563.indexOf(param3) == -1)
                  {
                     this.var_563.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_680.getKeys())
         {
            _loc5_ = this.var_680.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_292.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
            this.var_292.splice(_loc3_,1);
