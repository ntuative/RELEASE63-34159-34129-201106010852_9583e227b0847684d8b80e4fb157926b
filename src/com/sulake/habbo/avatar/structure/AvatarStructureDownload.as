package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private var var_2704:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_222);
            }
            this.var_1952 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2704.appendXML(this.var_1952);
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_222);
      }
   }
}
