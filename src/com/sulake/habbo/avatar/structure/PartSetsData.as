package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      private var var_1059:Dictionary;
      
      public function PartSetsData()
      {
         super();
         this._parts = new Dictionary();
         this.var_1059 = new Dictionary();
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            this.var_1059[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         var _loc2_:ActivePartSet = this.var_1059[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      {
         return this.var_1059[param1.activePartSet] as ActivePartSet;
      }
   }
}
