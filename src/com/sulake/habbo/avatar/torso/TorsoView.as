   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.const_267,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.const_202,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_71,FigureData.const_250,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_71 && var_153 == "")
         {
            var_71.switchCategory(FigureData.const_202);
         }
      }
