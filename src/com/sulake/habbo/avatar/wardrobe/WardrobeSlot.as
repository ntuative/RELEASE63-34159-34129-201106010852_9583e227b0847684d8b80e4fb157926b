package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_354 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this.var_605 && this.var_1443)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_110,this.var_941,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_43,parseInt(FigureData.const_859));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_605 = this._controller.figureData.getFigureString();
               this.var_941 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1780,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_605)
               {
                  this._controller.loadAvatarInEditor(this.var_605,this.var_941,this._controller.clubMemberLevel);
               }
         }
      }
