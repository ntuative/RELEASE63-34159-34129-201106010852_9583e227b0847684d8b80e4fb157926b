package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_675:uint = 1;
      ...
      private var var_1148:IRoomSession;
      ...
      private var var_211:CatalogViewer;
      
      private var var_378:ICatalogNavigator;
      
      private var var_107:Purse;
      
      private var var_97:RecyclerLogic;
      
      private var var_143:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_187:PurchaseConfirmationDialog;
      
      private var var_210:ChargeConfirmationDialog;
      ...
      private var var_2662:Boolean = true;
      
      private var var_1936:Boolean = false;
      
      private var var_2663:GiftWrappingConfiguration;
      
      private var var_1252:ClubGiftController;
      
      private var var_544:ClubBuyController;
      
      private var var_806:Map;
      
      private var var_1253:Boolean = false;
      
      private var var_805:IPurchasableOffer;
      
      private var var_1520:IDragAndDropDoneReceiver;
      
      private var var_59:PlacedObjectPurchaseData;
      
      private const const_1994:Point = new Point(100,20);
      
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_806 = new Map();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_97,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1825);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_377.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_187 == null || this.var_187.disposed)
            {
               this.var_187 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_187.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_544.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_377.loadProductData(this);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_197.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_197.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_377.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_377.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_66)
         {
            _loc3_ = this.var_377.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_806.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_107.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
      ...
      {
         if(param1.iconId == HabboToolbarIconEnum.CATALOGUE && param1.type == HabboToolbarEvent.const_50)
         {
            this.toggleCatalog();
         }
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            HabboTracking.getInstance().track("catalogue","open");
         }
         if(this.mainWindowVisible())
         {
            events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(this.var_97 != null && this.getCurrentLayoutCode() == "recycler")
            {
         ...
         this.setupInventoryForRecycler(this.var_97.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_211.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_211 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_211.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_675) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1994;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_248,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1936 = param1.session.isPrivateRoom;
               this.var_1148 = param1.session;
               if(this.var_97 != null)
               {
                  this.var_97.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_97:
               ...
               if(this.var_97 != null)
               {
                  this.var_97.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_97 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_143 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1252 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_544 == null)
         {
            this.var_544 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_211 != null)
         {
            this.var_211.catalogWindowClosed();
         }
         if(this.var_97 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_97.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_807 && this.var_807 != "")
         {
            this.var_378.openPage(this.var_807);
            this.var_807 = "";
            this.var_1017 = -1;
         }
         else if(this.var_1017 > -1)
         {
            this.var_378.openPageById(this.var_1017,this.var_1935);
            this.var_1017 = -1;
            this.var_1935 = -1;
            this.var_807 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_211.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_211 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_211.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2664 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1152);
         }
         this.var_2664 = false;
         if(this.var_210 != null && !this.var_210.disposed)
         {
            this.var_210.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_74,this.var_107.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2662 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1279);
         }
         this.var_2662 = false;
         if(this.var_210 != null && !this.var_210.disposed)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1252.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_97 == null)
         {
            return;
         }
         this.var_97.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_97.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_97.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_143 != null)
         {
            this.var_143.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_143 != null)
         {
            this.var_143.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_143 != null)
         {
            this.var_143.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2663 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_143.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_210 == null || this.var_210.disposed)
         {
            this.var_210 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_210.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_806.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_806.add(_loc2_.productCode,_loc3_.slice());
            this.var_211.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_197.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_197.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_173)
         {
            _loc3_ = this.var_197.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_197.keyExists("catalog.drag_and_drop") || this.var_197.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1148 || !this.var_1148.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_195);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_213);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1253 && param1.type == RoomEngineObjectEvent.const_163)
         {
            this.resetPlacedOfferData(true);
            if(this.var_805 == null || this.var_805.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_805.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_59 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_805);
            _loc5_ = this.var_1520;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_352,0.5);
            }
         }
      }
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_59)
         {
            if(this.var_59.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_59 != null)
         {
            if(this.var_59.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_59.roomId,this.var_59.roomCategory,this.var_59.objectId);
            }
            else if(this.var_59.category == RoomObjectCategoryEnum.const_26)
            {
               switch(this.var_59.furniData.name)
               {
                  case "floor":
                  case "wallpaper":
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.disposeObjectWallItem(this.var_59.roomId,this.var_59.roomCategory,this.var_59.objectId);
               }
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_59.objectId,this.var_59.category);
            }
            this.var_59.dispose();
            this.var_59 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_59 != null && this.var_59.productClassId == param1.classId)
         {
            if(this.var_59.roomCategory == this._roomEngine.activeRoomCategory && this.var_59.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_59.category;
               _loc4_ = this.var_59.wallLocation;
               _loc5_ = this.var_59.x;
               _loc6_ = this.var_59.y;
               _loc7_ = this.var_59.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_309:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_213);
                     if(this.var_59.extraParameter != _loc8_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_303:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_195);
                     if(this.var_59.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_312:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
                     if(this.var_59.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_197.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_675);
            if(_loc1_ != null)
            {
