package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_99:ClubBuyOfferData;
      ...
      {
         var _loc3_:* = null;
         if(!this.var_99 || !this._controller)
         {
            return;
         }
         ...
         _loc6_ += !!this.var_99.vip ? "vip" : "hc";
         _loc6_ += !!this.var_99.upgrade ? ".period" : "";
         ...
         var _loc11_:String = !!this.var_99.vip ? "vip" : "hc";
         var _loc12_:String = _loc2_.getLocalization("catalog.club." + _loc11_).value;
         var _loc13_:int = this.var_99.periods == 0 ? 1 : int(this.var_99.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(this.var_99.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(this.var_99.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(this.var_99.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(this.var_99.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(this.var_99.daysLeftAfterPurchase));
         if(this.var_99.upgrade)
         {
      ...
      {
         var _loc1_:* = null;
         if(this.var_99 && this.var_99.productContainer && this.var_99.productContainer.firstProduct)
         {
            _loc1_ = this.var_99.productContainer.firstProduct.productData;
            if(_loc1_)
            {
               return _loc1_.name;
            }
      ...
      {
         if(!param1 || !param2 || !this._controller || !this.var_99)
         {
            return;
         }
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_99,this.var_1516);
               break;
