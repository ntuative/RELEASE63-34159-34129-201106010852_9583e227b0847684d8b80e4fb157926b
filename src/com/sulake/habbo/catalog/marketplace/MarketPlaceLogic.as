package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1506:String = "poster";
       
      
      public const const_2094:int = 1;
      
      public const const_2075:int = 2;
      
      public const const_2292:int = 3;
      ...
      private var var_187:MarketplaceConfirmationDialog;
      ...
      private var var_2555:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_258);
            this.var_258 = null;
         }
         if(this.var_313 != null)
         {
            this.disposeOffers(this.var_313);
            this.var_313 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_187)
         {
            this.var_187 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_187.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2556,this.var_2561,this.var_2560,this.var_2558);
      }
      ...
      {
         if(!this.var_258 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_258.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_2094,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_313.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_313.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_561)
            {
               this.var_313.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_258.add(_loc4_.offerId,_loc5_);
         }
         this.var_2559 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2557 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_313.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_258.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_258.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_258.add(parser.offerId,updateItem);
            }
            this.var_258.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_2075,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_313.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2541 || param1.furniTypeId != this.var_2540)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         {
            _loc3_ = this._catalog.getFurnitureData(param1.furniId,ProductTypeEnum.const_66);
            if(_loc3_)
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1506)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_107)
            {
               _loc2_ = "roomItem.name." + param1.furniId;
            }
            else if(param1.furniType == MarketPlaceOfferData.const_71)
            {
