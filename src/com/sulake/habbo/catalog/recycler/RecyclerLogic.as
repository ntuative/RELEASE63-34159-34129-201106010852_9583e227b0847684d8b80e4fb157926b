package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1023:int = 0;
      
      private static const const_447:int = 1;
      
      private static const const_1022:int = 2;
      ...
      {
         return this.var_594 != const_1023;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1696 != RecyclerStatusMessageEvent.const_1360;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_594 == const_447;
      }
      ...
      {
         this.var_594 = const_1022;
         this.var_115 = new Array(const_221);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_221)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_594 = const_1023;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1696)
         {
            case RecyclerStatusMessageEvent.const_1886:
               this.var_594 = const_447;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1360:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1702:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1356:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1852:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_115.length > 0)
         {
            oldObjectData = this.var_115[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_221)
            {
               oldObjectData = this.var_115[newSlotId];
         ...
         this.var_115[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_115[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_115[param1].id))
         {
            return;
         }
         this.var_115[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_115.length)
         {
            _loc3_ = this.var_115[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_115.length < const_221)
         {
            return false;
         }
         var _loc1_:int = 0;
