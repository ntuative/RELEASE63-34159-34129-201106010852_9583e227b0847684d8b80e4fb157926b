package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1966:String = "ctlg_";
       
      
      protected var var_2174:XML;
      ...
      private var var_1139:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1138);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1138);
      }
      ...
      {
         var _loc2_:String = const_1966 + param1;
         ...
         this.var_2174 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2174) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1769:
               if(this.var_1139 == null)
               {
                  this.var_1139 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_36.push(this.var_1139);
               }
               break;
            case CatalogWidgetEnum.const_1711:
               this.var_36.push(new ItemGroupCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            case CatalogWidgetEnum.const_1952:
               this.var_36.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1935:
               this.var_36.push(new SongDiskProductViewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1693:
               this.var_36.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1838:
               this.var_36.push(new PurchaseCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            case CatalogWidgetEnum.const_1857:
               this.var_36.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1883:
               this.var_36.push(new ColourGridCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1771:
               this.var_36.push(new TraxPreviewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1870:
               this.var_36.push(new RedeemItemCodeCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1901:
               this.var_36.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1782:
               this.var_36.push(new SpacesNewCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            case CatalogWidgetEnum.const_1668:
               this.var_36.push(new RoomPreviewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1706:
               this.var_36.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1822:
               this.var_36.push(new PetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1926:
            ...
            case CatalogWidgetEnum.const_1826:
               ...
               break;
            case CatalogWidgetEnum.const_1847:
