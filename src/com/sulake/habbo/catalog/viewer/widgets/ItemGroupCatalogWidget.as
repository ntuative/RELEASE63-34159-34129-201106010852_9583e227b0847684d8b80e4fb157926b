package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_207[this.var_527][this.var_637];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_527 = var_484.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_527];
         var _loc3_:Array = this.var_207[this.var_527] as Array;
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_637));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_207[this.var_527] as Array;
         var _loc3_:Offer = _loc2_[this.var_637] as Offer;
         if(_loc3_ != null)
         {
            if(var_31.hasUserRight(null,_loc3_.clubLevel))
            {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_637 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_637] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_207[this.var_527] as Array;
         var _loc2_:Offer = _loc1_[this.var_637] as Offer;
         var_220 = _loc2_.productContainer as ProductGridItem;
         var_220.activate();
      }
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_409 || _loc1_.pricingModel == Offer.const_410)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_66 || _loc3_.productType == ProductTypeEnum.const_79)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_207[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
