package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2011:int = 1;
      
      private const const_2010:int = 2;
      
      private const const_2263:int = 40;
      
      private const const_2264:int = 10;
      
      private var var_818:Array;
      
      private var var_1528:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_547)
         {
            this.var_547.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_547 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_818 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_818 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_818));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_658)
         {
            ...
            this.var_658 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_658)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2010,_loc3_.length,_loc2_);
         if(!this.var_547)
         {
            this.var_547 = new Timer(25);
            this.var_547.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1263 = 0;
         this.populateList();
         this.var_547.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1263 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1263));
            ++this.var_1263;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_658 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_658.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2011);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_818.length)
         {
            _loc4_ = this.var_818[_loc6_.selection];
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_113)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2264;
                  break;
               case "search_input":
                  _loc8_ = this.const_2263;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1528.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_49)
