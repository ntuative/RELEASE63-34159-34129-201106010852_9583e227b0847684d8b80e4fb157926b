package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1422:int = 18;
      ...
      private var var_199:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_113,this.onTextWindowEvent);
         ...
         this.var_515 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_515 < 8)
         {
            return false;
         }
         this.var_2304 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_199 != null && this.var_199.length > 0)
         {
            this.var_353 = this.var_199[0];
         }
         else
         {
            this.var_353 = -1;
         }
         this._offers.add(this.var_515,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_199 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1422 && _loc2_ < this.var_199.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_515,this.var_199[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_199 != null && this.var_199.length > 0)
         {
            ...
            this.var_353 = this.var_199[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_515,this.var_353),this.getRaceLocalizationKey(this.var_515,this.var_353));
            }
         }
         return this.getRaceLocalizationKey(this.var_515,this.var_353);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_353 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_515;
         var _loc3_:int = this.var_353;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_353 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
