package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_627 = this.recycler.getPrizeTable();
         ...
         this.var_1845 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_627.length > 0 && this.var_627[0].prizes.length > 0)
         {
            this.select(this.var_627[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      private function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_627[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1845) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1846) as IWindowContainer;
