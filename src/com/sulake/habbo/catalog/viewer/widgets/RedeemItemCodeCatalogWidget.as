package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_944:IButtonWindow;
      
      private var var_945:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_944.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_944 = null;
         }
         if(this.var_945 != null)
         {
            this.var_945.removeEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
            this.var_945 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_944 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_944 != null)
         {
            this.var_944.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_945 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_945 != null)
         {
            this.var_945.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         }
         return true;
      }
