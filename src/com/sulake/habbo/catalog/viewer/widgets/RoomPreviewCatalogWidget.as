   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_508 != null && this.var_508 == param2)
         {
            if(this.var_99)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_99);
               this.var_508 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_1986 = _loc3_.id;
            this.var_1985 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_382 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_382,this._imageStoreWindow);
         }
      }
   }
}
