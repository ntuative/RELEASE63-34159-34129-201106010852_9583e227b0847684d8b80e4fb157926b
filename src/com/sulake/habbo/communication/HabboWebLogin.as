package com.sulake.habbo.communication
{
   ...
   public class HabboWebLogin extends EventDispatcher implements IHabboWebLogin
   {
      ...
      public function HabboWebLogin(param1:String, param2:String, param3:String, param4:IEventDispatcher = null)
      {
         ...
         this.var_2544 = "https://" + param3 + "/account/submit";
         this.var_2543 = "https://" + param3 + "/security_check";
         this.var_2545 = "https://" + param3 + "/account/reauthenticate";
      }
      ...
      private function requestCredentials() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(this.var_2544);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         this.var_42 = new URLLoader();
         this.var_42.addEventListener(Event.COMPLETE,this.credentialsComplete);
         this.configureListeners(this.var_42);
         this.var_42.load(_loc2_);
      }
      ...
      private function credentialsComplete(param1:Event = null) : void
      {
         ...
         if(_loc3_.indexOf("Redirecting") > -1 && _loc3_.indexOf("/useOrCreateAvatar/") != -1)
         {
            ...
            this.var_42.load(_loc5_);
            return;
         }
         this.var_42.removeEventListener(Event.COMPLETE,this.credentialsComplete);
         this.removeListeners(this.var_42);
         ...
         {
            dispatchEvent(new Event(HabboWeb.const_234));
         }
      ...
      private function requestSecurityCheck() : void
      {
         ...
         this.var_42 = new URLLoader();
         this.var_42.addEventListener(Event.COMPLETE,this.securityCheckComplete);
         this.configureListeners(this.var_42);
         this.var_42.load(_loc1_);
      }
      
      private function securityCheckComplete(param1:Event = null) : void
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         this.var_42.removeEventListener(Event.COMPLETE,this.securityCheckComplete);
         this.removeListeners(this.var_42);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
      ...
      public function requestReAuthenticate() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(this.var_2545);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         this.var_42 = new URLLoader();
         this.var_42.addEventListener(Event.COMPLETE,this.reauthenticateComplete);
         this.configureListeners(this.var_42);
         this.var_42.load(_loc2_);
      }
      ...
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         this.var_42.removeEventListener(Event.COMPLETE,this.reauthenticateComplete);
         this.removeListeners(this.var_42);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
