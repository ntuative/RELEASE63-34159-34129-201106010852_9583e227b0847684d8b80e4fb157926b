package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_948:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1223:Function;
      
      private var var_1221:Function;
      
      private var var_794:IAssetLibrary;
      
      private var var_1222:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_794 = param2;
         this._events = param3;
         this.var_948 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_794.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_794.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_29)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_555));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1221 != null)
            {
               this.var_1221(_loc4_);
               this.var_1221 = null;
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_794.loadAssetFromFile("hotel_view_banner_" + this.var_1222,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_700));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_948.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_948.removeChild(this._window);
         }
      }
   }
}
