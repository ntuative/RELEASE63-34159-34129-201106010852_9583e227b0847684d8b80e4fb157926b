package com.sulake.habbo.communication.messages.incoming.navigator
{
   ...
   public class GuestRoomSearchResultData implements IDisposable, MsgWithRequestId
   {
      ...
      private var var_1330:OfficialRoomEntryData;
      ...
      public function GuestRoomSearchResultData(param1:IMessageDataWrapper)
      {
         ...
         this.var_2896 = param1.readString();
         var _loc2_:int = param1.readInteger();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.var_114.push(new GuestRoomData(param1));
            _loc3_++;
         }
         var _loc4_:Boolean = param1.readBoolean();
         if(_loc4_)
         {
            this.var_1330 = new OfficialRoomEntryData(param1);
         }
      }
