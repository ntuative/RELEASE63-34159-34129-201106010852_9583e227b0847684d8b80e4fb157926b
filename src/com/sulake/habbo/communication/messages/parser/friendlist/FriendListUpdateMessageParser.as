package com.sulake.habbo.communication.messages.parser.friendlist
{
   ...
   public class FriendListUpdateMessageParser implements IMessageParser
   {
      ...
      public function flush() : Boolean
      {
         ...
         this.var_1766 = new Array();
         this.var_1767 = new Array();
         return true;
      }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1765.push(new FriendCategoryData(param1));
            _loc3_++;
         }
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            {
               this.var_1767.push(new FriendData(param1));
            }
            else if(_loc5_ == 1)
            {
               this.var_1766.push(new FriendData(param1));
            }
            _loc3_++;
         }
         return true;
