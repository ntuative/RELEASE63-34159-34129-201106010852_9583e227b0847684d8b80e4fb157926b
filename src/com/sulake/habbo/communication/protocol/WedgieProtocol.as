package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1791:uint = 1;
      
      public static const const_1950:uint = 2;
       
      
      private var var_1422:IProtocolEncoder;
      
      private var var_1136:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1422 = new WedgieEncoder();
         this.var_1136 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1791)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1136.getID(_loc4_);
