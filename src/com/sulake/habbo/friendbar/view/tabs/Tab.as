package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class Tab implements ITab
   {
      ...
      public static var var_1095:IHabboFriendBarData;
      
      public static var var_1634:IHabboFriendBarView;
      
      public static var var_480:IAssetLibrary;
      
      public static var var_705:IHabboWindowManager;
      ...
      protected function onMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         if(this.selected)
         {
            var_1634.deSelect(true);
         }
         else
         {
            var_1634.selectTab(this);
         }
      }
