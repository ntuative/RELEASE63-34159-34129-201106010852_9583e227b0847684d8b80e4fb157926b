package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1983:String = "no_reqs_info";
      ...
      private var var_1731:IContainerButtonWindow;
      
      private var var_1730:IContainerButtonWindow;
      ...
      {
         this.var_1731 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1730 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1730.procedure = this.onDismissAllButtonClick;
         this.var_1731.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_99,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_172)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_60.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_60.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_437;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_397;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_353,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_437 && _loc4_.state != FriendRequest.const_397)
            {
               _loc4_.state = FriendRequest.const_397;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_353,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_437 && _loc4_.state != FriendRequest.const_397)
            {
               ...
               _loc4_.state = FriendRequest.const_437;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1731,_loc1_);
         this.setEnabled(this.var_1730,_loc1_);
      }
