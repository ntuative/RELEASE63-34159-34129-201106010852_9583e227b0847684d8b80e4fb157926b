package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2223:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2919:IContainerButtonWindow;
      
      private var var_2920:IContainerButtonWindow;
      
      private var var_2918:IContainerButtonWindow;
      
      private var var_2318:IContainerButtonWindow;
      
      private var var_60:IItemListWindow;
      
      private var var_619:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_619 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2919 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2920 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2918 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2318 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_111).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_60.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_60.addListItem(_loc6_);
         }
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_111,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_111,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2919,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2920,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2918,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2318,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_619.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_619.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_619.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_159)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_159 && _loc4_.online)
            {
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._friendList.send(new ConversionPointMessageComposer("Navigation","Friend List","go.friendlist"));
      }
      ...
      private function refreshPager(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         if(param1.method_2() < 2 || !param1.open)
         {
            Logger.log("PAGER NOT VISIBLE: " + param1.open + ", " + param1.method_2());
            _loc3_.visible = false;
            return;
         }
         _loc3_.visible = true;
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_111,param4);
         _loc6_.visible = true;
      }
