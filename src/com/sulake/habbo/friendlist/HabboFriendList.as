package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_187:String = "face";
      ...
      private var var_140:IHabboMessenger;
      ...
      private var var_2291:FriendListLookAndFeel;
      
      private var var_429:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1700:OpenedToWebPopup;
      
      private var var_2292:int;
      
      var var_106:FriendCategories;
      
      private var _friendRequests:FriendRequests;
      
      private var var_1699:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_983:IHabboNotifications;
      
      private var var_595:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2291 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_106 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1699 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_595.stop();
            this.var_595.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_595 = null;
         }
         ...
         if(this.var_140)
         {
            this.var_140.release(new IIDHabboMessenger());
            this.var_140 = null;
         }
         if(this.var_197)
         {
         ...
         if(this.var_959)
         {
            this.var_959.release(new IIDAvatarRenderManager());
            this.var_959 = null;
         }
         if(this.var_983)
         {
            this.var_983.release(new IIDHabboNotifications());
            this.var_983 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_729)
         {
            this.var_729.release(new IIDSessionDataManager());
            this.var_729 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1700 = new OpenedToWebPopup(this);
         }
         this.var_1700.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_106.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_111);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_99);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_422);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_106.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_343,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_959.createAvatarImage(param1,AvatarScaleType.const_110,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_52);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_197.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_197.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_140 = param2 as IHabboMessenger;
      ...
      {
         this.var_983 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_106.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_1332,this.getText("friendlist.friends")));
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_416,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_106.addFriend(new Friend(_loc4_));
         }
         this.var_429 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_595)
         {
            this.var_595 = new Timer(120000);
            this.var_595.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_595.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_106.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_106.findCategory(FriendCategory.const_416);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_429.findTab(FriendListTab.const_99).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_429.findTab(FriendListTab.const_99);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1699.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_106.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_106.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_429.findTab(FriendListTab.const_99);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_729 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_729.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_729.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_37))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_106 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_106.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_187) as IBitmapWrapperWindow;
