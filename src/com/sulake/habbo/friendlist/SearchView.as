package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_733:ITextFieldWindow;
      ...
      {
         this.var_733 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_733.procedure = this.onSearchInput;
         this.var_733.addEventListener(WindowKeyboardEvent.const_192,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_60.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_422,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_60.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_60.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_619.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_619.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_60.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_733.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_733.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_733.text;
