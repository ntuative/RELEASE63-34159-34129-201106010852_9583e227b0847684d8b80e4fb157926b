package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2090:int = "F".charCodeAt(0);
      
      public static const const_2215:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_941 = param1.gender;
         this._online = param1.online;
         this.var_1695 = param1.followingAllowed && param1.online;
         this.var_605 = param1.figure;
         this.var_1772 = param1.motto;
         this.var_1771 = param1.lastAccess;
         this.var_1586 = param1.categoryId;
         this.var_1773 = param1.realName;
