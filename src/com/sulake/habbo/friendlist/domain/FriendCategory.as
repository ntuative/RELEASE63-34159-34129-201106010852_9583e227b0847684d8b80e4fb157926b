package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_399:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_234.indexOf(param1) >= 0)
         {
            return;
         }
         var _loc2_:String = param1.name.toLowerCase();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_234.length)
         {
            _loc4_ = this.var_234[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_234.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
         this.var_234.push(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_234)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_234,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_975 >= this.method_2())
         {
            this.var_975 = Math.max(0,this.method_2() - 1);
         }
      }
      
      public function method_2() : int
      {
         return Math.ceil(this.var_234.length / const_399);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_975 * const_399;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_975 + 1) * const_399,this.var_234.length);
      }
