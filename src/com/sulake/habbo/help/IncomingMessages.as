package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCallForHelpReply(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showCallForHelpReply(_loc2_.message);
      }
      ...
      private function onRoomEntryInfo(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_22.enableCallForGuideBotUI();
         }
         else
         {
            this.var_22.disableCallForGuideBotUI();
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         this.var_22.userRegistry.registerRoom(this.var_22.localization.getKey(_loc3_));
      }
      ...
      private function onGuestRoomResult(param1:IMessageEvent) : void
      {
         ...
         this.var_22.userRegistry.registerRoom(_loc2_.data.roomName);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_22.ownUserName = _loc2_.name;
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         this.var_22.ownUserName = _loc2_.newName;
         if(this.var_22.tutorialUI)
         {
            this.var_22.tutorialUI.onUserNameChanged(_loc2_.newName);
         }
         if(this.var_22.hotelMergeUI)
         {
            this.var_22.hotelMergeUI.onUserNameChanged(_loc2_.newName);
         }
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(this.var_2388 != _loc2_.id)
         {
            return;
         }
         if(this.var_22 == null || this.var_22.tutorialUI == null)
         {
            return;
         }
         this.var_22.tutorialUI.onUserChanged();
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_132)
            {
               this.var_22.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2388 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_22.tellUI(HabboHelpViewEnum.const_814);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         this.var_22.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + this.getCloseReasonKey(_loc3_.closeReason) + "}",0,this.onAlertClose);
      }
      ...
      private function onCallForHelpResult(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showCallForHelpResult(_loc4_);
      }
      
      private function onPendingCallsForHelpDeleted(param1:IMessageEvent) : void
      {
         this.var_22.showUI(HabboHelpViewEnum.const_405);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FaqIndex = this.var_22.getFaq();
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_224);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_593);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_327,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_22.tellUI(HabboHelpViewEnum.const_289,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1224);
         this.var_22.tellUI(HabboHelpViewEnum.const_1224,_loc5_);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_22.updateTutorial(_loc2_.hasChangedLooks,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(this.var_22.tutorialUI)
         {
            this.var_22.tutorialUI.onChangeUserNameResult(param1);
         }
         if(this.var_22.hotelMergeUI)
         {
            this.var_22.hotelMergeUI.onChangeUserNameResult(param1);
         }
      }
      ...
      private function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(this.var_22.tutorialUI)
         {
            this.var_22.tutorialUI.onCheckUserNameResult(param1);
         }
         if(this.var_22.hotelMergeUI)
         {
            this.var_22.hotelMergeUI.onCheckUserNameResult(param1);
         }
      }
