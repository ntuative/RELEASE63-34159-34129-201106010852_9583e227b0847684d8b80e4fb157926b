package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_239 = FaqItem(param1);
         }
         if(this.var_239 == null)
         {
            return;
         }
         if(!this.var_239.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_239.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_239.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_239.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_239.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_239.index + 1);
         }
         ...
         if(_loc6_ != null)
         {
            if(_loc5_ != null)
            {
               ...
               _loc6_.setParamFlag(WindowParam.const_31);
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            _loc2_ = this.var_239.category;
            main.showUI(HabboHelpViewEnum.const_327);
            main.tellUI(HabboHelpViewEnum.const_327,_loc2_);
         }
      }
      ...
      private function onNextEntry(param1:WindowMouseEvent) : void
      {
         ...
         {
            main.tellUI(HabboHelpViewEnum.const_289,this.getNextItem());
         }
      }
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_239 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_239.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_239.index + 1);
      }
   }
}
