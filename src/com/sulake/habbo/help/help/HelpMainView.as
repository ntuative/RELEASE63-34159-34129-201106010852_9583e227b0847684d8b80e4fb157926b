package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1426:int = 60;
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(_loc5_ != null)
         {
            _loc10_ = _loc5_.getFrontPageUrgentCategory().method_3();
            ...
            _loc10_ = _loc5_.getFrontPageNormalCategory().method_3();
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_289);
            main.tellUI(HabboHelpViewEnum.const_289,_loc6_);
         }
      }
   }
}
