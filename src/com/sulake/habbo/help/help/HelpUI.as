package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2084:String = "HHVE_HELP_FRONTPAGE";
      ...
      {
         this.var_400 = this.var_2084;
         this.var_568 = new Array();
         this.var_693 = new Array();
         super();
         this.var_22 = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106010847));
         this.var_129 = new Map();
         this.var_129.add(HabboHelpViewEnum.const_1917,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_224,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_593,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_327,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_289,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_405,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_914,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_294,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_129.add(HabboHelpViewEnum.const_1322,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_129.add(HabboHelpViewEnum.const_1169,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_814,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_129.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_129.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_568.length == 0 || param1 != this.var_400)
            {
               this.var_568.push(this.var_400);
            }
         }
         this.var_400 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_400);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_294:
               this.showUI(HabboHelpViewEnum.const_294);
               break;
            case CallForHelpResultEnum.const_1172:
               this.showUI(HabboHelpViewEnum.const_1169);
               break;
            case CallForHelpResultEnum.const_1281:
               this.showUI(HabboHelpViewEnum.const_1322);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_129.getValue(HabboHelpViewEnum.const_224) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_548));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_129.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_129.getValue(this.var_400);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2201 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2199;
         this._window.width = _loc1_.width + this.var_2201;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_568.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_400 == HabboHelpViewEnum.const_224)
         {
            return;
         }
         if(this.var_693.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_693.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_693.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_401.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_693[1],this.var_693[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_693[0],this.var_693[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_400 == HabboHelpViewEnum.const_224 || this.var_568.length == 0)
         {
            return;
         }
         if(this.var_401 == null)
         {
            ...
            this.var_401 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_401.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_401.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_401 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_401 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_401 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
