package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function storeItem(param1:int, param2:String, param3:String = null) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_160.length,this);
      ...
      {
         return this.var_160.getValue(param1) != null;
      }
      
      public function getItem(param1:int) : FaqItem
      {
         return this.var_160.getValue(param1);
      }
      ...
      public function method_3() : Array
      {
         var _loc2_:* = null;
      ...
      {
         return this.var_160.length > 0 || this.hasUpdatedWithinHour();
      }
      
      public function setTimeStamp() : void
      {
         this.var_1793 = new Date();
      }
      ...
      public function getAgeSeconds() : Number
      {
         ...
         return (new Date().valueOf() - this.var_1793.valueOf()) / 1000;
      }
