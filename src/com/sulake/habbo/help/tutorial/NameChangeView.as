package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private var var_1261:NameSuggestionListRenderer;
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_43.width;
            this._window.content.height = this.var_43.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1946 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_814)
         {
            this.var_814 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_814)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_815)
         {
            this.var_815 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_815)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_815.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_546;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_546);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_884:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_881:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_882:
               break;
            case ChangeUserNameResultMessageEvent.var_883:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_880:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1097 || param1 == ChangeUserNameResultMessageEvent.var_1096)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1261 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1261.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_546 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_546);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_91);
         }
      }
