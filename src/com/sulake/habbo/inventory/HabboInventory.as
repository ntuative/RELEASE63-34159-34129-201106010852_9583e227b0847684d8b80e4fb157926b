package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_2921:Boolean;
      
      private var var_2922:int;
      
      private const const_2285:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_632,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_53.getValue(InventoryCategory.const_67));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_53.getValue(InventorySubCategory.const_354));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_53.getValue(InventoryCategory.const_1001));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_53.getValue(InventoryCategory.const_261));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_53.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_53.getValue(InventorySubCategory.const_1180));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_53.getValue(InventoryCategory.const_131));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_53.getValue(InventoryCategory.const_388) as MarketplaceModel;
      }
      ...
      public function get clubLevel() : int
      {
         ...
         return HabboClubLevelEnum.const_37;
      }
      ...
      {
         this.var_377 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_632,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               this.var_1148 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_632:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_377 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_53.add(InventoryCategory.const_388,_loc1_);
         ...
         this.var_53.add(InventoryCategory.const_67,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_377);
         this.var_53.add(InventoryCategory.const_261,_loc3_);
         ...
         this.var_53.add(InventoryCategory.const_1001,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_377);
         this.var_53.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_53.add(InventorySubCategory.const_354,_loc6_);
         ...
         this.var_53.add(InventorySubCategory.const_1180,_loc7_);
         ...
         this.var_53.add(InventoryCategory.const_131,_loc8_);
         _loc2_.petsModel = _loc8_;
         _loc8_.furniModel = _loc2_;
         this.var_198 = true;
         if(this.var_2921)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_354:
               this._view.toggleCategoryView(InventoryCategory.const_67,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1086.indexOf(param1) == -1)
            {
               this.var_1086.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_1086.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1086.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1086.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2285);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_998));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2922)
         {
            this.var_2922 = _loc1_;
            this._view.updateUnseenItemCounts();
            this._toolbar.setUnseenItemCount(HabboToolbarIconEnum.INVENTORY,_loc1_);
         }
      }
      
      public function isStandaloneAchievementListEnabled() : Boolean
      {
         return this._config.getBoolean("standaloneAchievementList.enabled",false);
      }
   }
}
