package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         this.var_24 = this._inventory.communication;
         this.var_24.addHabboConnectionMessageEvent(new FurniListEvent(this.onFurniList));
         this.var_24.addHabboConnectionMessageEvent(new FurniListInsertEvent(this.onFurniListInsert));
         this.var_24.addHabboConnectionMessageEvent(new FurniListRemoveEvent(this.onFurniListRemove));
         this.var_24.addHabboConnectionMessageEvent(new FurniListUpdateEvent(this.onFurniListUpdate));
         this.var_24.addHabboConnectionMessageEvent(new PostItPlacedEvent(this.onPostItPlaced));
         this.var_24.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(this.onAvatarEffects));
         this.var_24.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(this.onAvatarEffectActivated));
         this.var_24.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(this.onAvatarEffectAdded));
         this.var_24.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(this.onAvatarEffectExpired));
         this.var_24.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(this.onClubStatus));
         this.var_24.addHabboConnectionMessageEvent(new BadgesEvent(this.onBadges));
         this.var_24.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(this.onUserBadges));
         this.var_24.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.onAchievementReceived));
         this.var_24.addHabboConnectionMessageEvent(new BadgePointLimitsEvent(this.onBadgePointLimits));
         this.var_24.addHabboConnectionMessageEvent(new AchievementsEvent(this.onAchievements));
         this.var_24.addHabboConnectionMessageEvent(new AchievementsScoreEvent(this.onAchievementsScore));
         this.var_24.addHabboConnectionMessageEvent(new TradingAcceptEvent(this.onTradingAccepted,TradingAcceptParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingConfirmationEvent(this.onTradingConfirmation,TradingConfirmationParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(this.onTradingAlreadyOpen,TradingAlreadyOpenParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingCloseEvent(this.onTradingClose,TradingCloseParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingCompletedEvent(this.onTradingCompleted,TradingCompletedParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingItemListEvent(this.onTradingItemList,TradingItemListParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingNotOpenEvent(this.onTradingNotOpen,TradingNotOpenParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingOpenEvent(this.onTradingOpen,TradingOpenParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(this.onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         this.var_24.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(this.onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         this.var_24.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(this.onRoomClosed));
         this.var_24.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(this.onRoomClosed));
         this.var_24.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(this.onRoomClosed));
         this.var_24.addHabboConnectionMessageEvent(new PetInventoryEvent(this.onPets));
         this.var_24.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(this.onPetAdded));
         this.var_24.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(this.onPetRemoved));
         this.var_24.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(this.onPetInventoryUpdated));
         this.var_24.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(this.onMarketplaceConfiguration));
         this.var_24.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(this.onMarketplaceCanMakeOfferResult));
         this.var_24.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(this.onMarketplaceMakeOfferResult));
         this.var_24.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(this.onMarketplaceItemStats));
         this.var_24.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(this.onNotEnoughCredits));
         this.var_24.addHabboConnectionMessageEvent(new UserRightsMessageEvent(this.onUserRights));
         this.var_24.addHabboConnectionMessageEvent(new UnseenItemsEvent(this.onUnseenItems));
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return this.var_24.getHabboMainConnection(null);
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_67,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_1001);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_261);
      }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:BadgesModel = this._inventory.badgesModel;
         if(_loc4_ != null)
         {
      ...
      {
         if(this._inventory.isStandaloneAchievementListEnabled())
         {
            return;
         }
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.ACHIEVEMENTS);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_354);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_194)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModelCategory.const_39,_loc9_.category,_loc9_.stuffData);
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModelCategory.const_47,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_131);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_388);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_388))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this._inventory.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_417));
         this._inventory.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_394));
         this._inventory.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_57));
         this._inventory.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1303));
