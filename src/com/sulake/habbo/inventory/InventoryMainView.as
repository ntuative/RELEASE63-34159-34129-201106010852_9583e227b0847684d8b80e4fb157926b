package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2906:IWindowContainer;
      ...
      private var var_2072:IWindowContainer;
      
      private const const_1994:Point = new Point(120,150);
      ...
      public function InventoryMainView(param1:HabboInventory, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         if(this.var_16 != null)
         {
            ...
            {
               _loc6_ = ITabContextWindow(this.var_16.findChildByName("contentArea"));
               _loc7_ = ITabButtonWindow(this.var_16.findChildByName("achievements"));
               _loc6_.removeTabItem(_loc7_);
               --this.var_16.findChildByName("badges").x;
            }
      ...
      {
         return !!this.var_16 ? Boolean(this.var_16.getStateFlag(WindowState.const_89)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_857);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_398 != null && this.var_398 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_398 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_857);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_67:
               this._controller.furniModel.resetUnseenItems();
               break;
            case InventoryCategory.const_131:
               this._controller.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_261:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_398);
         }
         ...
         _loc2_.container.removeChild(this.var_2073);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_398 == InventoryCategory.const_131)
            {
               this.toggleCategoryView(InventoryCategory.const_131);
            }
            else if(this.var_398 == InventoryCategory.const_67)
            {
               this.toggleCategoryView(InventoryCategory.const_67);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_67);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2072)
         {
            this.var_2072 = this.createCounter("badges");
         }
         var _loc1_:int = this._controller.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2072,_loc1_);
