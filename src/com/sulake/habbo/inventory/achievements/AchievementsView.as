package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_71:AchievementsModel;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_60 = IItemListWindow(this._view.getChildByName("achievements_itemlist"));
         this.var_430 = new Timer(1000,1);
      ...
      public function updateList() : void
      {
         ...
         var _loc1_:Array = this.var_71.getAchievements();
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_430.running);
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_871[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_377.getBadgeImage(param2.badgeId);
            this.var_871[param2.badgeId] = _loc4_;
         }
