package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2262:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_377 = param5;
         this.var_377.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_812[_loc2_] == param1)
            {
               this.var_812.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1260.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_657.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_377.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_238.unshift(_loc11_);
            }
            else
            {
               this.var_238.push(_loc11_);
            }
            if(param2)
            {
      ...
      private function getBadge(param1:String) : Badge
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_238.length)
         {
            _loc3_ = this.var_238[_loc2_];
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_308);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_238.length)
         {
            _loc3_ = this.var_238[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_464);
         ...
         var _loc3_:Array = this.getBadges(const_308);
      ...
      {
         return this.getItemInIndex(param1,const_308);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_464);
      }
      ...
      {
         if(param1 == InventoryCategory.const_261 && this._controller.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_657.indexOf(_loc2_) == -1)
            {
               this.var_657.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_657 && this.var_657.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1303));
            this.var_657 = [];
