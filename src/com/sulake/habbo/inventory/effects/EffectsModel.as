package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsModel implements IInventoryModel
   {
      ...
      private function getEffect(param1:int) : Effect
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_250.length)
         {
            _loc3_ = this.var_250[_loc2_];
      ...
      {
         this._controller.communication.getHabboMainConnection(null).send(new AvatarEffectActivatedComposer(param1));
      }
      
      public function method_6(param1:int) : void
      {
      ...
      public function useEffect(param1:int) : void
      {
         ...
         {
            _loc2_.isInUse = true;
            this._controller.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(param1));
            this.refreshViews();
         }
      }
      ...
      public function stopUsingAllEffects(param1:Boolean = true, param2:Boolean = true) : void
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_250.length)
         {
            _loc4_ = this.var_250[_loc3_];
