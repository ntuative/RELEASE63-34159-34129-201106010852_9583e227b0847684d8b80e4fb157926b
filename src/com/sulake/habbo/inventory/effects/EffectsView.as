package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_848:ThumbListManager;
      
      private var var_849:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_848 = new ThumbListManager(this._assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         this.var_849 = new ThumbListManager(this._assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
      ...
      public function updateListViews() : void
      {
         ...
         this.var_849.updateImageFromList();
         this.var_848.updateImageFromList();
         var _loc1_:IBitmapWrapperWindow = this._view.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         var _loc2_:BitmapData = this.var_849.getListImage();
         ...
         var _loc4_:BitmapData = this.var_848.getListImage();
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:Effect = this.var_71.getSelectedEffect(-1);
         if(_loc3_ == null)
         {
            _loc1_.disable();
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = this.var_848.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = this.var_71.getItemInIndex(_loc4_,1);
            if(_loc5_ != null)
            {
               this.var_71.toggleEffectSelected(_loc5_.type);
            }
         }
      }
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = this.var_849.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = this.var_71.getItemInIndex(_loc4_,0);
            if(_loc5_ != null)
            {
               this.var_71.toggleEffectSelected(_loc5_.type);
            }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = this.var_71.getSelectedEffect(0);
               if(_loc3_ != null)
               {
                  this.var_71.requestEffectActivated(_loc3_.type);
               }
            }
         }
      }
