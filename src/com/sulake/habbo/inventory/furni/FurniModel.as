package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1609:int = 100;
      
      private static const const_1608:int = 1000;
      ...
      private var var_2898:XML;
      
      private var var_854:IWindowContainer;
      
      private var var_1253:Boolean;
      ...
      private var var_2064:Vector.<Array>;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_690.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_690.stop();
               this.var_690 = null;
            }
            if(this.var_217 != null)
            {
               this.var_217.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_217.stop();
               this.var_217 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_2064 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2064;
            }
            else
            {
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_67);
         ...
         if(this.getSelectedItemIndex(const_39) == -1)
         {
            this.toggleItemSelection(const_39,0);
         }
         if(this.getSelectedItemIndex(const_47) == -1)
         {
            this.toggleItemSelection(const_47,0);
         }
         this.initListImages();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_303)
         {
         ...
         if(this.var_854 == null)
         {
            this.var_854 = this._windowManager.buildFromXML(this.var_2898) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_854.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_854.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_39,const_47];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_217 = new Timer(param1,1);
            this.var_217.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_217.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_67 && this._controller.isVisible)
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_388);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_39,const_47];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_39,const_47];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_689.add(const_39,new Array());
         this.var_689.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_471.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_47;
            _loc5_ = this.var_470.indexOf(param1.ref) > -1;
         }
      ...
      {
         return getTimer() < this.var_2897 + const_1608;
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.getCategoryContent(const_47);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_354;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_309 || _loc3_.category == FurniCategory.const_303 || _loc3_.category == FurniCategory.const_312)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_689.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_354:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_689.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_766)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function updateView() : void
      {
         if(this._view != null)
         {
            this.updateGroupItems(const_39);
            this.updateGroupItems(const_47);
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_471.indexOf(_loc2_) == -1)
            {
               this.var_471.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_470.indexOf(_loc2_) == -1)
            {
               this.var_470.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_417:
               return this.var_471.length;
            case UnseenItemCategoryEnum.const_394:
               return this.var_470.length;
            default:
               return this.var_471.length + this.var_470.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_47:
               if(this.var_470 && this.var_470.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_394));
                  this.var_470 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_39:
               if(this.var_471 && this.var_471.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_417));
                  this.var_471 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
