package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1980:int = 0;
      ...
      private static const const_1017:int = 42;
      
      private static const const_1013:int = 120;
      
      private static const const_1012:int = 4;
      ...
      private var var_852:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this._soundManager.events.addEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
         this.var_345 = new Map();
         this.var_345.add(FurniModelCategory.const_39,new FurniGridView(this.var_71,FurniModelCategory.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_345.add(FurniModelCategory.const_47,new FurniGridView(this.var_71,FurniModelCategory.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModelCategory.const_39);
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1012;
            _loc3_.y = _loc4_.y + const_1012;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._soundManager)
            {
               ...
               {
                  this._soundManager.events.removeEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
               }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_71.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         if(this.var_422 == param1)
         {
            return;
         }
         var _loc2_:ISelectorWindow = this._view.findChildByName("category_selector") as ISelectorWindow;
         if(this.var_71.isMainViewActive())
         {
            this.var_71.resetUnseenItems();
         }
         switch(param1)
         {
            case FurniModelCategory.const_47:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_wall"));
               this.var_422 = FurniModelCategory.const_47;
               break;
            case FurniModelCategory.const_39:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_422 = FurniModelCategory.const_39;
               break;
            case FurniModelCategory.const_242:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_422 = FurniModelCategory.const_242;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_71.furniCategorySwitch();
         this.showCategoryGrid(this.var_422);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_345.getValue(this.var_422);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_71.getCategoryContent(this.var_422);
         if(!this.var_71.isListInited())
         {
            _loc2_ = const_1015;
         }
         ...
         if(this.var_2221 == _loc2_)
         {
            return;
         }
         this.var_2221 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_39,FurniModelCategory.const_47];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_345.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_345.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_345.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_345.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_71.getUnseenItemCount(UnseenItemCategoryEnum.const_417) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_71.getUnseenItemCount(UnseenItemCategoryEnum.const_394) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_71.petsModel.getUnseenItemCount() > 0;
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_71.getSelectedItemIndex();
         _loc4_ = this.var_71.getGroupItemInIndex(_loc3_,this.var_422);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_195);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_213);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
            ...
            if(_loc5_.category == FurniCategory.const_303)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_194)
               {
         ...
         var _loc12_:Boolean = this.var_71.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_71.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_71.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_852 && this.var_852.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1157)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1013)
         {
            _loc3_ = const_1013;
         }
         else if(_loc3_ < const_1017)
         {
            _loc3_ = const_1017;
         }
         else
      ...
      {
         var _loc3_:GroupItem = this.var_71.getGroupItemInIndex(this.var_71.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_71.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_71.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_71.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_71.requestCatalogOpen();
                  break;
               default:
                  this.var_71.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.switchCategory(FurniModelCategory.const_47);
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_242);
            }
         }
      }
