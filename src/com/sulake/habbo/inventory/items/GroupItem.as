package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_886:int = 0;
      
      protected var var_707:BitmapData;
      
      protected var var_2254:int;
      
      protected var var_1638:Boolean;
      
      protected var var_2177:Boolean;
      
      protected var var_2952:BitmapData;
      
      private var var_1447:Boolean;
      
      private const const_1987:Number = 1;
      
      private const const_1986:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2179 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1526));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2178);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_766)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1986;
               _loc1_.blend = this.const_1986;
            }
            else
            {
               this._window.blend = this.const_1987;
               _loc1_.blend = this.const_1987;
            }
         }
         this.var_1602.color = !!this.var_1447 ? uint(const_1428) : uint(const_1427);
         this.var_2435.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2177 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2952;
               _loc5_.visible = true;
            }
            else
            {
