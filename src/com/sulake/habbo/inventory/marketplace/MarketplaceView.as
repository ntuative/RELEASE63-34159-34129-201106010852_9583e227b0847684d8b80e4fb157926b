package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_71:MarketplaceModel;
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(!param1 || !this._localization || !this._roomEngine || !this.var_71)
         {
            return;
         }
         ...
         this.checkPrice();
         this._localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",this.var_71.expirationHours.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",this.var_71.offerMinPrice.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",this.var_71.offerMaxPrice.toString());
         ...
         this.var_2529 = this._localization.getKey(_loc5_);
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2529);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_1838.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_71.makeOffer(this.var_1838);
         }
         this.var_71.releaseItem();
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "buy_tokens_button":
                  this.var_71.buyMarketplaceTokens();
                  this.disposeView();
                  break;
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_1838 = parseInt(_loc3_.text);
      ...
      private function checkPrice() : void
      {
         ...
         if(_loc2_ > this.var_71.offerMaxPrice)
         {
            _loc1_.text = this.var_71.offerMaxPrice.toString();
            _loc2_ = this.var_71.offerMaxPrice;
         }
         var _loc3_:int = Math.max(Math.ceil(this.var_71.commission * 0.01 * _loc2_),1);
         ...
         if(_loc2_ < this.var_71.offerMinPrice)
         {
      ...
      {
         if(!this._view || !this._localization || !this.var_71)
         {
            return;
         }
         ...
         var _loc4_:int = Math.floor(param1 / (1 + this.var_71.commission * 0.01));
