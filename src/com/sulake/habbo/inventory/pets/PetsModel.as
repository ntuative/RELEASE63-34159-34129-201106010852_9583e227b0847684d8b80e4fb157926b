package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_131 && this._controller.isVisible)
         {
      ...
      {
         var _loc3_:FurniModel = this._controller.furniModel;
         if(_loc3_ != null)
         {
            _loc3_.switchCategory(param1);
            this._controller.toggleInventoryPage(InventoryCategory.const_67,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_2047 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_32,RoomObjectTypeEnum.const_191,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_2047 && param1.type == RoomEngineObjectEvent.const_163)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_561.indexOf(_loc2_) == -1)
            {
               this.var_561.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_561 && this.var_561.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_57));
            this.var_561 = [];
            this._view.update();
      ...
      {
         return this.var_561.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_561.indexOf(param1) > -1;
      }
   }
}
