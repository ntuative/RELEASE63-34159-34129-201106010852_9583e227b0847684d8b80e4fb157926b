package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1980:int = 0;
      
      private const const_1015:int = 1;
      
      private const const_1016:int = 2;
      
      private const const_1014:int = 3;
      ...
      private var var_220:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_201 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_220);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_497.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_201.removeGridItem(_loc2_.window);
         if(this.var_220 == _loc2_)
         {
            this.var_220 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_497 == null || this.var_497.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_497.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_497.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_71.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_201.addGridItem(_loc2_.window);
            this.var_497.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_220.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_71.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_49)
         {
            ...
            {
               case "tab_floor":
                  this.var_71.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_71.switchToFurnitureCategory(FurniModelCategory.const_47);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_220 != null)
         {
            this.var_220.setSelected(false);
         }
         this.var_220 = param1;
         if(this.var_220 != null)
         {
            this.var_220.setSelected(true);
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Map = this.var_71.pets;
         if(!this.var_71.isListInitialized())
         {
            _loc2_ = this.const_1015;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1016;
         }
         else
         {
            _loc2_ = this.const_1014;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1015:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1016:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1014:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_71.roomSession != null)
         {
            _loc8_ = this.var_71.roomSession.arePetsAllowed;
            _loc9_ = this.var_71.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc8_ = this._avatarRenderer.createPetImage(param1,param2,_loc7_,AvatarScaleType.const_58,this);
            if(_loc8_ != null)
            {
               _loc8_.setDirection(AvatarSetType.const_43,param4);
               if(param5)
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_43);
               }
               else
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_52);
               }
               _loc8_.dispose();
            }
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_71.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_417) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_71.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_394) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_71.getUnseenItemCount() > 0;
      }
   }
}
