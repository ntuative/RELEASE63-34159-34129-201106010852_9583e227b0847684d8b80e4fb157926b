package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1667:uint = 9;
      ...
      public static const const_526:uint = 4;
      
      public static const const_297:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_2667 = param5;
         this.var_1018 = new Map();
         this.var_1255 = false;
         this.var_1770 = param6;
         this.var_759 = true;
         this.state = const_218;
         this.var_56.setup(param1,param3,param4,param6);
         this.var_56.updateItemList(this.var_809);
         this.var_56.updateItemList(this.var_1521);
      ...
      public function close() : void
      {
         if(this.var_759)
         {
            if(this._state != const_208 && this._state != const_297)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_208;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_51);
            this.var_759 = false;
         }
      ...
      {
         this.var_56.setMinimized(param1 != InventoryCategory.const_67);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_808 + " OTHER: " + this.var_1255);
         ...
         {
            case const_208:
               if(param1 == const_218 || param1 == const_297)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1207);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_809)
            {
               this.var_808 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1255 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         else if(param1 is TradingConfirmationEvent)
         {
            ...
            this.state = const_391;
         }
         else if(param1 is TradingCompletedEvent)
         {
            Logger.log("TRADING::TradingCompletedEvent");
            this.state = const_297;
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_266.length < const_1667)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_194)
            {
