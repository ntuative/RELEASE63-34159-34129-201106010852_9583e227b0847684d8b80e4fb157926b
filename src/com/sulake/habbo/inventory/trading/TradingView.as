package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1051:uint = 4284532064;
      
      private static const const_1050:uint = 2577770;
      ...
      private var var_619:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_619 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_204)
            {
               this.var_204.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_204.stop();
               this.var_204 = null;
            }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1051) : uint(const_1050);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1051) : uint(const_1050);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_204 = new Timer(1000,3);
            this.var_204.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_204.reset();
         this.var_204.repeatCount = 3;
         this.var_204.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_204.currentCount));
         if(this.var_204.currentCount == 3)
         {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1888)
            {
            ...
            this.var_619.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_496);
            this.var_619.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_619.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_181.push(param4);
            this.var_181.push(param1);
            this.var_181.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_181.length > 0)
         {
            _loc2_ = this.var_181.pop();
            _loc3_ = this.var_181.pop();
            _loc4_ = uint(this.var_181.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_619.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_496);
               }
            }
            else
            {
               this.var_181.push(_loc4_);
               this.var_181.push(_loc3_);
