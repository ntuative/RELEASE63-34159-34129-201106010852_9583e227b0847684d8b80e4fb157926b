package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private static var var_1530:String = "%";
      ...
      private var var_1956:Dictionary;
      
      private var var_2711:Array;
      
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1956 = new Dictionary();
         this.var_2711 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1955 = (param2 & 0) > 0;
         if(!this.var_1955)
         {
            lock();
         }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1530);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1530,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = "";
            _loc3_ = this.var_197.getKey("url.prefix",_loc3_);
            _loc3_ = _loc3_.replace("http://","");
            _loc3_ = _loc3_.replace("https://","");
            super.setPredefinedUrl(_loc3_);
            if(!this.var_1955)
            {
               if("false" == this.var_197.getKey("use.default.localizations","false"))
               {
                  _loc5_ = this.var_197.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_180,this.onLocalizationLoaded);
                  super.loadLocalizationFromURL(_loc5_);
               }
            }
            _loc4_ = 1;
            while(this.var_197.keyExists("localization." + _loc4_))
            {
               _loc6_ = this.var_197.getKey("localization." + _loc4_,"");
               _loc7_ = this.var_197.getKey("localization." + _loc4_ + ".name","");
               _loc8_ = this.var_197.getKey("localization." + _loc4_ + ".url","");
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_180,this.onLocalizationLoaded);
         if(this.var_197.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_197.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_180,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_180,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1956[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1956[param1];
      }
      ...
      {
         return this.var_2711[Math.max(0,param1 - 1)];
      }
