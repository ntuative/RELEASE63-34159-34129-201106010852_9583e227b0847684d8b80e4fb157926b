package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1597:int = 20;
       
      
      private var var_140:HabboMessenger;
      
      private var var_2814:IScrollbarWindow;
      
      private var var_2028:IContainerButtonWindow;
      
      private var var_60:IItemListWindow;
      
      private var var_555:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_140 = param1;
         this.var_2028 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_60 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2814 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_140.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1107 + const_1597)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_140.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1596;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_555 == null || _loc1_.id != this.var_555.id)
         {
            this.var_555 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_555.followingAllowed)
         {
            this.var_2028.enable();
         }
         else
         {
            this.var_2028.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_60.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_555.messages.length - const_1107);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_555.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_555.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_140.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_750 || param3.type == Message.const_749 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_555.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_140.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_140.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_140.send(new FollowFriendMessageComposer(this.var_555.id));
         this.var_140.send(new ConversionPointMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1214)
         {
            return 4294927974;
         }
         if(param1 == Message.const_823)
         {
            return 4293454056;
         }
         if(param1 == Message.const_868)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1146)
         {
            return 4288269465;
         }
         return 4291611852;
