package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1089:Array = [];
      
      private static var var_2097:int = 1000;
      
      private static var var_1090:Array = [];
      
      private static var var_2098:int = 200;
      ...
      private var var_2043:IMessageComposer;
      ...
      {
         this.var_865 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_866 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         this.var_518 = new Timer(1000,1);
         ...
         this.var_33.connection.send(this.var_2043);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1089.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_866.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1089.length < var_2097)
         {
            ...
            param1.width = this.var_866.width;
            param1.height = this.var_866.height;
            var_1089.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1090.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_865.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1090.length < var_2098)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_865.width;
            param1.height = this.var_865.height;
            var_1090.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2096[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1623.getValue(param2.chatterName))
            {
               this.var_1623.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1623.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1624)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1622)
         {
