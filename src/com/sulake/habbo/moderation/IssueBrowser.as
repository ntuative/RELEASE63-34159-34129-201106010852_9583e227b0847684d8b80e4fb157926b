package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2270:String = "my_issues";
      
      private const const_2272:String = "open_issues";
      
      private const const_2271:String = "picked_issues";
      
      private const const_2291:String = "closed_issues";
      ...
      private var var_391:IIssueBrowserView;
      
      private var var_2023:IIssueBrowserView;
      
      private var var_2024:IIssueBrowserView;
      
      private var var_2025:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_275 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_275.numTabItems)
            {
               _loc5_ = this.var_275.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_49,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_275 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_275 == null || this.var_275.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_275.selector.getSelectableByName("open_issues");
         this.var_275.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_391 == _loc2_)
         {
            return;
         }
         if(this.var_391 != null)
         {
            this.var_391.visible = false;
         }
         this.var_391 = _loc2_;
         if(this.var_391 == null)
         {
         ...
         this.var_391.view.width = this.var_275.container.width;
         this.var_391.view.height = this.var_275.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2270:
               if(this.var_2023 == null)
               {
                  this.var_2023 = new MyIssuesView(this.issueManager,this,this.var_275.container);
               }
               return this.var_2023;
            case this.const_2272:
               if(this.var_2024 == null)
               {
                  this.var_2024 = new OpenIssuesView(this.issueManager,this,this.var_275.container);
               }
               return this.var_2024;
            case this.const_2271:
               if(this.var_2025 == null)
               {
                  this.var_2025 = new PickedIssuesView(this.issueManager,this,this.var_275.container);
               }
