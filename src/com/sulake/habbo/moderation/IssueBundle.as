package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_791:IssueMessageData = null;
      
      private var var_790:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2449 = param2.pickerUserId;
         this.var_2575 = param2.pickerUserName;
         this.var_1467 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1217 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1218;
         }
         if(this.var_791 == null || param1.timeStamp < this.var_791.timeStamp)
         {
            this.var_791 = param1;
         }
         if(this.var_790 == null || param1.priority > this.var_790.timeStamp)
         {
            this.var_790 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1217 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1218;
            }
            if(this.var_791 == _loc2_)
            {
               this.var_791 = null;
            }
            if(this.var_790 == _loc2_)
            {
               this.var_790 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_790;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_791;
         if(_loc2_ == null)
         {
