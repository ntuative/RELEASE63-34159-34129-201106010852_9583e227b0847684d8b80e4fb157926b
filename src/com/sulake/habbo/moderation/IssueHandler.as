package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_167:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_538:UserInfoCtrl;
      
      private var var_1244:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_68.windowManager == null || this.var_68.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_68.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_68.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_41,this.onResized);
         }
         ...
         this.var_68.disableButton(this.var_68.initMsg.chatlogsPermission,this._window,"show_chatlog");
         _loc2_ = this._window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = this.var_167.getHighestPriorityIssue();
         this.var_538 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
         this.var_1244 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
         this.var_538.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_167.reportedUserId > 0)
         {
            this.var_1244.load(_loc4_,this.var_167.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_167.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_167.issues;
         var _loc3_:int = 0;
         var _loc5_:int = _loc1_.numListItems;
         var _loc6_:int = _loc2_.length;
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_68.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_68.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_68.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_68.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         if(this.var_68 != null && this.var_68.issueManager != null && this.var_167 != null)
         {
            this.var_68.issueManager.removeHandler(this.var_167.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_167.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_167.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_167.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.releaseBundle(this.var_167.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_167.getHighestPriorityIssue().issueId;
         this.var_68.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_68,WindowTracker.const_1283,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_167.getHighestPriorityIssue();
            this.var_538 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
            this.var_538.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_68 == null || this.var_68.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_68.issueManager.autoPick();
         }
      }
   }
}
