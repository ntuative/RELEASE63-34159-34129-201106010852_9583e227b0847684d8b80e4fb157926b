package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_1829:IWindowContainer;
      
      private var var_3017:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1829 = this.var_664.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         var _loc4_:int = this.var_60.numListItems;
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1829.clone() as IWindowContainer;
         ...
         else if(_loc4_ > _loc5_)
         {
            ...
            {
               _loc9_ = this.var_60.removeListItemAt(0);
               _loc9_.dispose();
               _loc2_++;
            }
         }
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1829 == null)
            {
               return;
            }
            _loc3_ = this.var_60.getListItemAt(_loc2_ - 1) as IWindowContainer;
            if(_loc3_ == null)
            {
               return;
            }
            _loc3_.width = this.var_60.width;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_664.assets.getAssetByName(_loc12_) as BitmapDataAsset;
