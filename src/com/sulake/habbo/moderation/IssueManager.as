package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1136:String = "issue_bundle_open";
      
      public static const const_786:String = "issue_bundle_my";
      
      public static const const_1199:String = "issue_bundle_picked";
      
      public static const const_1725:int = 15000;
       
      
      private var var_68:ModerationManager;
      
      private var var_664:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_664 = new IssueBrowser(this,this.var_68.windowManager,this.var_68.assets);
         this.var_1274 = [];
         this.var_1273 = [];
         this.var_1033 = new Map();
         this.var_2722 = parseInt(this.var_68.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1976 = new Timer(const_1725,0);
         this.var_1976.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1976.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_108.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1274 = this.var_1274.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_108.getValues();
         for each(_loc5_ in _loc3_)
         {
            if(_loc5_.state == IssueMessageData.const_172 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc2_:* = [];
         for each(_loc3_ in this.var_108)
         {
            if(_loc3_.state == IssueMessageData.const_440 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_108.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1273 = this.var_1273.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_664 == null || !this.var_664.isOpen())
         {
            this.var_68.soundManager.playSound(HabboSoundTypesEnum.const_1217);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1034.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_108.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_108.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_1034.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1712)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_108)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1034.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2721++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1034.add(param1.issueId,_loc2_);
            this.var_108.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1274.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_68.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_440)
               {
                  this.unhandleBundle(_loc3_.id);
               }
            }
         }
         if(param1.state == IssueMessageData.const_172)
         {
            _loc6_ = this.getBundles(const_786);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1273.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2722);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1033.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1033.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1034.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_108.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_108)
         {
            ...
            {
               case const_1136:
                  if(_loc4_.state == IssueMessageData.const_172)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_786:
                  if(_loc4_.state == IssueMessageData.const_440 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1033.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1033.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_108.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_108.getValues();
         var _loc4_:int = this.var_68.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_440 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_108)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1033.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
