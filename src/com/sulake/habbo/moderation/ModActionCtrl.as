package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1311:IDropMenuWindow;
      ...
      private var var_1056:OffenceCategoryData;
      
      private var var_1055:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1309 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1310 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_2030;
         ...
         this.var_1311 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1311);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1056 != null;
         if(this.var_1055 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1055.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1056 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1056.offences,this.var_1309,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1310,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1783;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1574,this.var_556.text,this.var_1575));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1056 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1055 = this.var_1056.offences[_loc3_];
         this.var_556.text = this.var_1055.msg;
         this.var_685 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1574,this.var_556.text,this.var_1575));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1311.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1574,this.var_556.text,this.getBanLength(),this.var_1575));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1311.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1309.destroy();
            this.var_1309 = null;
         }
         if(this.var_1310 != null)
         {
            this.var_1310.destroy();
            this.var_1310 = null;
         }
         this.var_1311 = null;
         this.var_556 = null;
