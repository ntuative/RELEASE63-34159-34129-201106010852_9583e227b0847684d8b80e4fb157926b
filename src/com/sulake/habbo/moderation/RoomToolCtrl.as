package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1189:IDropMenuWindow;
      
      private var var_556:ITextFieldWindow;
      
      private var var_685:Boolean = true;
      
      private var var_963:ICheckBoxWindow;
      
      private var var_1474:ICheckBoxWindow;
      
      private var var_1475:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_33.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_357));
         Logger.log("BEGINNING TO SHOW: " + this.var_357);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1784;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_357);
         if(param1.flatId != this.var_357)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_357);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1189 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1189);
         this.var_1189.procedure = this.onSelectTemplate;
         this.var_963 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1474 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1475 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_697,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_685 || this.var_556.text == "")
         {
            this.var_33.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_963.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1908,_loc2_,this.var_556.text,"",""));
         if(this.var_1474.isSelected || this.var_1475.isSelected || this.var_963.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1474.isSelected,this.var_1475.isSelected,this.var_963.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1951);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1881);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1189.selection];
         if(_loc3_ != null)
         {
            this.var_685 = false;
