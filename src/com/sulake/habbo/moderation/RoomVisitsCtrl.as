package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1083:Array = [];
      
      private static var var_2080:int = 200;
      ...
      {
         this.var_863 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1868;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1083.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_863.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1083.length < var_2080)
         {
            ...
            param1.width = this.var_863.width;
            param1.height = this.var_863.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1613)
         {
