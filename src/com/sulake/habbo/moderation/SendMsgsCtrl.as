package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_2030;
      ...
      {
         return WindowTracker.const_1876;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.messageTemplates[this.var_1189.selection];
         if(_loc3_ != null)
         {
            this.var_685 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModMessageMessageComposer(this.var_1574,this.var_556.text,this.var_1575));
         this.dispose();
      }
