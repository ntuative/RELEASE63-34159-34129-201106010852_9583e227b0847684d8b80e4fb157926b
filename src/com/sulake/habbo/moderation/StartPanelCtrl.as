package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      public function show() : void
      {
         if(this._frame == null)
         {
            this._frame = IFrameWindow(this.var_33.getXmlWindow("start_panel"));
            ...
            this._frame.findChildByName("room_tool_but").disable();
            this._frame.findChildByName("chatlog_but").disable();
            this.var_33.disableButton(this.var_33.initMsg.cfhPermission,this._frame,"ticket_queue_but");
      ...
      {
         if(this.var_33.initMsg.chatlogsPermission)
         {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_2026 ? 0 : 1,this._roomId),this.var_33,WindowTracker.const_697,this._roomId),this._frame,false,false,true);
      }
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new UserInfoFrameCtrl(this.var_33,this._userId),this._frame,false,false,true);
      }
