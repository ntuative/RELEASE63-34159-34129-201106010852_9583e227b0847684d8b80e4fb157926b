package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1243:UserInfoCtrl;
      ...
      {
         this._frame = IFrameWindow(this.var_33.getXmlWindow("user_info_frame"));
         this._frame.caption = "User Info";
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_1243 = new UserInfoCtrl(this._frame,this.var_33,"",true);
         this.var_1243.load(this._frame.content,this._userId);
         this._frame.visible = true;
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1680;
      }
