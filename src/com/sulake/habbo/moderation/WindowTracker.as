package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1680:int = 1;
      
      public static const const_1876:int = 2;
      
      public static const const_1283:int = 3;
      
      public static const const_697:int = 4;
      
      public static const const_1286:int = 5;
      
      public static const const_1868:int = 6;
      
      public static const const_1783:int = 7;
      ...
      private var var_1825:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1825 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1825[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1825[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
