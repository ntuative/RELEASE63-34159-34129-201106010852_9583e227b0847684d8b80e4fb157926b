package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_326:MainViewCtrl;
      
      private var var_673:RoomInfoViewCtrl;
      
      private var var_1306:RoomCreateViewCtrl;
      ...
      private var var_954:GuestRoomPasswordInput;
      
      private var var_317:GuestRoomDoorbell;
      
      private var var_1305:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2830 = new Array();
         ...
         this.var_326 = new MainViewCtrl(this);
         this.var_673 = new RoomInfoViewCtrl(this);
         this.var_1306 = new RoomCreateViewCtrl(this);
         this.var_2594 = new RoomThumbnailRenderer(this);
         this.var_954 = new GuestRoomPasswordInput(this);
         this.var_317 = new GuestRoomDoorbell(this);
         this.var_429 = new Tabs(this);
         this.var_1305 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_343,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_326.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_197.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_326.startSearch(Tabs.const_201,Tabs.const_425,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_326.mainWindow.activate();
      }
      ...
      public function method_5() : void
      {
         ...
         this.var_326.startSearch(Tabs.const_281,Tabs.const_233);
         this.var_429.getTab(Tabs.const_281).tabPageDecorator.tabSelected();
      }
