package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1339)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1687)
         {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_196 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               this._navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_123 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_233);
      }
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_223).tabPageDecorator);
      ...
      private function onCanCreateRoom(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(this._navigator.sessionData.hasUserRight("fuse_can_create_more_rooms",HabboClubLevelEnum.const_45))
            {
      ...
      private function forwardToRoom(param1:Boolean, param2:int) : void
      {
         ...
         this._navigator.trackNavigationDataPoint("Room Forward","go.roomforward",String(param2));
      }
