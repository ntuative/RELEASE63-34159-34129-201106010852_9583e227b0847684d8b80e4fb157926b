package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1484:CutToWidth = new CutToWidth();
      
      private static var var_2512:CutToHeight = new CutToHeight();
      ...
      public static function setProc(param1:IWindowContainer, param2:String, param3:Function) : void
      {
         ...
         _loc4_.setParamFlag(HabboWindowParam.const_46,true);
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1484.beforeSearch(param2,param1,param3);
         binarySearch(var_1484,param2.length - 1);
      }
