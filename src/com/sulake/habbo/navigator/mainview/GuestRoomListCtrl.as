package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_543:RoomPopupCtrl;
      
      private var var_579:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_543 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_579 = IScrollbarWindow(this.var_178.findChildByName("scroller"));
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_60.numListItems)
         {
            if(this.var_60.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_193,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1660,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_196,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_123,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_543.visible && this.var_2660)
         {
            return;
         }
         ...
         this.var_543.room = _loc4_;
         this.var_543.showPopup(_loc2_);
      }
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            switch(_loc4_.doorMode)
            {
               case RoomSettingsFlatInfo.const_123:
                  ...
                  return;
               case RoomSettingsFlatInfo.const_196:
                  this._navigator.doorbell.show(_loc4_,_loc5_);
                  return;
            }
         }
         this._navigator.goToRoom(_loc4_.flatId,true);
         this.var_543.hideInstantly();
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1519.tags[0];
            this.var_1519.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2661 - _loc2_.stageX);
         this.var_2661 = _loc2_.stageX;
         this.var_2660 = _loc3_ > 2;
      }
   }
}
