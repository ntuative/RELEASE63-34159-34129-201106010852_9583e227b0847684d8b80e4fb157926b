package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_135 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.prepareSubNavi();
      ...
      private function startSearch() : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_281,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_832;
         }
         if(param1 == 3)
         {
            return Tabs.const_774;
         }
         if(param1 == 4)
         {
            return Tabs.const_858;
         }
         return Tabs.const_233;
      }
