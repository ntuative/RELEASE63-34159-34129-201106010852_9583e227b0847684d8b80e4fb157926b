package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_135:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_135 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_135.addEventListener(WindowEvent.const_49,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_135 != null)
         {
            this.var_135.removeEventListener(WindowEvent.const_49,this.onFilterSelected);
            this.var_135.selection = 0;
            this.var_135.addEventListener(WindowEvent.const_49,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_135 == null ? 0 : int(this.var_135.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_408);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_965);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_408,"" + _loc3_);
         }
         if(this.var_135)
         {
            this._navigator.trackNavigationDataPoint(this.var_135.enumerateSelection()[this.var_135.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_135 ? this.var_135.enumerateSelection()[this.var_135.selection] : null;
      }
   }
}
