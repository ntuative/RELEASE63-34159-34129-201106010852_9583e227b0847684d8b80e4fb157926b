package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1163:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_609 = new Timer(100);
         this.var_609.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_44 = new Array();
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,104,"a"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,94,"b"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,36,"c"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,84,"d"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"e"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"f"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"i"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,320,"j"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,448,"k"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"l"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,384,"m"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_55,372,"n"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,80,"g"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,74,"h"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,416,"o"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,352,"p"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,304,"q"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,336,"r"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,748,"u"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_37,438,"v"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,540,"t"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,512,"w"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,396,"x"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,440,"y"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,456,"z"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_609)
         {
            this.var_609.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_609.reset();
            this.var_609 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1163.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1783 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1783 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_60 = IItemListWindow(this.var_178.findChildByName("item_list"));
         ...
         this.var_1164 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1164.goBackToInitialState();
         this.var_1164.input.textBackgroundColor = 4294967295;
         this.var_1163 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         while(this.var_60.numListItems > 0)
         {
            _loc6_ = this.var_60.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_44)
         {
         ...
         while(_loc4_ < this.var_44.length)
         {
            ...
            if(this.isAllowed(_loc7_))
            {
               ...
               {
                  _loc3_ = this.getRow();
                  this.var_60.addListItem(_loc3_);
               }
         ...
         if(this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_37))
         {
            if(this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_45))
            {
               _loc5_ = null;
            }
            else
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_60.addListItem(_loc8_);
            }
         }
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_55:
               return true;
            case HabboClubLevelEnum.const_37:
               return this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_37);
            case HabboClubLevelEnum.const_45:
               return this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_45);
            default:
               return false;
         }
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1164.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1164.getText();
         var _loc3_:String = "model_" + this.var_1163.name;
