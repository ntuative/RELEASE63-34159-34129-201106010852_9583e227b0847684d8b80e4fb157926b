package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_71:ThumbnailEditorModel;
      
      private var var_2111:IButtonWindow;
      
      private var var_2112:IButtonWindow;
      
      private var var_2110:IButtonWindow;
      
      private var var_2935:IWindowContainer;
      
      private var var_2934:IWindowContainer;
      
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_71 = new ThumbnailEditorModel();
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(this._active)
         {
            this.var_71.data = this._navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2111 = IButtonWindow(this.find("bg_tab"));
         this.var_2112 = IButtonWindow(this.find("top_tab"));
         this.var_2110 = IButtonWindow(this.find("obj_tab"));
         this.var_2935 = IWindowContainer(this.find("tile_grid"));
         this.var_2934 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2111,this.onBgTabButton);
         Util.setProcDirectly(this.var_2112,this.onTopTabButton);
         Util.setProcDirectly(this.var_2110,this.onObjTabButton);
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this.var_71.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(this._navigator.data.enteredGuestRoom.flatId,this.var_71.data.bgImgId,this.var_71.data.frontImgId,_loc3_.length);
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_71.mode = ThumbnailEditorModel.const_38;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_71.mode = ThumbnailEditorModel.const_62;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_71.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_2111,this.var_71.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_2112,this.var_71.mode != ThumbnailEditorModel.const_62);
         this.setEnabled(this.var_2110,this.var_71.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2934;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_71.mode == ThumbnailEditorModel.const_38);
         this.refreshEditImg(_loc1_,"edit_top",this.var_71.mode == ThumbnailEditorModel.const_62);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_71.mode == ThumbnailEditorModel.const_35,false);
         if(this.var_71.mode == ThumbnailEditorModel.const_35)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2935;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_560)
            {
         ...
         if(this.var_71.selected == null)
         {
            _loc2_.visible = false;
            return;
         }
         _loc2_.visible = true;
         this.refreshTileLoc(_loc2_,this.var_71.selected.pos);
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = this.var_71.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_560)
         {
      ...
      {
         this.refreshImgSelector(ThumbnailEditorModel.const_38);
         this.refreshImgSelector(ThumbnailEditorModel.const_62);
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = this.var_71.getImgId();
         var _loc6_:int = 0;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_469,HabboWindowStyle.const_48,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_343,HabboWindowStyle.const_48,HabboWindowParam.const_64,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this._window.findChildByName("picframe")),this.var_71.data,false);
      }
   }
}
