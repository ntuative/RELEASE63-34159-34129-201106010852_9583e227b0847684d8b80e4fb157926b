package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_583:int = 70;
      
      public static const const_1678:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_598:int = 1;
      
      private static const const_1093:int = 2;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1999 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1999 = 15;
         }
         this.var_2000 = this._window.height;
         this.var_1544 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      {
         if(param1.badgeId != this.var_239.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_598:
               ...
               _loc2_ = Number(this.var_1284) / Number(this.var_1041["time_fade_in"]);
               if(this.var_1284 > int(this.var_1041["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1093:
               ...
               if(this.var_1545 > int(this.var_1041["time_display"]) && !this.var_2001)
               {
                  this.startFadeOut();
               }
               break;
            case const_1094:
               ...
               _loc3_ = 1 - Number(this.var_1283) / Number(this.var_1041["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1283 > int(this.var_1041["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1999;
         if(this._window.height < this.var_2000)
         {
            this._window.height = this.var_2000;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1678;
         this._window.y = this.var_1544;
      }
