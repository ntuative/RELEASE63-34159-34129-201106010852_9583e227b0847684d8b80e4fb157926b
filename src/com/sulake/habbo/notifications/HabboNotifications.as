package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1556:String = "pixelbalance";
      
      private static const const_1554:String = "badges";
      
      private static const const_1559:String = "selectbadge";
      
      private static const const_1557:String = "inventory";
      
      private static const const_1560:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1555:String = "friendlist";
      
      private static const const_1558:String = "pet_inventory";
      
      private static const const_1553:String = "go_to_room";
      ...
      private var var_380:HabboNotificationViewManager;
      
      private var var_240:HabboAlertDialogManager;
      
      private var var_819:ParkBusDialogManager;
      
      private var var_2707:Boolean;
      
      private var var_1027:ClubGiftNotification;
      
      private var var_1025:ClubEndingNotification;
      
      private var var_1028:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1026);
         }
         var _loc6_:Map = this.var_1026["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1026["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1267.push(_loc8_);
         return this.var_1267.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1267.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_240 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_380)
         {
            this.var_380.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1529[_loc3_.data.badgeCode] = new AchievementNotification(_loc3_.data.badgeCode,_loc3_.data.achievementID,_loc3_.data.level,_loc3_.data.points,_loc3_.data.levelRewardPoints,_loc3_.data.levelRewardPointType,_loc3_.data.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_377);
      }
      
      private function isStandaloneAchievementListEnabled() : Boolean
      {
         return this._config.getKey("standaloneAchievementList.enabled","false") == "true";
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1529[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1529[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_380 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1026["styles"],this.var_1026["view"]);
         ...
         registerUpdateReceiver(this.var_380,1);
         registerUpdateReceiver(this,2);
         this.var_377.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_377.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1239,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1239,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1922,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_861,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_570.createAvatarImage(param2,AvatarScaleType.const_58);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_52,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_52);
            _loc7_.dispose();
         }
         if(param3 == "")
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc7_ = this.var_377.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_66)
               {
                  _loc7_ = this.var_377.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_377.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1774,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            case CatalogPageMessageProductData.const_79:
               ...
               break;
            case CatalogPageMessageProductData.const_66:
               ...
               break;
            case CatalogPageMessageProductData.const_214:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1356)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1707,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1745)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1025 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1028 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_380.isSpaceAvailable() && this.var_1267.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_380.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_380 != null)
         {
            this.var_380.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_240 == null)
         {
            return;
         }
         this.var_240.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_240.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_240.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_240.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_240.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_819 == null)
         {
            this.var_819 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_819 != null)
         {
            this.var_819.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1203,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1203,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_570.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_58);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_43,3);
               _loc4_ = _loc6_.getCroppedImage(AvatarSetType.const_52);
               _loc6_.dispose();
            }
         }
         else
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2707)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_861,null);
            this.var_2707 = true;
      ...
      {
         if(param2.type == WindowEvent.const_173 || param2.type == WindowEvent.const_622)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1027 && this.var_1027.visible)
         {
            return;
         }
         this.var_1027 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_861,_loc6_);
      }
   }
}
