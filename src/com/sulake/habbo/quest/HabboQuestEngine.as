package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1537:int = 5;
      ...
      private var var_1245:QuestController;
      
      private var var_1013:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1245 = new QuestController(this);
         this.var_1013 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1537);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_377.events.removeEventListener(BadgeImageReadyEvent.const_114,this.var_1013.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_377.events.addEventListener(BadgeImageReadyEvent.const_114,this.var_1013.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_1245.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1013.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1245.questTracker.isVisible();
      }
