package com.sulake.habbo.quest
{
   ...
   public class PendingImage implements IDisposable
   {
      ...
      public static function retrievePreviewAsset(param1:HabboQuestEngine, param2:String, param3:Function) : void
      {
         ...
         _loc7_.addEventListener(AssetLoaderEvent.const_29,param3);
      }
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.disposed)
         {
            ...
            if(_loc2_ != null)
            {
               this.setImageFromAsset(this.var_2071,_loc2_.assetName,null);
            }
         }
         this.dispose();
      }
      ...
      public function setImageFromAsset(param1:IWindow, param2:String, param3:Function) : void
      {
         ...
         if(_loc4_ == null)
         {
            retrievePreviewAsset(this._questEngine,param2,param3);
            return;
         }
         if(param1)
         {
