package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1547:int = 5;
      
      private static const const_1545:int = 10;
      
      private static const const_1546:int = 10;
      
      private static const const_1544:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_768 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_768.toggle();
         this.var_1933 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_579 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_60.spacing = const_1545;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1546;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1547;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1544;
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         this._questEngine.setupCampaignImage(param1,param2);
         ...
         param1.findChildByName("more_quests_button").visible = false;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1933 && !this.var_1932)
            {
               this.var_1933 = false;
