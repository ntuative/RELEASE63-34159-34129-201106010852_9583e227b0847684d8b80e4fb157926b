package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_751:String = "RCL_LOADER_READY";
      
      private static const const_367:String = "RCL_PUBLICROOM_";
      
      private static const const_2005:int = 0;
      
      private static const const_1015:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_461:String = "place_holder";
      
      private static const const_674:String = "wall_place_holder";
      
      private static const const_672:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_461;
      
      private static const const_673:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1087:String = "selection_arrow";
       
      
      private var _baseUrl:String;
      
      private var var_540:Map = null;
      
      private var _events:Map = null;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_798:Map = null;
      ...
      private var var_1514:IEventDispatcher = null;
      ...
      private var var_372:Dictionary;
      
      private var var_653:Map = null;
      
      private var _wallItems:Dictionary;
      
      private var var_1015:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1016:Map = null;
      
      private var var_209:PublicRoomData = null;
      
      private var var_1513:Map = null;
      ...
      {
         this.var_372 = new Dictionary();
         this._wallItems = new Dictionary();
         this._pets = new Dictionary();
         this.var_2647 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2643 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1015)
         {
            return;
         }
         this.var_1514 = param1;
         this.var_2646 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2645 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_377.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_540.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_540.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_449.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_449.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_372)
            {
               delete this.var_372[_loc1_];
            }
            this.var_372 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_799.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_448.add(_loc3_,_loc4_);
               if(this.var_372[_loc7_] == null)
               {
                  this.var_372[_loc7_] = 1;
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2644)
         {
            ...
            {
               this.var_1514.dispatchEvent(new Event(const_751));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_541 != null)
         {
            ...
            this.var_541.add(param1,param2);
         }
         if(this.var_539 != null)
         {
            this.var_539.remove(param2);
            this.var_539.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_541 != null)
         {
            _loc2_ = this.var_541.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_539 != null)
         {
            _loc2_ = this.var_539.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_209 != null && (this.var_209.type == param1 || this.var_209.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_83;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_83;
         ...
         {
            return RoomObjectCategoryEnum.const_331;
         }
         return RoomObjectCategoryEnum.const_183;
      }
      ...
      {
         return [const_461,const_674,const_672,const_673,TILE_CURSOR,const_1087];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_448.getValue(param1) as String;
      ...
      {
         return this.var_1015.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1016[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_799.getValue(param1) != null)
         {
            return this.var_799.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_209 != null && this.var_209.hasWorldType(const_367 + param1))
         {
            return this.var_209.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_279 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_372[_loc4_] == null)
                     {
                        this.var_372[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_392,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1513.getValue(param1) != null)
         {
            this.var_209 = this.var_1513.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_857,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2647.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1735);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2643.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_392,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_605,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1016.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1513.add(param1,_loc4_);
         this.var_209 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_798.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_798.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_540.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_798.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_540.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_540.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_493.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_449.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_449.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_449[_loc2_] != null)
         {
            _loc3_ = this.var_449.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_367 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_367 + param1) == RoomObjectCategoryEnum.const_83)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_209.getWorldHeightScale(const_367 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_209 != null)
         {
            return this.var_209.getWorldScale(const_367 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_448.remove(param1);
         this.var_448.add(param1,param2);
      }
   }
}
