package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_658:String = "temporary_room";
      
      private static const const_364:int = -1;
      
      private static const const_657:String = "room";
      
      private static const const_1060:int = -2;
      
      private static const const_1471:String = "tile_cursor";
      
      private static const const_1058:int = -3;
      
      private static const const_1470:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_365:String = "object_icon_sprite";
      
      private static const const_453:int = 15;
      
      private static const const_1059:int = 40;
      ...
      private var var_771:IRoomObjectFactory = null;
      ...
      private var var_67:RoomObjectEventHandler = null;
      
      private var var_971:RoomMessageHandler = null;
      
      private var var_13:RoomContentLoader = null;
      
      private var var_2510:Boolean = false;
      
      private var var_772:NumberBank;
      
      private var var_1194:Map;
      ...
      {
         this.var_519 = new Array();
         super(param1,param2);
         this.var_304 = new Map();
         this.var_772 = new NumberBank(1000);
         this.var_1194 = new Map();
         this.var_358 = new Map();
         this.var_67 = new RoomObjectEventHandler(this);
         this.var_971 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_771.release(new IIDRoomObjectFactory());
            this.var_771 = null;
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_304.length)
            {
               _loc2_ = this.var_304.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_304.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_304.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      {
         return this.getRoomCamera(this.var_78,this.var_79);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_78,this.var_79));
      ...
      {
         this.var_1193 = false;
         if(this.var_519 && this.var_519.length > 0)
         {
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_277:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_15.getSession(this.var_78,this.var_79);
         ...
         var _loc5_:int = this.var_519.indexOf(_loc4_);
         if(_loc5_ == -1)
         {
            this.var_519.push(_loc4_);
            this.var_1193 = true;
         }
      }
      ...
      private function removeBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = this.var_519.indexOf(_loc3_);
         if(_loc4_ > -1)
         {
            this.var_519.splice(_loc4_,1);
            this.var_1193 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_970 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc11_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_304.length)
         {
            _loc3_ = this.var_304.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_78 || _loc6_ != this.var_79 || !this.var_969)
                  {
               ...
               if(_loc11_ != null)
               {
                  if(this.var_969)
                  {
                     _loc11_.screenOffsetX += this.var_1481;
                     _loc11_.screenOffsetY += this.var_1482;
                     this.var_1481 = 0;
                     this.var_1482 = 0;
                  }
               }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_934) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_906) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_872) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_941) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_771 = param2 as IRoomObjectFactory;
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_32);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_331);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_83);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_971 != null)
            {
               this.var_971.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_751,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_148);
         }
         this.var_2508 = this.var_148.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_751)
         {
            this.var_2510 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_301.events.addEventListener(AdEvent.const_567,this.showRoomAd);
         this.var_301.events.addEventListener(AdEvent.const_827,this.onRoomAdImageLoaded);
         this.var_301.events.addEventListener(AdEvent.const_960,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_377;
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_771 != null)
         {
            this.var_771.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_771 == null || this.var_493 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_148 == null || !this.var_2510)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_520 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_887,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_358.length)
            {
               _loc3_ = this.var_358.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1182,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_637,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_525,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1182);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_520)
         {
            _loc5_ = this.var_358.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_358.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_350,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_364,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1150,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_706,1,true);
            _loc12_ = parseInt(this.var_148.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1363,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_364,const_657,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_706,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_723,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_934,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_872,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_906,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_941,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1359,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_844,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_213,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_894,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_195,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_739,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_215,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_545,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_290);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_879,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_885,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_879,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_885,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1185,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1270,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1060,const_1471,RoomObjectCategoryEnum.const_331);
         if(this.var_148.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1058,const_1470,RoomObjectCategoryEnum.const_331);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_364,RoomObjectCategoryEnum.const_83);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ == null)
         {
            ...
            _loc11_ = this.var_358.getValue(_loc10_);
            if(_loc11_ == null)
            {
               _loc11_ = new RoomData(param1,param2,null);
               this.var_358.add(_loc10_,_loc11_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            {
               _loc8_.setString(RoomObjectVariableEnum.const_213,param3);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_844,param3);
         ...
         if(param4 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_195,param4);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_894,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_215,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_739,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1792,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1208,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1245,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1293,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_678,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_304.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_359,param1,param2));
      }
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.targetCategory = RoomObjectCategoryEnum.const_32;
         }
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1228;
         ...
         _loc10_.mouseListener = this.var_67;
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_723);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_879);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_885);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1185);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1270);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1479;
         var _loc9_:int = param3 - this.var_1480;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_969 = true;
               this.var_770 = false;
               this.var_2511 = this.var_1479;
               this.var_2509 = this.var_1480;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_969)
            {
               ...
               if(this.var_770)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_78,this.var_79);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_969)
            {
               if(!this.var_770)
               {
                  _loc8_ = param2 - this.var_2511;
                  _loc9_ = param3 - this.var_2509;
                  if(_loc8_ <= -const_453 || _loc8_ >= const_453 || _loc9_ <= -const_453 || _loc9_ >= const_453)
                  {
                     this.var_770 = true;
                  }
                  _loc8_ = 0;
               ...
               {
                  this.var_1481 += _loc8_;
                  this.var_1482 += _loc9_;
                  this.var_770 = true;
               }
            }
         }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_365);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_500,this.var_78,this.var_79,-1,RoomObjectCategoryEnum.const_183));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_67 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_364,const_657);
                     this.var_67.handleRoomObjectEvent(_loc14_,this.var_78,this.var_79);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_78,this.var_79,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,this.var_1483);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_365);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_365,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1479 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1480 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,this.var_1483);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_365);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_78,this.var_79,this.var_1483);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_365);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_67 != null)
         {
            return this.var_67.modifyRoomObject(this.var_78,this.var_79,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_67.modifyRoomObjectData(this.var_78,this.var_79,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_67 != null)
         {
            ...
            {
               return this.var_67.modifyWallItemData(this.var_78,this.var_79,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_67.deleteWallItem(this.var_78,this.var_79,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_78,this.var_79);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_706) != 0)
         {
            return false;
         }
         if(this.var_67 != null)
         {
            return this.var_67.initializeRoomObjectInsert(this.var_78,this.var_79,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_67 != null)
         {
            this.var_67.cancelRoomObjectInsert(this.var_78,this.var_79);
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:IRoomObject = this.getRoomObject(this.var_78,this.var_79,param1,param2);
         if(_loc3_ != null)
         {
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_183;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1058,RoomObjectCategoryEnum.const_331);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1060,RoomObjectCategoryEnum.const_331);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_274,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_284,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_387,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_830,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1302,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1141,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_862,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_282,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Boolean) : Boolean
      {
         var _loc11_:* = null;
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_274,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_284,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_387,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1228,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_862,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_282,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1191) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1165);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_545,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_870,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_282,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_220);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_427,this.var_78,this.var_79,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_67 != null)
         {
            this.var_67.handleRoomObjectEvent(param1,this.var_78,this.var_79);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_274));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_313);
                     break;
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_203);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_213,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_195,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_215,_loc6_);
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_545,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_658);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_658,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_772.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_274,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_313,param7);
               break;
            case RoomObjectCategoryEnum.const_32:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_203,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_874,int(param2));
               }
               break;
            case RoomObjectCategoryEnum.const_83:
         ...
         if(param8 > -1)
         {
            _loc18_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_93);
         ...
         {
            this.var_1194.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1194,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_772.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_78,this.var_79,const_364,RoomObjectCategoryEnum.const_83,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_658);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1194);
               ...
               this.var_772.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1194.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_93);
            if(_loc7_ != null)
            {
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(this.var_67 != null)
         {
            this.var_67.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(this.var_67 != null)
         {
            return this.var_67.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         this.var_67.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_395,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1158,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1196,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1211,RoomObjectVariableEnum.const_395,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_301.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_827:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1310,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_960:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1236,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
