package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_2746:int = -1;
      
      private var var_1994:Boolean = true;
      
      private var var_1541:int = -1.0E9;
      
      private var var_825:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_825 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onRoomVisualizationSettings(param1:IMessageEvent) : void
      {
         ...
         if(this.var_12 != null)
         {
            ...
            this.var_12.updateObjectRoomPlaneThicknesses(_loc4_,_loc5_,_loc8_,_loc9_);
         }
      }
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_825.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_825.objectData);
            this.var_825.objectData = null;
         }
         else
         {
            this.var_825.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_825.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_825.objectData = _loc6_;
         }
      }
      ...
      private function addActiveObject(param1:int, param2:int, param3:ObjectMessageData) : void
      {
         ...
         {
            this.var_12.addObjectFurniture(param1,param2,param3.id,param3.type,_loc4_,_loc5_,param3.state,param3.data,param3.extra,param3.expiryTime,param3.knownAsUsable);
         }
      }
      ...
      private function addWallItem(param1:int, param2:int, param3:ItemMessageData) : void
      {
         ...
         this.var_12.addObjectWallItem(param1,param2,param3.id,param3.type,_loc5_,_loc6_,param3.state,param3.data,param3.knownAsUsable);
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_723);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1179:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1226:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1349,_loc3_.status);
         }
      }
