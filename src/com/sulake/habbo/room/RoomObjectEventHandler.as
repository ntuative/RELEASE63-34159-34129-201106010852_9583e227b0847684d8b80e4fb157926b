   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               if(param4 == RoomObjectCategoryEnum.const_32)
               {
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_798,param1,param2,param3,param4));
         }
      }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         if(_loc5_ != RoomObjectCategoryEnum.const_83)
         {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_63:
               this.handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_777:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_65:
               ...
               break;
            case RoomObjectMoveEvent.const_438:
               this.handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_738:
               this.handleSelectedObjectRemove(param1,param2,param3);
               break;
            case RoomObjectWidgetRequestEvent.const_166:
            ...
            case RoomObjectWidgetRequestEvent.const_152:
            ...
            case RoomObjectWidgetRequestEvent.const_162:
            case RoomObjectWidgetRequestEvent.const_146:
               this.handleObjectWidgetRequestEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_578:
            case RoomObjectFurnitureActionEvent.const_534:
            case RoomObjectFurnitureActionEvent.const_618:
            case RoomObjectFurnitureActionEvent.const_601:
            case RoomObjectFurnitureActionEvent.const_551:
            case RoomObjectFurnitureActionEvent.const_603:
            case RoomObjectFurnitureActionEvent.const_543:
               this.handleObjectActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_532:
            case RoomObjectFurnitureActionEvent.const_490:
            case RoomObjectFurnitureActionEvent.const_471:
            case RoomObjectFurnitureActionEvent.const_485:
               this.handleObjectSoundMachineEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_600:
            case RoomObjectFurnitureActionEvent.const_474:
            case RoomObjectFurnitureActionEvent.const_473:
            case RoomObjectFurnitureActionEvent.const_554:
               this.handleObjectJukeboxEvent(param1,param2,param3);
               break;
            case RoomObjectRoomAdEvent.const_206:
            case RoomObjectRoomAdEvent.const_486:
            case RoomObjectRoomAdEvent.const_305:
            case RoomObjectRoomAdEvent.const_304:
            case RoomObjectRoomAdEvent.const_179:
               this.handleObjectRoomAdEvent(param1,param2,param3);
               break;
            case RoomObjectRoomActionEvent.const_504:
            case RoomObjectRoomActionEvent.const_1683:
            case RoomObjectRoomActionEvent.const_519:
               this.handleRoomActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_337:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_141:
               this.handleRoomObjectMouseClick(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_635:
            ...
            case RoomObjectMouseEvent.const_185:
               ...
               break;
            case RoomObjectMouseEvent.const_177:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc8_ == RoomObjectCategoryEnum.const_83)
               {
                  if(_loc5_ != null)
                  {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  _loc13_ = false;
                  _loc14_ = false;
                  if(_loc8_ == RoomObjectCategoryEnum.const_32)
                  {
                     if(!this._roomEngine.getIsPlayingGame(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory))
                     {
                        _loc13_ = true;
                  ...
                  if(_loc10_ != null)
                  {
                     if(_loc13_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_83,MouseEvent.CLICK,_loc10_);
                     }
                     if(_loc14_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_183,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_83)
         {
            _loc15_ = this.getMouseEventId(RoomObjectCategoryEnum.const_183,MouseEvent.CLICK);
            _loc16_ = this.getMouseEventId(RoomObjectCategoryEnum.const_32,MouseEvent.CLICK);
            if(_loc15_ != _loc10_ && _loc16_ != _loc10_)
            {
               _loc17_ = this._roomEngine.events;
               if(_loc17_ != null)
               {
                  _loc17_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_500,param2,param3,-1,RoomObjectCategoryEnum.const_183));
               }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_633);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_636);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
         ...
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc7_ == RoomObjectCategoryEnum.const_83)
               {
      ...
      private function handleRoomObjectMouseLeave(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_177,param2,param3,param1.objectId,this._roomEngine.getRoomObjectCategory(param1.objectType)));
         }
      }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_27 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_722,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            {
               this._roomEngine.addObjectWallItem(param2,param3,_loc5_.id,_loc5_.typeId,new Vector3d(),new Vector3d(),0,_loc5_.instanceData,false);
            }
            else if(_loc5_.category == RoomObjectCategoryEnum.const_32 && _loc7_ != null)
            {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_27)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_920);
      ...
      private function handleObjectWidgetRequestEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               case RoomObjectWidgetRequestEvent.const_166:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_166,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
               ...
               case RoomObjectWidgetRequestEvent.const_145:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_152:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_152,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_139:
               ...
               case RoomObjectWidgetRequestEvent.const_112:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_162:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_162,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_146:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_532:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_692,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_490:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_901,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_471:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1002,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_485:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_747,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_600:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_905,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_474:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1844,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_473:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1866,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_554:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_232,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_324);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_426);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_324);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_426);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_324);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1000);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1132);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_352,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1543,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_633));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_636));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_920);
         }
      ...
      private function placeObject(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_27 || _loc7_ == RoomObjectCategoryEnum.const_32)
               {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_32 && _loc5_.typeId == RoomObjectTypeEnum.const_191)
               {
                  this._roomEngine.connection.send(new PlacePetMessageComposer(_loc6_,int(_loc10_),int(_loc11_)));
               }
               else if(_loc8_.getModelController().getString(RoomObjectVariableEnum.const_1275) != null)
               {
