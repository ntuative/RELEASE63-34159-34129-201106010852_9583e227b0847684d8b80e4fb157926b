package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_678:Number = 0.25;
      
      private static const const_1293:Number = 0.25;
      ...
      private var var_1394:Number = 1.0;
      
      private var _floorThicknessMultiplier:Number = 1.0;
      
      private var var_904:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_123.push(_loc4_);
            this.var_672.push(_loc5_);
            _loc3_++;
         }
         this.var_282 = param1;
         this._height = param2;
         this.var_461 = this.var_282;
         this.var_458 = -1;
         this.var_460 = this._height;
         this.var_459 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_282 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_123[param2] as Array;
            ...
            {
               if(param1 == this.var_461 || param1 == this.var_458)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_460;
               ...
               if(param2 == this.var_460 || param2 == this.var_459)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_461;
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_123[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_282)
            {
               this.var_672[_loc2_][_loc8_] = this.var_123[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_123);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_904 = getFloorHeight(this.var_123);
         if(!param1)
         {
         ...
         var _loc6_:* = [];
         var _loc7_:int = 0;
         while(_loc7_ < this.var_123.length)
         {
            _loc5_ = this.var_123[_loc7_];
            _loc9_ = [];
            _loc10_ = 0;
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_280,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_371,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1293 * this.var_1394;
         var _loc9_:Number = const_678 * this._floorThicknessMultiplier;
         ...
         this.addPlane(RoomPlaneData.const_280,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_280,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_280,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_280,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_123 == null || param1 == this.var_123)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_123.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_123[_loc3_] as Array;
         ...
         if(_loc19_)
         {
            ...
            this.addFloor(new Vector3d(_loc29_ + _loc17_,_loc30_ + 0.34,_loc28_ + _loc19_ / 4 * 2),new Vector3d(-_loc17_,0,0),new Vector3d(0,-0.34,0),_loc26_ > 0,_loc25_ > 0,_loc34_ > 0,_loc33_ > 0,0,0,0,0,false,true);
            this.addFloor(new Vector3d(_loc29_ + _loc17_,_loc30_ + 0.67,_loc28_ + _loc19_ / 4),new Vector3d(-_loc17_,0,0),new Vector3d(0,-0.33,0),_loc26_ > 0,_loc25_ > 0,_loc34_ > 0,_loc33_ > 0,0,0,0,0,false,true);
         }
         if(_loc20_)
         {
            if(_loc20_ < 0)
            ...
            this.addFloor(new Vector3d(_loc29_ + _loc17_,_loc30_ + _loc18_,_loc28_ + _loc20_ / 4),new Vector3d(-_loc17_,0,0),new Vector3d(0,-0.33,0),_loc26_ > 0,_loc25_ > 0,_loc34_ > 0,_loc33_ > 0,0,0,0,0,false,true);
         }
         if(_loc21_)
         {
            if(_loc21_ > 0)
            ...
            this.addFloor(new Vector3d(_loc29_ + 0.34,_loc30_ + _loc18_,_loc28_ + _loc21_ / 4 * 2),new Vector3d(-0.34,0,0),new Vector3d(0,-_loc18_,0),_loc32_ > 0,_loc31_ > 0,_loc24_ > 0,_loc23_ > 0,0,0,0,0,true,false);
            this.addFloor(new Vector3d(_loc29_ + 0.67,_loc30_ + _loc18_,_loc28_ + _loc21_ / 4),new Vector3d(-0.33,0,0),new Vector3d(0,-_loc18_,0),_loc32_ > 0,_loc31_ > 0,_loc24_ > 0,_loc23_ > 0,0,0,0,0,true,false);
         }
         if(_loc22_)
         {
            if(_loc22_ < 0)
            ...
            this.addFloor(new Vector3d(_loc29_ + _loc17_,_loc30_ + _loc18_,_loc28_ + _loc22_ / 4),new Vector3d(-0.33,0,0),new Vector3d(0,-_loc18_,0),_loc32_ > 0,_loc31_ > 0,_loc24_ > 0,_loc23_ > 0,0,0,0,0,true,false);
         }
         _loc4_ = _loc10_;
         ...
         this.addFloor(new Vector3d(_loc29_ + _loc17_,_loc30_ + _loc18_,_loc28_),new Vector3d(-_loc17_,0,0),new Vector3d(0,-_loc18_,0),_loc26_ > 0,_loc25_ > 0,_loc24_ > 0,_loc23_ > 0,_loc35_,_loc36_,_loc37_,_loc38_,false,false);
         return true;
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_249,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_678 * this._floorThicknessMultiplier;
            _loc19_ = _loc18_;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_249,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_249,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_249,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_249,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_282}" height="{this._height}" wallHeight="{this.var_1567}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc4_ = <tileRow/>;
            _loc5_ = this.var_672[_loc2_];
            _loc6_ = 0;
            while(_loc6_ < this.var_282)
            {
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_134[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1295;
         }
         var _loc2_:RoomPlaneData = this.var_134[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_134[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
