   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2501 = param1.extra;
            this.var_1187 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1187 > 0 && param1 >= this.var_1187)
         {
            this.var_1187 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1821,String(this.var_1821),this.var_2501);
