package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_474,RoomObjectFurnitureActionEvent.const_473,RoomObjectFurnitureActionEvent.const_554,RoomObjectFurnitureActionEvent.const_600,RoomObjectWidgetRequestEvent.const_146];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_830) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_373,RoomWidgetInfostandExtraParamEnum.const_546);
            ...
            if(_loc4_ != this.var_2221)
            {
               this.var_2221 = _loc4_;
               if(_loc4_ == 1)
               {
      ...
      override public function useObject() : void
      {
         ...
         if(eventDispatcher != null && object != null)
         {
            ...
            _loc3_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_146,_loc1_,_loc2_);
            eventDispatcher.dispatchEvent(_loc3_);
            eventDispatcher.dispatchEvent(new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_63,_loc1_,_loc2_,-1));
         }
      }
      ...
      private function requestInit() : void
      {
         ...
         this.var_1698 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_600,object.getId(),object.getType());
