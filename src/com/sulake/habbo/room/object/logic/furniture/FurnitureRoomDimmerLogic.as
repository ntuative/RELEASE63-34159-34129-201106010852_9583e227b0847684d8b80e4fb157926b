package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_169,RoomObjectWidgetRequestEvent.const_112,RoomObjectDimmerStateUpdateEvent.const_65];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1950)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               eventDispatcher.dispatchEvent(_loc3_);
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_112,_loc1_,_loc2_);
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_93);
            if(_loc2_ != null && _loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_93,"");
