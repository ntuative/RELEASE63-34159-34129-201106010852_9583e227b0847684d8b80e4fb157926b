package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_490,RoomObjectFurnitureActionEvent.const_471,RoomObjectFurnitureActionEvent.const_485,RoomObjectFurnitureActionEvent.const_532];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2221)
         {
            this.var_2221 = _loc3_;
            if(_loc3_ == 1)
            {
