package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_2258:String = "TYPE_INJECTED";
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_139,RoomObjectFurnitureActionEvent.const_551];
         ...
         if(_loc5_ == this.const_2258)
         {
            if(param1.type == MouseEvent.MOUSE_UP)
            {
               if(eventDispatcher != null)
               {
                  ...
                  _loc9_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_139,_loc7_,_loc8_);
      ...
      override public function useObject() : void
      {
         ...
         if(eventDispatcher != null && object != null)
         {
            ...
            _loc3_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_551,_loc1_,_loc2_);
