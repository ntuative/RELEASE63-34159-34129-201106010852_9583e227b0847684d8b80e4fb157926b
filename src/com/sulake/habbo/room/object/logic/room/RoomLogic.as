package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1685:int = 255;
      
      private var var_1406:uint = 16777215;
      
      private var var_1686:int = 255;
      
      private var var_1133:uint = 16777215;
      
      private var var_1688:int = 255;
      
      private var var_1134:int = 0;
      
      private var var_1687:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_635,RoomObjectMouseEvent.const_141];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1246,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_951,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_742,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_886,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_946,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1134)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1685;
            if(_loc2_ - this.var_1134 >= this.var_1687)
            {
               _loc3_ = this.var_1133;
               _loc4_ = this.var_1688;
               this.var_1134 = 0;
            }
            else
            {
               _loc7_ = this.var_1406 >> 16 & 255;
               _loc8_ = this.var_1406 >> 8 & 255;
               _loc9_ = this.var_1406 & 255;
               _loc10_ = this.var_1133 >> 16 & 255;
               _loc11_ = this.var_1133 >> 8 & 255;
               _loc12_ = this.var_1133 & 255;
               _loc13_ = (_loc2_ - this.var_1134) / this.var_1687;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1686 + (this.var_1688 - this.var_1686) * _loc13_;
               this._color = _loc3_;
               this.var_1685 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_951,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_844:
               param2.setString(RoomObjectVariableEnum.const_213,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_894:
               param2.setString(RoomObjectVariableEnum.const_195,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_739:
               param2.setString(RoomObjectVariableEnum.const_215,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_545:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_290)
               {
                  _loc5_ = "null";
               }
               this.var_496.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_870:
               _loc4_ = this.var_496.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_496.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1317,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1245:
               param2.setNumber(RoomObjectVariableEnum.const_742,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1208:
               param2.setNumber(RoomObjectVariableEnum.const_886,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_946,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_678:
               param2.setNumber(RoomObjectVariableEnum.const_1130,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1293:
               param2.setNumber(RoomObjectVariableEnum.const_1301,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1149,int(param1.bgOnly));
         this.var_1406 = this._color;
         this.var_1686 = this.var_1685;
         this.var_1133 = _loc3_;
         this.var_1688 = _loc4_;
         this.var_1134 = getTimer();
         this.var_1687 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_616,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1899,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1778,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1776,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_616,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_280 || _loc12_ == RoomPlaneData.const_371)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
