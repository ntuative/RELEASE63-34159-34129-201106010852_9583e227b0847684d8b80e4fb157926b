package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_2058:int = 0;
      ...
      private var var_122:Map = null;
      
      private var var_428:int = -1;
      
      private var var_2017:Boolean = false;
      
      private var var_1563:Array = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_122 != null)
         {
            ...
            {
               _loc2_ = this.var_122.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(this.var_1563 != null && this.var_1563.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_428;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_122.add(param1,_loc6_);
         var _loc10_:int = _loc6_.frameCount;
         if(_loc10_ > this.var_428)
         {
            this.var_428 = _loc10_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_122.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_122.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
