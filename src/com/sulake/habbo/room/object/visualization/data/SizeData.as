package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_436:int = 1000;
      ...
      private var var_1576:int = 360;
      
      private var var_838:DirectionData = null;
      
      private var var_276:Map;
      
      private var _colors:Map;
      
      private var var_1312:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_838 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_276 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < this.var_276.length)
            {
               _loc2_ = this.var_276.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_838,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_276.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_838);
            this.defineDirection(_loc3_,_loc8_);
            this.var_276.add(String(_loc7_),_loc3_);
            this.var_2033 = -1;
            this.var_1312 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1205);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1145);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1576 / 2) % 360 / this.var_1576;
         if(this.var_276.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_276.length)
         {
            _loc6_ = int(this.var_276.getKey(_loc5_)) * this.var_1576;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_276.getKey(_loc4_));
         }
         return const_1738;
      }
      ...
      {
         if(param1 == this.var_2033)
         {
            return this.var_1312;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_276.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_838;
         }
         this.var_2033 = param1;
         this.var_1312 = _loc2_;
         return this.var_1312;
      }
