package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_610:Dictionary;
      
      private var var_227:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_610)
         {
            for each(_loc1_ in this.var_610)
            {
               _loc1_.dispose();
            }
            this.var_610 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_227 = this.var_610[param1];
               _loc3_ = true;
            }
            else if(param1 != var_94)
            {
               if(this.var_227)
               {
                  this.var_227.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_227)
         {
            this.var_227.setAnimation(param1);
         }
      ...
      {
         if(this.var_227 && this.var_227.controlsSprite(param3))
         {
            return this.var_227.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1315);
         if(_loc3_.length == 0)
         {
