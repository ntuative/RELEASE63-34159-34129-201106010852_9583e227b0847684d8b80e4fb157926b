package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_821[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_821[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_821.length == 2)
            {
               return this.var_821[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_821.length == 2)
            {
               return this.var_821[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1270[param2];
         var _loc4_:int = this.var_1272[param2];
         var _loc5_:int = this.var_1269[param2];
         var _loc6_:Number = this.var_1271[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1090;
         }
         ...
         this.var_1270[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1271[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1270.push(Math.random() * _loc2_ * 1.5);
         this.var_1270.push(Math.random() * _loc2_ * 1.5);
         this.var_1272 = new Array();
         this.var_1272.push(1);
         this.var_1272.push(-1);
         this.var_1269 = new Array();
         this.var_1269.push(const_1570);
         this.var_1269.push(const_1569);
         this.var_1271 = new Array();
         this.var_1271.push(this.getRandomAmplitudeFactor());
         this.var_1271.push(this.getRandomAmplitudeFactor());
      }
