package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      public function FurniturePlanetSystemVisualization()
      {
         ...
         this.var_2864 = new Vector3d(0,0,0);
         super();
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_280 == null && spriteCount > 0)
         {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_280.length)
            {
               _loc2_ = this.var_280[_loc3_];
               _loc2_.update(this._offsetArray,this.var_2864,param1);
               _loc3_++;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1292);
