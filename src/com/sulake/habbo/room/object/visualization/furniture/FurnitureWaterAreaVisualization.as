package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1431:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1169)
            {
      ...
      {
         if(this.var_2446 == param1 && this.var_2447 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1431)
            {
               this.var_1791 = _loc2_;
               this.var_2446 = param1;
               this.var_2447 = direction;
               return this.var_1791;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1169.indexOf(_loc2_) < 0)
            {
               this.var_1169.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_516 + 2;
         var _loc4_:int = this.var_612 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_613[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_613[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_516 == 0 || this.var_612 == 0)
         {
            ...
            this.var_516 = _loc2_.getNumber(RoomObjectVariableEnum.const_324);
            this.var_612 = _loc2_.getNumber(RoomObjectVariableEnum.const_426);
         }
         this.var_431 = [];
         this.var_613 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_516 * 2 + this.var_612 * 2)
         {
            this.var_431.push(false);
            this.var_613.push(ShoreMaskCreatorUtility.const_82);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_516 + 2;
         var _loc2_:int = this.var_612 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_74 == null || this.var_74.width < param1 || this.var_74.height < param2)
         {
            if(this.var_74 != null)
            {
               this.var_74.dispose();
            }
            this.var_74 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_74,getSize(param3),this.var_431,this.var_613,assetCollection);
      }
