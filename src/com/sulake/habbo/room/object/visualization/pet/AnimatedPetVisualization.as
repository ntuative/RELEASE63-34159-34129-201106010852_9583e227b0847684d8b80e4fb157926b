package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1620:String = "head";
      
      private static const const_685:int = 1;
      
      private static const const_1113:int = 1000;
      
      private static const const_1618:String = "pet_experience_bubble_png";
      
      private static const const_1619:int = 0;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1087 = [];
         super();
         while(this.var_130.length < ANIMATION_INDEX_COUNT)
         {
            this.var_130.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_130 != null)
         {
            ...
            {
               _loc2_ = this.var_130[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1618) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_402 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2924)
            {
               this.var_2924 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_155)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_265);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_154);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_265);
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_94);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_94,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_154);
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_94);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_94,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_1863 = _loc3_.getNumber(RoomObjectVariableEnum.const_442) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_220);
            if(!isNaN(_loc8_))
            {
               this.var_2093 = _loc8_;
            }
            else
            {
               this.var_2093 = direction;
            }
            this.var_1436 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2273 = _loc3_.getNumber(RoomObjectVariableEnum.const_942);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_874);
            if(_loc9_ != this.var_2092)
            {
               this.var_2092 = _loc9_;
               this.var_2925 = this.var_2092.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_402 != null)
         {
            ...
            if(this.var_1436 > 0)
            {
               _loc2_ = param1 - this.var_1436;
               if(_loc2_ < const_1113)
               {
                  this.var_402.alpha = int(Math.sin(_loc2_ / const_1113 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_402.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_402.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_261 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_94,param1);
            this.setAnimationForIndex(const_1619,_loc3_);
         }
         if(param2 != this.var_1435)
         {
            this.var_1435 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_94,param2);
            this.setAnimationForIndex(const_1617,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_685;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_130.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1619 = false;
         var _loc1_:int = this.var_130.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_130[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_130.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_130[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_130.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_130[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2925);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_685)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_685))
            {
               if(param2 >= FurnitureVisualizationData.const_563.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_563[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2093);
         }
         return direction;
      }
      ...
      {
         if(this.var_1087[param1] == null)
         {
            if(this._animationData.getTag(var_94,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1620)
            {
               this.var_1087[param1] = true;
            }
            else
            {
               this.var_1087[param1] = false;
            }
         }
         return this.var_1087[param1];
      }
   }
}
