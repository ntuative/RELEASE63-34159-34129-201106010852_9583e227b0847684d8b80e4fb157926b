package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      {
         if(this.var_2263 == param1 || this.var_89 == null)
         {
            return;
         }
         this.var_89.copyPixels(this._copy,this._copy.rect,new Point(0,0));
         ...
         this.var_89.draw(_loc3_,_loc4_);
      }
   }
}
