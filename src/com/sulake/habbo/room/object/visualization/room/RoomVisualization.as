package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1965:int = 16777215;
      
      public static const const_1843:int = 13421772;
      
      private static const const_1008:int = 16777215;
      
      private static const const_1009:int = 13421772;
      
      private static const const_1010:int = 10066329;
      
      private static const const_1011:int = 10066329;
      
      public static const const_1662:int = 16777215;
      
      public static const const_1767:int = 13421772;
      
      public static const const_1827:int = 10066329;
      ...
      private var var_723:Rectangle = null;
      
      private var var_496:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1394:Number = NaN;
      
      private var var_1662:String = null;
      
      private var var_1128:uint = 16777215;
      ...
      private var var_1869:int = -1000;
      
      private const const_2246:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_496 = new RoomPlaneBitmapMaskParser();
      ...
      private function resetRoomPlanes() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_134.length)
            {
               _loc2_ = this.var_134[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_723 = super.boundingRectangle;
         }
         return new Rectangle(this.var_723.x,this.var_723.y,this.var_723.width,this.var_723.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               ...
               else if(_loc3_.type == RoomPlane.const_107)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1394;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1246);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1359);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_280)
            {
               ...
               {
                  _loc13_.color = const_1011;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1008;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1009;
               }
               else
               {
                  _loc13_.color = const_1010;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_371)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1662;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1767;
               }
               else
               {
                  _loc13_.color = const_1827;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1801)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_71,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_371)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1869 + this.const_2246 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_344.length)
            {
               _loc11_ = this.var_592[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_344[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1665)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2218 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2219 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2217 / 255);
         ...
         var_155 = _loc7_.getUpdateID();
         this.var_1869 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1663)
         {
            this.var_1663 = param1.updateId;
            this.var_723 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1592 || _loc3_.y != this.var_2216 || _loc3_.z != this.var_2215 || param1.scale != this.var_1664))
            {
               this.var_1592 = _loc3_.x;
               this.var_2216 = _loc3_.y;
               this.var_2215 = _loc3_.z;
               this.var_1664 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_155 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1317);
            if(_loc3_ != this.var_1662)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1662 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_951));
            if(_loc4_ != this.var_1128)
            {
               this.var_1128 = _loc4_;
               this.var_2218 = this.var_1128 & 255;
               this.var_2219 = this.var_1128 >> 8 & 255;
               this.var_2217 = this.var_1128 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1149));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_155 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_195);
            ...
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_886));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_946));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_155 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1130);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1301);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1394))
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_134.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_107 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_344;
         if(this.var_344.length == 0)
         {
            _loc6_ = this.var_134;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_344.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_107)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_344.push(_loc12_);
                        this.var_592.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1127;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_496.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_496.maskCount)
         {
            _loc10_ = this.var_496.getMaskType(_loc8_);
            _loc11_ = this.var_496.getMaskLocation(_loc8_);
            _loc12_ = this.var_496.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_71 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_290)
                              {
