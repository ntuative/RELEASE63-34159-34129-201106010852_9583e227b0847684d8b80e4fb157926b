package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_950:int = 0;
      ...
      public static const const_258:int = 4;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34 != null)
         {
            ...
            {
               _loc2_ = this.var_34[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc3_:int = 0;
         if(this.var_1747 == const_950)
         {
            _loc3_ = this.getCellsHeight(this.var_34,param2);
            param1 = _loc3_;
         }
         if(this._cachedBitmapNormal == null)
         {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.height == param1 && Vector3d.isEqual(this._cachedBitmapNormal,param2))
               {
                  return this.var_30;
               }
               this.var_30.dispose();
         ...
         if(this.var_30 == null)
         {
            this.var_30 = new BitmapData(this.var_282,param1,true,16777215);
         }
         this._cachedBitmapNormal.assign(param2);
         if(this.var_34.length == 0)
         {
            return this.var_30;
         }
         switch(this.var_1747)
         {
            case const_950:
      ...
      {
         if(this.var_34.length == 0 || this.var_30 == null)
         {
            return;
         }
         this.renderCells(this.var_34,0,true,param1);
      }
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = this.getCellsHeight(this.var_34,param1);
         var _loc3_:int = 0;
         ...
         {
            _loc3_ = this.renderCells(this.var_34,_loc3_,true,param1);
            if(_loc3_ == 0)
            {
               return;
            }
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         var _loc7_:int = 0;
         _loc7_ = 1;
         while(_loc7_ < this.var_34.length - 1)
         {
            _loc2_ = this.var_34[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         if(this.var_34.length == 1)
         {
            _loc2_ = this.var_34[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc6_ = _loc2_.getHeight(param1);
               if(_loc6_ > 0)
         ...
         _loc2_ = this.var_34[this.var_34.length - 1] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         var _loc9_:int = 0;
         _loc9_ = 0;
         while(_loc9_ < this.var_34.length >> 1)
         {
            _loc2_ = this.var_34[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         _loc9_ = (this.var_34.length >> 1) + 1;
         while(_loc9_ < this.var_34.length)
         {
            _loc2_ = this.var_34[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         _loc3_ = this.renderCells(this.var_34,_loc3_,false,param1);
         _loc2_ = this.var_34[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
