package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_994:int = 6;
      
      public static const const_1665:int = const_444;
      ...
      public static const ALIGN_DEFAULT:int = const_133;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2376 = param6;
         this.var_2378 = param7;
         if(this.var_1747 == const_994)
         {
            this.var_1922 = false;
         }
      }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_373[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_373.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_373[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_373[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_656,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_373.length)
         {
            _loc11_ = this.var_373[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_133)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_656);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_656,this.var_30.width,this.var_656);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_373.length == 1)
         {
            _loc4_ = this.var_373[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
