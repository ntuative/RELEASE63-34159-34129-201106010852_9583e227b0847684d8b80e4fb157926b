package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2104:int = 1;
      
      public static const const_2060:int = 16777216;
      ...
      private var var_1942:int = 16777216;
      
      private var var_2990:int = 69069;
      
      private var var_2991:int = 5;
      ...
      {
         var _loc1_:int = this.var_2990 * this.var_1941 + this.var_2991;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1942;
         this.var_1941 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1942 * param2);
      }
   }
}
