package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_86.roomEngine.getRoomObject(this.var_86.roomId,this.var_86.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
