package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_335:int = 3;
      
      private static var var_1614:int = 2;
       
      
      private var var_86:HabboUserDefinedRoomEvents;
      
      private var _window:IFrameWindow;
      
      private var var_52:IWindowContainer;
      
      private var var_2083:TriggerConfs;
      
      private var var_2081:ActionTypes;
      
      private var var_2082:ConditionTypes;
      
      private var var_283:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_864:RoomObjectHightLighter;
      
      private var var_195:UserDefinedRoomEventsHelp;
      
      private var var_1341:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2083 = new TriggerConfs();
         this.var_2081 = new ActionTypes();
         this.var_2082 = new ConditionTypes();
         this.var_283 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_864 = new RoomObjectHightLighter(param1);
         this.var_195 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_283[param1])
         {
            delete this.var_283[param1];
            this.var_864.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_35.furniLimit)
         {
            this.var_283[param1] = param2;
            this.var_864.show(param1);
         }
         this.refresh();
      }
      ...
      {
         return this.resolveHolder().getElementByCode(this.var_35.code);
      }
      
      private function resolveHolder() : ElementTypeHolder
      {
         if(this.var_35 as TriggerDefinition != null)
         {
            return this.var_2083;
         }
         if(this.var_35 as ActionDefinition != null)
         {
            return this.var_2081;
         }
         if(this.var_35 as ConditionDefinition != null)
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_86.getXmlWindow("ude_main"));
         this.var_52 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_52,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_52,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_52,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_52,"apply_snapshot_txt"),this.onApplySnapshot);
         Util.setProcDirectly(this.find(this.var_52,"dec_stuff_sel_txt"),this.onDecStuffSelectionType);
         Util.setProcDirectly(this.find(this.var_52,"inc_stuff_sel_txt"),this.onIncStuffSelectionType);
         this.find(this.var_52,"dec_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_52,"inc_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_52,"helplink").mouseThreshold = 0;
         this.find(this.var_52,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1341 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1341.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1341.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_86.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_86.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_864.hideAll(this.var_283);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.prepareWindow();
         this.var_35 = param1;
         Logger.log("Received: " + this.var_35 + ", " + param1.code);
         var _loc2_:Element = this.resolveType();
         this.var_864.hideAll(this.var_283);
         this.var_283 = new Dictionary();
         for each(_loc3_ in this.var_35.stuffIds)
         {
            this.var_283[_loc3_] = "yes";
         }
         _loc4_ = !!_loc2_.hasSpecialInputs ? this.prepareCustomInput() : null;
         _loc2_.onEditStart(_loc4_,this.var_35);
         this.var_864.showAll(this.var_283);
         if(this.var_35 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_35);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1341.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_35.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_86.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
               this.getFurniTypeMatchesCheckBox().visible = true;
               this.getFurniTypeMatchesText().visible = true;
            }
            else if(_loc2_.requiresFurni == var_335)
            {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_52.findChildByName("select_furni_container"));
         _loc1_.height = Util.getLowestPoint(_loc1_);
      }
      
      private function refreshStuffTypeSelectionToggler() : void
      {
         this.getFurniTypeMatchesText().caption = this.var_86.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_35.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_35 as TriggerDefinition != null)
         {
            this.var_86.send(new UpdateTriggerMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ActionDefinition != null)
         {
            this.var_86.send(new UpdateActionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ConditionDefinition != null)
         {
            this.var_86.send(new UpdateConditionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1341.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_195.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1614) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1614 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_86.send(new ApplySnapshotMessageComposer(this.var_35.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_335)
         {
            return this.var_35.stuffTypeSelectionCode;
         }
         return 0;
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2083);
         this.refreshConfigureElement(this.var_2081);
         this.refreshConfigureElement(this.var_2082);
      ...
      {
         if(!param1.acceptTriggerable(this.var_35))
         {
            this.find(this.var_52,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_52,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_52,3,5);
         this.var_52.height = Util.getLowestPoint(this.var_52) + 1;
      }
      
      private function getElementName(param1:int) : String
      {
         var _loc2_:IFurnitureData = this.var_86.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_52,"header_container"));
         this.find(_loc3_,param2 + "_icon_bitmap").visible = true;
         this.setText(_loc3_,"conf_name_txt",this.getElementName(this.var_35.stuffTypeId));
         this.setText(_loc3_,"conf_desc_txt",this.getElementDesc(this.var_35.stuffTypeId));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_52,"action_inputs_container"));
         if(this.var_35 as ActionDefinition == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         var _loc1_:ActionDefinition = ActionDefinition(this.var_35);
         ...
         this.var_86.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_86.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_86.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         var _loc1_:TriggerDefinition = TriggerDefinition(this.var_35);
         ...
         this.var_86.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_86.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_86.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      
      private function refreshWarning(param1:String, param2:String) : void
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_52,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_52,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_52.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_52.findChildByName("custom_inputs_container"));
         var _loc4_:String = _loc1_.getKey() + _loc2_.code;
         var _loc5_:IWindowContainer = IWindowContainer(_loc3_.getChildByName(_loc4_));
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_86.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_86);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         var _loc4_:int = this.var_35.furniLimit;
         this.var_86.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_86.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
      
      private function getFurniTypeMatchesCheckBox() : ICheckBoxWindow
      {
         return ICheckBoxWindow(this.var_52.findChildByName("furni_type_matches_checkbox"));
      }
      
      private function getDecStuffSelTxt() : IWindow
      {
         return this.var_52.findChildByName("dec_stuff_sel_txt");
      }
      
      private function getIncStuffSelTxt() : IWindow
      {
         return this.var_52.findChildByName("inc_stuff_sel_txt");
      }
      
      private function getFurniTypeMatchesText() : IWindow
      {
         return this.var_52.findChildByName("furni_type_matches_txt");
      }
   }
}
