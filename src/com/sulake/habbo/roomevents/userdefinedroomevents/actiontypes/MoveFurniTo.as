package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class MoveFurniTo implements ActionType
   {
      ...
      {
         return ActionTypeCodes.var_2166;
      }
      ...
      {
         return UserDefinedRoomEventsCtrl.var_335;
      }
      ...
      private function onSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_86.localization.registerParameter("wiredfurni.params.emptytiles","tiles","" + _loc4_);
            }
         }
      }
