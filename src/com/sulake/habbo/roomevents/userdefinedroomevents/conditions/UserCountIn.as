package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1347:SliderWindowController;
      
      private var var_1348:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2149;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1347.getValue());
         _loc2_.push(this.var_1348.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_86 = param2;
         this.var_1347 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1347.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1347.setValue(1);
         this.var_1348 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1348.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1348.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1347.setValue(_loc3_);
         this.var_1348.setValue(_loc4_);
      }
      ...
      private function onMinSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_86.localization.registerParameter("wiredfurni.params.usercountmin","value","" + _loc4_);
            }
         }
      }
      ...
      private function onMaxSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               _loc3_ = _loc2_.getValue();
               _loc4_ = int(_loc3_);
               this.var_86.localization.registerParameter("wiredfurni.params.usercountmax","value","" + _loc4_);
            }
         }
      }
   }
