package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1147:String = "group_badge";
      
      public static const const_1912:String = "normal_badge";
       
      
      private const const_2023:String = "badge_";
      ...
      private function getBadgeImageInternal(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc3_:String = this.const_2023 + param1;
         ...
         switch(param2)
         {
            case const_1912:
               ...
               {
                  _loc5_ = this.var_197.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1147:
               if(this.var_197 != null)
               {
                  if(this.var_197 != null)
                  {
                     _loc5_ = this.var_197.getKey("group.badge.url");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_29,this.onBadgeImageReady);
         }
         return null;
      }
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_2023,"");
