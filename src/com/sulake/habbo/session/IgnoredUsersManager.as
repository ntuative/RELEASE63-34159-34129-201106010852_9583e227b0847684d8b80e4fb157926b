package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      {
         var _loc1_:IConnection = this.var_31.communication.getHabboMainConnection(null);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         var _loc1_:IConnection = this.var_31.communication.getHabboMainConnection(null);
         _loc1_.send(new GetIgnoredUsersMessageComposer(this.var_31.userName));
      }
      ...
      private function onIgnoreResult(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = String(this.var_1621.shift());
      ...
      {
         this.var_1621.push(param1);
         var _loc2_:IConnection = this.var_31.communication.getHabboMainConnection(null);
