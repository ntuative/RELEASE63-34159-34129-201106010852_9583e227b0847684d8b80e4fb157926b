   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_235)
         {
            ...
            {
               _loc1_ = this.var_235.getKey(0) as String;
               _loc2_ = this.var_235.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_80.push(new UserNotificationHandler(this._connection,this));
         this.var_80.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1879)
         {
            this.gotoRoom(this.var_2587,this.var_2588,this.var_1878);
            this.var_1879 = false;
            this.var_1878 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_1504 = true;
         if(this.var_235.getValue(_loc6_) != null)
         {
         ...
         this.var_235.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_296,_loc7_));
         return true;
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1282:
                  break;
               case RoomSessionHandler.const_1284:
                  break;
               case RoomSessionHandler.const_922:
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_235.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_235.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_235.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_235.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_235.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_97,_loc4_));
            _loc4_.dispose();
         }
      }
         ...
         if(param1 != null && this.var_80 != null)
         {
            ...
            while(_loc2_ < this.var_80.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc3_.var_26 = param1.roomCategory;
               }
               _loc2_++;
            }
         }
