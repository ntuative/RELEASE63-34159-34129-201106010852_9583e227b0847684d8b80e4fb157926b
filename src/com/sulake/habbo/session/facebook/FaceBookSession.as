package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1108:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1598:String = "sendAccessTokenToServer";
      
      private static const const_1599:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1598,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1599,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1108);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1108);
         }
      }
