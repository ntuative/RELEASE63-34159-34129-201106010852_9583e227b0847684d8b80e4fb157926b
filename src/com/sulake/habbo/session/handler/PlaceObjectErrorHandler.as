package com.sulake.habbo.session.handler
{
   ...
   public class PlaceObjectErrorHandler extends BaseHandler
   {
      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         {
            case PlaceObjectErrorEnum.const_271:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_275:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_270:
               _loc4_ = "null";
               break;
            ...
            case PlaceObjectErrorEnum.const_259:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_246:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_256:
               _loc4_ = "null";
               break;
            default:
               return;
