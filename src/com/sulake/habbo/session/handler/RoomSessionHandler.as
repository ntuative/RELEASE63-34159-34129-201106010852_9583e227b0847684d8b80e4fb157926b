package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1282:String = "RS_CONNECTED";
      
      public static const const_1284:String = "RS_READY";
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:int = var_26;
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1282);
         }
      }
      ...
      private function onFlatAccessible(param1:FlatAccessibleMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_61,_loc6_,_loc5_));
            }
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1284);
         }
      }
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_156,_loc6_,_loc5_));
            }
         }
      }
      ...
      private function onRoomQueueStatus(param1:RoomQueueStatusMessageEvent) : void
      {
         ...
         var _loc3_:IRoomSession = listener.getSession(_xxxRoomId,var_26);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onYouAreSpectator(param1:YouAreSpectatorMessageEvent) : void
      {
         ...
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_26);
         if(_loc2_ == null)
         {
            return;
         }
