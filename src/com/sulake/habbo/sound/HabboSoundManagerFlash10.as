package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1502:int = 16777215;
      ...
      private var var_926:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1202 = new Map();
         this.var_1490 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_809,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_982.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1217:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1789:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1352:
               ...
               case HabboSoundTypesEnum.const_1279:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1152:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1942:
            ...
            this.var_982.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_926;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_197.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_197.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_626.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1202.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_983.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_197.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2530 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_983 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_197 == null || this._connection == null || this._roomEngine == null || this.var_225 != null)
         {
            return;
         }
         this.var_225 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_225.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1889,this.var_778));
         this.var_778 = -1;
         this.var_779 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_926 * 100)));
         }
      }
      ...
      {
         this.var_926 = param1;
         this.var_225.updateVolume(this.var_926);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_626.getValue(param1) != null)
         {
            _loc2_ = this.var_626.remove(param1);
            if(this.var_257.getValue(_loc2_) == null)
            {
               this.var_1490.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1490,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1490,_loc2_,TraxSample.const_1946,TraxSample.const_1815);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1203.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1504 && this.var_1203.length > 0)
            {
               _loc3_ = this.var_1203.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_626.length == 0 && this.var_778 != -1)
            {
               this.var_779.ready = true;
               _loc4_ = this.var_778;
               this.var_778 = -1;
               this.var_779 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_809,_loc4_));
               if(this.var_2530)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_779 == null && this.var_1202.length > 0)
         {
            _loc1_ = this.var_1202.getKey(0);
            _loc2_ = this.var_1202.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_809,_loc1_));
               }
               else
               {
                  this.var_779 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_225.samplesIdsInUse;
         var _loc4_:int = 0;
         ...
         if(_loc1_ > const_1503)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1502 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               ...
               this.var_225.samplesUnloaded(_loc7_);
            }
         }
      }
