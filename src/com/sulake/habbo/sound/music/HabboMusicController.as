package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1487:int = HabboMusicPrioritiesEnum.const_118;
      ...
      private var var_522:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_803.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_803.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_803)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_905,this.onJukeboxInit);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_232,this.onJukeboxDispose);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_692,this.onSoundMachineInit);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_747,this.onSoundMachineDispose);
         this.var_1198 = new Timer(1000);
         this.var_1198.start();
         this.var_1198.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_268)
         {
            this.var_310[_loc6_] = null;
            this.var_776[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1836)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_419)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_134,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_803)
               {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_256.length)
               {
                  _loc3_ = this.var_256.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_905,this.onJukeboxInit);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_232,this.onJukeboxDispose);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_692,this.onSoundMachineInit);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_747,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_310[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_310[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_776[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_310.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_310[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_256.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_268)
         {
      ...
      {
         if(this.var_624.getValue(param1) == null)
         {
            this.var_624.add(param1,param2);
            this.var_775.push(param1);
         }
      }
      ...
      {
         return this.var_362.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_362.length)
         {
            return this.var_362.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_362.length)
         {
            return this.var_362.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_256.length)
         {
            ...
            if(_loc3_.id != this.var_1487 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_310[_loc2_] != null)
            {
               _loc3_ = this.var_310[_loc2_];
               _loc4_ = this.var_256.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_775));
         Logger.log("Requested song info\'s : " + this.var_775);
         this.var_775 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_256.add(_loc6_.id,_loc10_);
               ...
               this._events.dispatchEvent(new SongInfoReceivedEvent(SongInfoReceivedEvent.const_90,_loc6_.id));
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_268)
         {
            return false;
         }
         ...
         this.var_1836 = this.getSongRequestCountAtPriority(param1);
         this.var_1487 = param2;
         if(this._priorityPlaying <= const_1487)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_118)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_127,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2520 != param1.id || _loc3_ > this.var_2521 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2520 = param1.id;
            this.var_2521 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_624.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_362.add(_loc5_,_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_522 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_86,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_522 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
