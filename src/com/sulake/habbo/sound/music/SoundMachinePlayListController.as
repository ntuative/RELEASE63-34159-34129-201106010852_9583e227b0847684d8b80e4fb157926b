package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_225:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_225 = param2;
         this.var_803 = [];
         this.var_803.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_803.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_803)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_901,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomEngineSoundMachineEvent.const_1002,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_901,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomEngineSoundMachineEvent.const_1002,this.onSoundMachineStopEvent);
               this.var_86 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_468);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_225.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_468 = -1;
         this.var_681 = false;
         this.var_225.stop(HabboMusicPrioritiesEnum.const_118);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_225.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_225.playSong(param1,HabboMusicPrioritiesEnum.const_118,_loc3_,0,0,0))
         {
