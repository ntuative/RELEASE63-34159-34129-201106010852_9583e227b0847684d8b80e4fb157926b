package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1946:String = "sample_44khz";
      
      public static const const_1742:String = "sample_22khz";
      
      public static const const_1688:String = "sample_11khz";
      
      public static const const_1815:String = "sample_16bit";
      
      public static const const_1856:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1006:int = 32;
      
      private static const const_75:int = 255;
      
      private static const const_189:int = 65535;
      ...
      private var var_113:Vector.<int> = null;
      
      private var _id:int;
      
      private var var_156:int = 2;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_156 * this.var_76;
         var _loc7_:int = param1.length / 8;
         _loc7_ = int(_loc7_ / _loc6_) * _loc6_;
         this.var_113 = new Vector.<int>(_loc7_ / _loc6_,true);
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1006)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1006);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_156 == this.var_156 - 1)
            {
               this.var_113[int(_loc11_ / this.var_156)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_113.length * this.var_156 * this.var_76;
      }
      
      public function get usageCount() : int
      {
         return this.var_587.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_113 == null)
         {
            return param4;
         }
         var _loc5_:int = this.var_156 * this.var_76;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_113.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_113.length - param4)) * _loc5_;
            _loc6_ = this.var_113.length - param4;
         ...
         if(this.var_76 == 1)
         {
            if(this.var_156 == 2)
            {
               while(_loc6_-- > 0)
               {
                  _loc8_ = this.var_113[param4++];
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_189) - const_188;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_189) - const_188;
               }
            }
            else if(this.var_156 == 4)
            {
               while(_loc6_-- > 0)
               {
                  _loc8_ = this.var_113[param4++];
         ...
         else if(this.var_76 >= 2)
         {
            ...
            if(this.var_156 == 2)
            {
               ...
               {
                  _loc8_ = this.var_113[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_189) - const_188);
                  _loc9_ = this.var_76;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_189) - const_188);
                  _loc9_ = this.var_76;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_76 == 1)
         {
            if(this.var_156 == 2)
            {
               while(_loc6_-- > 0)
               {
                  _loc7_ = this.var_113[param4++];
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_189) - const_188);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_189) - const_188);
               }
            }
            else if(this.var_156 == 4)
            {
         ...
         else if(this.var_76 >= 2)
         {
            ...
            if(this.var_156 == 2)
            {
               ...
               {
                  _loc7_ = this.var_113[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_189) - const_188);
                  _loc8_ = this.var_76;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_189) - const_188);
                  _loc8_ = this.var_76;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_587.indexOf(param1) == -1)
         {
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_587.indexOf(param1) != -1;
      }
   }
}
