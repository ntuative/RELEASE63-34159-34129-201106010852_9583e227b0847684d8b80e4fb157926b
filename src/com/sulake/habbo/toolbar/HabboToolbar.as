package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_736:ToolbarExtension;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_249.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_249 && this._windowManager && this._config)
         {
            this.var_249.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_736 = new ToolbarExtension(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_736.showRoomInfo();
         }
         else
         {
            this.var_736.hideRoomInfo();
         }
      }
