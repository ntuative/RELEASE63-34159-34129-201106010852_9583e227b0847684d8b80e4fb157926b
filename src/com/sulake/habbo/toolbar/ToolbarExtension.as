package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1541:uint = 12247545;
      
      private static const const_1539:String = "HELP";
      
      private static const const_1540:String = "ROOMINFO";
      ...
      private var var_386:IWindow;
      
      private var var_655:IWindowContainer;
      
      private const const_731:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_386 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_60.removeListItem(this.var_386);
      }
      
      public function showRoomInfo() : void
      {
         this.var_60.addListItemAt(this.var_386,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_908;
         _loc3_.y = this.const_731;
         return _loc3_;
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1539);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1540);
               break;
            case "confirm":
               if(false)
               {
