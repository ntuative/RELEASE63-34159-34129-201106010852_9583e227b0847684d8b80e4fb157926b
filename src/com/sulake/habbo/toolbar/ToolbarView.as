package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1412:Point = new Point(3,3);
      
      private static const const_1413:uint = 7433577;
      
      private static const const_1414:uint = 5723213;
      
      private static const const_450:String = "_hover";
      
      private static const const_451:String = "_normal";
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         var _loc8_:XmlAsset = param3.getAssetByName(!!this.isStandaloneAchievementListEnabled() ? "toolbar_view_with_achievements_xml" : "toolbar_view_xml") as XmlAsset;
         this._window = param2.buildFromXML(_loc8_.content as XML,2) as IWindowContainer;
         if(this._window == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         this._window.position = const_1412;
         ...
         {
            this.setIconHoverState(_loc11_,const_451);
         }
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_877:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_725:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_450);
               this.setIconBgHoverState(_loc3_,const_450);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_451);
               this.setIconBgHoverState(_loc3_,const_451);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_450 ? this.var_1431 : this.var_1430;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_450)
         {
            param1.color = const_1413;
         }
         else
         {
            param1.color = const_1414;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1430)
         {
            this.var_1430.dispose();
         }
         this.var_1430 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1431)
         {
            this.var_1431.dispose();
         }
         this.var_1431 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_934.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1034;
            _loc2_.y = const_1034;
