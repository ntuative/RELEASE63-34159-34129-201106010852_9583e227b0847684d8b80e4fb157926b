package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1116:uint = 11;
      ...
      private var var_218:IHabboFriendList;
      
      private var var_1346:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_195:IHabboHelp;
      
      private var var_1627:Array;
      
      private var _crashed:Boolean = false;
      
      private var var_285:PerformanceTracker = null;
      
      private var var_478:FramerateTracker = null;
      
      private var var_286:LatencyTracker = null;
      
      private var var_697:LagWarningLogger = null;
      
      private var var_477:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_285 = new PerformanceTracker();
         this.var_478 = new FramerateTracker();
         this.var_286 = new LatencyTracker();
         this.var_697 = new LagWarningLogger();
         this.var_477 = new ToolbarClickTracker(this);
         this.var_1627 = new Array(const_1116);
         var _loc4_:int = 0;
         while(_loc4_ < const_1116)
         {
            this.var_1627[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1898,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1659,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1834,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_839,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1338,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1346)
            {
               this.var_1346.release(new IIDHabboWindowManager());
               this.var_1346 = null;
            }
            if(this.var_301)
            {
            ...
            if(this.var_218)
            {
               ...
               {
                  Component(this.var_218).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_218).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_218).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_218).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_218).events.removeEventListener(HabboFriendListTrackingEvent.const_595,this.onFriendlistTrackingEvent);
               }
               this.var_218.release(new IIDHabboFriendList());
               this.var_218 = null;
            }
            if(this.var_195)
            {
               if(!this.var_195.disposed)
               {
                  this.var_195.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_195.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_195.release(new IIDHabboHelp());
               this.var_195 = null;
            }
            if(this._toolbar)
            {
               ...
               {
                  this._toolbar.events.removeEventListener(HabboToolbarEvent.const_50,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_206,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_350,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_359,this.onRoomAction);
               }
            ...
            {
               this.var_331.stop();
               this.var_331.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_331 = null;
            }
      ...
      {
         this.var_1627[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_197 = IHabboConfigurationManager(param2);
         if(this.var_197)
         {
            if(this.var_286 != null)
            {
               this.var_286.configuration = this.var_197;
            }
            if(this.var_285 != null)
            {
               this.var_285.configuration = this.var_197;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1818);
            if(this.var_197)
            {
               if(this.var_697 != null)
               {
                  this.var_697.configure(this.var_197);
               }
               if(this.var_478 != null)
               {
                  this.var_478.configure(this.var_197);
               }
               if(this.var_477 != null)
               {
                  this.var_477.configure(this.var_197);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_180);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_743,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_207,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_247,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_700,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_73,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_555,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_285 != null)
            {
               this.var_285.connection = param1;
            }
            if(this.var_286 != null)
            {
               this.var_286.communication = this._communication;
               this.var_286.connection = param1;
            }
            if(this.var_697 != null)
            {
               this.var_697.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_700)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1907);
         }
         else if(param1.type == HabboHotelViewEvent.const_555)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1873);
         }
         else if(param1.type == HabboHotelViewEvent.const_73)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1750);
               break;
            case HabboCommunicationEvent.const_743:
               this.trackLoginStep(HabboLoginTrackingStep.const_1788,String(this._communication.port));
               break;
      ...
      {
         this.var_1346 = IHabboWindowManager(param2);
         if(this.var_1346)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_197)
            {
               if(this.var_197.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_197.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1627)
                  {
                  ...
                  if(this.var_285 != null)
                  {
                     _loc4_["null"] = this.var_285.flashVersion;
                     _loc4_["null"] = this.var_285.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1335);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1335,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_218 = param2 as IHabboFriendList;
         Component(this.var_218).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_218).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_218).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_218).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_218).events.addEventListener(HabboFriendListTrackingEvent.const_595,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_595:
      ...
      {
         this.var_195 = param2 as IHabboHelp;
         this.var_195.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_195.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2929)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1704);
            this.var_2929 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1338,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_839,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_206,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_350,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_359,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_301 = param2 as IAdManager;
         this.var_301.events.addEventListener(AdEvent.const_567,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._toolbar = param2 as IHabboToolbar;
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_50,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_350)
         {
            if(this.var_2103 < 1)
            {
               if(!this.var_331)
               {
                  this.var_331 = new Timer(60000,1);
                  this.var_331.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_331.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_359)
         {
            if(this.var_331)
            {
               this.var_331.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_478)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_478.frameRate),_loc2_);
                  ++this.var_2103;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_477)
         {
            this.var_477.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_477)
         {
            this.var_477.track(param1.type);
         }
      }
      ...
      {
         if(this.var_197 != null && !Boolean(this.var_197.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_697.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_571 > -1 && _loc2_ < this.var_571)
         {
            ++this.var_2101;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2101);
         }
         if(this.var_571 > -1 && _loc2_ - this.var_571 > 15000)
         {
            ++this.var_2102;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2102);
         }
         this.var_571 = _loc2_;
         if(this.var_285 != null)
         {
            this.var_285.update(param1,this.var_571);
         }
         if(this.var_286 != null)
         {
            this.var_286.update(param1,this.var_571);
         }
         if(this.var_478 != null)
         {
            this.var_478.trackUpdate(param1,this,this.var_571);
         }
         if(this.var_697 != null)
         {
            this.var_697.update(this.var_571);
         }
      }
   }
}
