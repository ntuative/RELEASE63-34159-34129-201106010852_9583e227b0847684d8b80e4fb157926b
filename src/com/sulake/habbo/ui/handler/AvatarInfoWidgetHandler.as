package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_778);
      ...
      {
         return [RoomSessionUserDataUpdateEvent.const_122];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_778:
               this.dispatchOwnAvatarInfo();
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_122:
