package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_435:Map = null;
      
      private var var_309:Map = null;
      
      private var var_623:Map = null;
      
      private var var_1835:Map = null;
      
      private var var_1196:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1197:Number = 0.0;
      
      private var var_773:Point = null;
      ...
      public function ChatWidgetHandler()
      {
         ...
         super();
         this.var_435 = new Map();
         this.var_309 = new Map();
         this.var_623 = new Map();
         this.var_1835 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_435.length)
            {
               _loc2_ = this.var_435.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_309 != null)
         {
            ...
            {
               _loc2_ = this.var_309.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1196)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_848,RoomWidgetChatSelectAvatarMessage.const_797];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_848:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_37) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1351))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_37) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1351))
                              {
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_129:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_147:
                           this._container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_797:
      ...
      {
         return [RoomSessionChatEvent.const_199];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_199:
               _loc3_ = param1 as RoomSessionChatEvent;
               if(_loc3_ != null)
               {
                  _loc4_ = this._container.roomEngine.getRoomObject(_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.userId,RoomObjectCategoryEnum.const_32);
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_191)
                           {
                              _loc13_ = this.var_309.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_435.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_623.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_191:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_52);
                                          _loc18_ = _loc17_.getPartColor("ch");
                                          _loc17_.dispose();
                                          if(_loc18_ != null)
                                          {
                                             _loc12_ = uint(_loc18_.rgb);
                                             this.var_623.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_191)
                                    {
                                       this.var_309.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_435.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
                        ...
                        _loc14_ = "null";
                        _loc2_ = new RoomWidgetChatUpdateEvent(_loc14_,_loc3_.userId,_loc3_.text,_loc11_,RoomObjectCategoryEnum.const_32,_loc6_,_loc7_,_loc13_,_loc12_,_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.chatType,_loc3_.links);
                     }
                  }
               }
         }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1197 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1197);
            }
            if(this.var_773 == null)
            {
               ...
               this.var_521.y = 0;
               this.var_521.z = 0;
               this.var_773 = _loc4_.getScreenPoint(this.var_521);
               this.var_1197 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_521.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_773.x || _loc8_.y != this.var_773.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_773,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_309)
         {
            _loc2_ = this.var_309.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1196.push(_loc2_);
            }
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_435)
         {
            _loc2_ = this.var_435.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1196.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_623.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1835.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1835.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_309)
            {
               this.var_309.add(_loc3_,param2);
            }
         }
      }
   }
