package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_966);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_987);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_696);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_966:
               ...
               if(_loc4_)
               {
                  _loc5_ = this._container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_32,this._container.getFirstCanvasId());
                  _loc6_ = this._container.roomEngine.getRoomObjectScreenLocation(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_32,this._container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_987:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_696:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_150);
         _loc1_.push(FriendRequestEvent.const_61);
         _loc1_.push(FriendRequestEvent.const_353);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_150:
            ...
            case FriendRequestEvent.const_353:
