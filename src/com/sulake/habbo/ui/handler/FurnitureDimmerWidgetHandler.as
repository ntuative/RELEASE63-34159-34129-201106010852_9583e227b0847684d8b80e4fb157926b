package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_590;
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_970,RoomWidgetDimmerSavePresetMessage.const_702,RoomWidgetDimmerChangeStateMessage.const_713,RoomWidgetDimmerPreviewMessage.const_863];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_970:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_702:
               if(this.validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_713:
               if(this.validateRights())
               {
                  this._container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_863:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_505);
         _loc1_.push(RoomEngineDimmerStateEvent.const_65);
         _loc1_.push(RoomEngineObjectEvent.const_112);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_505:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_935);
            ...
            case RoomEngineObjectEvent.const_112:
               this._container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_810));
         }
      }
