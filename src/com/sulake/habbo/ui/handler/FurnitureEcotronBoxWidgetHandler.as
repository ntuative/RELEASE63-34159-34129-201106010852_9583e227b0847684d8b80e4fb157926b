package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_949,RoomWidgetEcotronBoxOpenMessage.const_893,RoomWidgetEcotronBoxOpenedMessage.const_1851];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_949:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_893:
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_95,0,this._name,false,param2);
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_314:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_95,0,this._name,false,_loc3_.data);
