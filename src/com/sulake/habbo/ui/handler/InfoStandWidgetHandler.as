package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_225.events.addEventListener(NowPlayingEvent.const_98,this.onNowPlayingChanged);
            this.var_225.events.addEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
         }
      }
      ...
      {
         return RoomWidgetEnum.const_541;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_176,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_181,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_176,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_181,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_646.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_646.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_225 != null)
         {
            this.var_225.events.removeEventListener(NowPlayingEvent.const_98,this.onNowPlayingChanged);
            this.var_225.events.removeEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
            this.var_225 = null;
         }
         this.var_1110 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_566);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_962);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_538);
         _loc1_.push(RoomWidgetUserActionMessage.const_516);
         _loc1_.push(RoomWidgetUserActionMessage.const_413);
         _loc1_.push(RoomWidgetUserActionMessage.const_556);
         _loc1_.push(RoomWidgetUserActionMessage.const_465);
         _loc1_.push(RoomWidgetUserActionMessage.const_482);
         _loc1_.push(RoomWidgetUserActionMessage.const_576);
         _loc1_.push(RoomWidgetUserActionMessage.const_903);
         _loc1_.push(RoomWidgetFurniActionMessage.const_286);
         _loc1_.push(RoomWidgetFurniActionMessage.const_828);
         _loc1_.push(RoomWidgetFurniActionMessage.const_803);
         _loc1_.push(RoomWidgetFurniActionMessage.const_898);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1189);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_695);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_756);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_826);
         _loc1_.push(RoomWidgetUserActionMessage.const_624);
         _loc1_.push(RoomWidgetUserActionMessage.const_602);
         _loc1_.push(RoomWidgetUserActionMessage.const_564);
         _loc1_.push(RoomWidgetUserActionMessage.const_1696);
         _loc1_.push(RoomWidgetPetCommandMessage.const_573);
         _loc1_.push(RoomWidgetPetCommandMessage.const_875);
         _loc1_.push(RoomWidgetUserActionMessage.const_577);
         _loc1_.push(RoomWidgetUserActionMessage.const_390);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_967);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_624)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_390 || param1.type == RoomWidgetUserActionMessage.const_577 || param1.type == RoomWidgetUserActionMessage.const_564)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_566:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_962:
            ...
            case RoomWidgetUserActionMessage.const_463:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1166,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_538:
               this._container.sessionDataManager.ignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_516:
               this._container.sessionDataManager.unignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_413:
               this._container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_556:
               this._container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_465:
            ...
            case RoomWidgetUserActionMessage.const_482:
               ...
               break;
            case RoomWidgetUserActionMessage.const_576:
               ...
               break;
            case RoomWidgetUserActionMessage.const_903:
            ...
            case RoomWidgetFurniActionMessage.const_803:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_898:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_1189:
               ...
               break;
            case RoomWidgetUserActionMessage.const_390:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_695:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_756:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_826:
               ...
               break;
            case RoomWidgetUserActionMessage.const_624:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_284);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_361);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_373) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_373);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_862) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1304;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_284);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1302);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1141);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_546)
                  {
                     _loc30_ = this.var_225.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_414) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_414.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_225.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_191)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_132)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_610)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_522);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_108)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_137)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_815);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_727;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_796;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1805);
               }
               else
               {
               ...
               _loc19_ = _loc12_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_58,_loc19_);
               if(_loc20_ != null)
               {
                  _loc20_.setDirection(AvatarSetType.const_43,4);
                  _loc14_.image = _loc20_.getImage(AvatarSetType.const_43,true);
                  _loc20_.dispose();
               }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_158];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_158:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_43,4);
               _loc4_ = _loc5_.getImage(AvatarSetType.const_43,true);
               _loc5_.dispose();
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_646.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_646.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = this._container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_32);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_815);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc4_ != null)
            {
               _loc2_ = _loc4_.getCroppedImage(AvatarSetType.const_43);
               _loc4_.dispose();
            }
         }
         else
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_225 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_225.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_420,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_225 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_398,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
