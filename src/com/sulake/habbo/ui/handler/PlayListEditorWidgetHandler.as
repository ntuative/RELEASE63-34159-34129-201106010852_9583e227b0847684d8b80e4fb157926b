package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1395:IMessageEvent;
      
      private var var_1666:IMessageEvent;
      
      private var var_1667:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_153,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_98,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_127,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_134,this.processSoundManagerEvent);
         }
      }
      
      public function set connection(param1:IConnection) : void
      {
         this.var_1395 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1666 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1667 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1395);
         this._connection.addMessageEvent(this.var_1666);
         this._connection.addMessageEvent(this.var_1667);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1395);
               this._connection.removeMessageEvent(this.var_1666);
               this._connection.removeMessageEvent(this.var_1667);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_153,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_98,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_127,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_134,this.processSoundManagerEvent);
                  }
               }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_932,RoomWidgetPlayListModificationMessage.const_787,RoomWidgetPlayListModificationMessage.const_913,RoomWidgetPlayListPlayStateMessage.const_807,RoomWidgetPlayListUserActionMessage.const_836];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_932:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_709,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_787:
            ...
            case RoomWidgetPlayListModificationMessage.const_913:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_807:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_836:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_232);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_232:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_969,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_927,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_819));
               break;
            case PlayListStatusEvent.const_101:
               ...
               break;
            case PlayListStatusEvent.const_153:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_153));
               break;
            case NowPlayingEvent.const_98:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_98,_loc2_.id,_loc2_.position,_loc2_.priority));
               break;
            case NowPlayingEvent.const_127:
               ...
               break;
            case NowPlayingEvent.const_134:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_134,_loc2_.id,_loc2_.position,_loc2_.priority));
         }
      }
   }
}
