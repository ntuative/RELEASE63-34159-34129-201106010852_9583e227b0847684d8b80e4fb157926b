package com.sulake.habbo.ui.handler
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_557,RoomWidgetPollMessage.const_758];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_758:
               this._container.roomSession.sendPollStartMessage(_loc2_.id);
               break;
            case RoomWidgetPollMessage.const_557:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionPollEvent.const_167);
         _loc1_.push(RoomSessionPollEvent.const_73);
         _loc1_.push(RoomSessionPollEvent.const_143);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_167:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_167);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_73:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_73);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_143:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_143);
