   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this._container.catalog.events.removeEventListener(PurseEvent.const_109,this.purseEventHandler);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.catalog)
         {
            ...
            this._container.catalog.events.addEventListener(PurseEvent.const_109,this.purseEventHandler);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_919);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_919:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_109,_loc2_.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
               break;
               ...
               if(this._container.catalog != null)
               {
                  switch(_loc3_.pageKey)
                  {
                     case RoomWidgetOpenCatalogMessage.const_1333:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1676);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1353:
      ...
      private function purseEventHandler(param1:PurseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case PurseEvent.const_74:
               ...
               break;
            case PurseEvent.const_109:
               _loc2_ = new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_109,param1.balance);
         }
         if(_loc2_)
         {
