package com.sulake.habbo.ui.handler
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetVoteMessage.const_124];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetVoteMessage.const_124:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionVoteEvent.const_161);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_161:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_161,_loc2_.question,_loc2_.choices);
               break;
