package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_596;
      }
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_803 = [];
         this.var_803.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_803.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_803)
         {
            return;
         }
         for each(_loc1_ in this.var_803)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_880);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_878);
         return _loc1_;
      }
