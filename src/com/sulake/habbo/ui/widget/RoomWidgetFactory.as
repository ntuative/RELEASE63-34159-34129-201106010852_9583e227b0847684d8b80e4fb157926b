package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2989:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2989 = param1.root.assets;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_64)
         {
            this.var_64.release(new IIDHabboLocalizationManager());
            this.var_64 = null;
         }
         if(this.var_148)
         {
      ...
      {
         this.var_64 = param2 as IHabboLocalizationManager;
      }
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_400:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_64,this.var_148,this.var_2658++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_435:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_64,this.var_148,this);
               break;
            case RoomWidgetEnum.const_541:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_64,this.var_148,this._catalog);
               break;
            case RoomWidgetEnum.const_558:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_64,events,this.var_148);
               break;
            case RoomWidgetEnum.const_763:
               _loc3_ = new PlaceholderWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_498:
               _loc3_ = new CreditFurniWidget(param2,this._windowManager,assets,this.var_64);
               break;
            ...
            case RoomWidgetEnum.const_591:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_64,this.var_148,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_611:
               _loc3_ = new PetPackageFurniWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_125:
               _loc3_ = new DoorbellWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_621:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_64,this.var_148);
               break;
            case RoomWidgetEnum.const_996:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_64,this.var_148);
               break;
            case RoomWidgetEnum.const_124:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_64,this.var_148);
               break;
            case RoomWidgetEnum.const_432:
               _loc3_ = new PollWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_351:
               _loc3_ = new UserChooserWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_487:
               _loc3_ = new FurniChooserWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_590:
               _loc3_ = new DimmerFurniWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_150:
               _loc3_ = new FriendRequestWidget(param2,this._windowManager,assets,this.var_64,this);
               break;
            case RoomWidgetEnum.const_520:
               _loc3_ = new ClothingChangeFurnitureWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_752:
               _loc3_ = new RoomWidgetBase(param2,this._windowManager);
               break;
            case RoomWidgetEnum.const_126:
               _loc3_ = new UserNotificationWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_411:
               _loc3_ = new PurseWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_130:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_148,this.var_64,this);
               break;
            case RoomWidgetEnum.const_596:
               _loc3_ = new WelcomeGiftWidget(param2,this._windowManager,assets,this.var_64);
               break;
            case RoomWidgetEnum.const_518:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_64,this.var_148,this._catalog);
               break;
