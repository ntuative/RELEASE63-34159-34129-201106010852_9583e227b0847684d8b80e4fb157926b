package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1369:uint = 4281149991;
      
      protected static const const_1365:uint = 4283715916;
      
      protected static const const_1370:uint = 16777215;
      
      protected static const const_1367:uint = 9552639;
      
      protected static const const_1366:uint = 16777215;
      
      protected static const const_1368:uint = 5789011;
      
      private static const const_1432:int = 25;
      ...
      protected var var_2247:int;
      
      protected var var_1365:Boolean;
      
      protected var var_2181:FixedSizeStack;
      
      protected var var_2182:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_485:Timer;
      
      protected var var_2955:int = 3000;
      
      protected var var_1639:Boolean;
      
      protected var var_1641:Boolean;
      
      protected var _blend:Number;
      
      protected var var_1642:int;
      
      protected var var_2954:int = 500;
      
      protected var var_1102:Boolean;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2181 = new FixedSizeStack(const_1432);
         super();
         this._widget = param1;
         this.var_1102 = true;
         this.var_1639 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1640 = param5;
         param1.var_2247 = param4;
         param1.var_2180 = param6;
         param1.var_1639 = false;
         param1.var_2954 = 500;
         param1.var_1641 = false;
         param1._blend = 1;
         if(param1.var_1102)
         {
            if(!param1.var_485)
            {
               param1.var_485 = new Timer(param1.var_2955,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_612));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1641)
         {
            ...
            this._blend = 1 - this.var_1642 / Number(this.var_2954);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1365)
         {
            ...
            if(this.var_1640 == RoomObjectTypeEnum.const_132 || this.var_1640 == RoomObjectTypeEnum.const_610)
            {
            ...
            this.var_2181.addValue(_loc5_);
            _loc6_ = this.var_2181.getMax();
            if(_loc6_ < this.var_2182 - const_1040)
            {
               _loc6_ = this.var_2182 - const_1040;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2182 = _loc6_;
