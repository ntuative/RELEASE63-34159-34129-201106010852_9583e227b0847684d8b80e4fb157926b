package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1039:String = "use_minimized_own_avatar_menu";
      ...
      private var var_228:AvatarInfoData;
      ...
      private var var_762:AvatarInfoView;
      
      private var var_760:OwnAvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_197 = param4;
         this.var_228 = new AvatarInfoData();
         this.var_2470 = Boolean(this.var_197.getBoolean("menu.avatar.enabled",false));
         this.var_1805 = this.var_197.getBoolean("menu.own_avatar.enabled",false);
         this.var_356 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_282,this.onRoomObjectAdded);
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_427,this.onRoomObjectRemoved);
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_1342 as AvatarInfoWidgetHandler;
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_282,this.onRoomObjectAdded);
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_427,this.onRoomObjectRemoved);
         this._view = null;
         this.var_197 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_361,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_175,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_94,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_384,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_615,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_785,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_361,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_175,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_94,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_384,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_615,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_130:
               ...
               if(this.var_1805 && _loc2_.allowNameChange)
               {
               ...
               this.var_198 = true;
               break;
            case RoomWidgetRoomObjectNameEvent.const_615:
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_361:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_785:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1804 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_962,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_406:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1804)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_137:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_132,false,!!_loc3_.isSpectatorMode ? null : this.var_228);
               break;
            ...
            case RoomWidgetUserDataUpdateEvent.const_122:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_175:
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_94:
               this.var_1751 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_384:
               this.var_1751 = true;
         }
      ...
      private function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_341,_loc2_.id,RoomObjectCategoryEnum.const_32);
      ...
      {
         this.var_228.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_228.amIController = param1.amIController;
         this.var_228.amIOwner = param1.amIOwner;
         this.var_228.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_228.canBeKicked = param1.canBeKicked;
         this.var_228.canTrade = param1.canTrade;
         this.var_228.canTradeReason = param1.canTradeReason;
         this.var_228.hasFlatControl = param1.hasFlatControl;
         this.var_228.isIgnored = param1.isIgnored;
         this.var_228.respectLeft = param1.respectLeft;
         this.var_228.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_108;
         this.var_228.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1805) : Boolean(this.var_2470);
         }
            ...
            if(!this.var_1751)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_760)
                     {
                        this.var_760 = new OwnAvatarMenuView(this);
                     }
               ...
               else
               {
                  if(!this.var_762)
                  {
                     this.var_762 = new AvatarInfoView(this);
                  }
      ...
      {
         return this.handler.container.config.getBoolean(const_1039,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1039,!!param1 ? "1" : "0");
      }
   }
}
