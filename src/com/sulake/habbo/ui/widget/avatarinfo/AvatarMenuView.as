package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1372:uint = 0;
      
      protected static const const_363:uint = 1;
      
      protected static const const_1004:uint = 2;
      
      protected static var var_1381:uint = const_363;
      
      private static const const_1552:uint = 16744755;
      
      private static const const_1551:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_338:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1374)
         {
            ...
            {
               this.var_338 = const_1004;
            }
            else
            {
               this.var_338 = var_1381;
            }
         }
         if(this.var_338 == const_1372)
         {
         ...
         if(this.var_338 == const_1372 || this.var_338 == const_363)
         {
            ...
            else
            {
               ...
               this.var_338 = const_363;
            }
         }
         if(this.var_338 == const_363)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1551;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1552;
               }
            }
         }
         if(_loc3_)
