package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1405:int = 250;
      
      private static const const_1406:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1404:String = "${widgets.chatinput.say}";
      ...
      private var var_1719:IWindow;
      
      private var _button:IWindow;
      
      private var var_1720:IWindow;
      
      private var var_1415:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1144 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2320 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2319 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_350 = new Timer(1000,1);
         this.var_350.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_350.reset();
            this.var_350.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_350 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1719 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1720 = this._window.findChildByName("send_button_text");
         this.var_1415 = this._window.findChildByName("block_text");
         this.var_1720.caption = const_1404;
         this.var_25.setParamFlag(HabboWindowParam.const_46,true);
         this.var_25.addEventListener(WindowMouseEvent.const_44,this.windowMouseEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_346,this.keyUpHandler);
         this.var_25.addEventListener(WindowEvent.const_113,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1414 = true;
         this.var_600 = "";
         this._window.addEventListener(WindowEvent.const_899,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_549,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1719.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1405 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1406);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_25 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1144 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_25.text = "";
                  this.var_600 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_600.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_599);
