package com.sulake.habbo.ui.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1637:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_988,this.onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_156,this.onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_988,this.onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_156,this.onDoorbellHandled);
      ...
      public function addUser(param1:String) : void
      {
         ...
         if(this._users.length >= const_1637)
         {
            this.deny(param1);
            return;
         }
