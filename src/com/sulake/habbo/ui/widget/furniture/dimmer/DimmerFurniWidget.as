package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1605:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1604:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_935,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_810,this.onHide);
         param1.addEventListener(RoomWidgetDimmerStateUpdateEvent.const_65,this.onDimmerState);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_935,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_810,this.onHide);
         param1.removeEventListener(RoomWidgetDimmerStateUpdateEvent.const_65,this.onDimmerState);
      }
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_1320 = param1.selectedPresetId - 1;
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2202 = param1.presetId;
         this.var_1322 = param1.effectId;
         this._color = param1.color;
         this.var_1321 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_1321,this.var_1322))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1321,this.var_1322 == 2);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.var_1320 + 1;
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_1320] as DimmerFurniWidgetPresetItem;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1321,this.var_1322 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
