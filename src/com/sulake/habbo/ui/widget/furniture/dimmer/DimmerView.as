package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1396:Number = 100;
      ...
      private var var_1413:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_598:DimmerViewColorGrid;
      
      private var var_426:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1396,const_1395,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_598 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_426 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_275 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_275.numTabItems)
         {
            _loc6_ = this.var_275.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1412 = _loc2_.light;
         if(this.var_426 != null)
         {
            this.var_426.setValue(this.var_1412);
         }
         this.var_502 = this.colors.indexOf(_loc2_.color);
         if(this.var_598 != null)
         {
            this.var_598.setSelectedColorIndex(this.var_502);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_275.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_275.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_275.selector.getSelected();
         return this.var_275.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1413 = XML(_loc1_.content);
         return this.var_1413;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_426 != null)
         {
            this.var_426.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_598 != null)
         {
            this.var_598.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
