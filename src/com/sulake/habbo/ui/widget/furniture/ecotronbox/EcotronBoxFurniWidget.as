package com.sulake.habbo.ui.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_95,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_95,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_70:
               ...
               this.showInterface();
               break;
            case RoomWidgetEcotronBoxDataUpdateEvent.const_95:
               if(!this.var_379)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1396,const_1395,2,2),null,0) as IWindowContainer;
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_893,this.var_221);
