package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_644:String = "welcome_gift_email_unverified";
      
      private const const_1036:String = "welcome_gift_email_verified";
      
      private const const_1423:String = "welcome_gift_email_change";
      
      private const const_2253:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1165)
         {
            this.setViewState(this.const_1036);
         }
         else
         {
            this.setViewState(this.const_644);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_644:
               ...
               this._view.findChildByName("edit_text").visible = this.var_943;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_943);
               break;
            case this.const_1036:
            ...
            case this.const_1423:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_943);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1445;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1423);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_880,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1165 ? this.const_1036 : this.const_644);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1446 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1446));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_478,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_811,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_478,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_811,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_478:
               this.var_1445 = param1.email;
               this.var_1165 = param1.isVerified;
               this.var_943 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1445 = this.var_1446;
            this.setViewState(this.const_644);
         }
         else
         {
            if(param1.result == this.const_2253)
            {
               this.var_943 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1446);
