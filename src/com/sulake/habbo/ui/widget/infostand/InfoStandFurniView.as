package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_45:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_247 = this.var_45.findChildByTag("catalog");
         if(this.var_247 != null)
         {
            this.var_247.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc2_ = new RoomWidgetFurniActionMessage(_loc3_,_loc6_,_loc7_,null);
      ...
      {
         if(this.var_50 == null || this.var_45 == null || this._buttons == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_45.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_45.width < this._buttons.width)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1304 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_546 && param1.isRoomOwner)
         {
         ...
         if(this.var_50 != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_50.addListItem(_loc4_);
                  }
               }
            }
         }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1345.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function getVisibleAdFurnitureExtraParams() : String
      {
         ...
         {
            _loc2_ = [];
            this.var_45.groupChildrenWithTag("branding_element",_loc2_,true);
            if(_loc2_.length > 0)
            {
      ...
      private function showAdFurnitureDetails(param1:Boolean) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this._widget == null || this.var_45 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_45.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:* = [];
         this.var_45.groupChildrenWithTag("branding_element",_loc3_,true);
         if(_loc3_.length > 0)
         {
            for each(_loc8_ in _loc3_)
            {
               this.var_45.removeChild(_loc8_);
               _loc8_.dispose();
            }
         }
         var _loc4_:Boolean = false;
         var _loc5_:IWindow = this.var_45.findChildByName("furni_details_text") as ITextWindow;
         if(_loc5_ != null)
         {
            _loc5_.visible = param1;
            _loc5_.caption = "id: " + this._widget.furniData.id;
         }
         var _loc6_:Map = this.getAdFurnitureExtraParams();
         if(_loc6_.length > 0)
         {
            _loc4_ = true;
            for each(_loc9_ in _loc6_.getKeys())
            {
               _loc10_ = _loc6_.getValue(_loc9_);
               this.createAdElement(_loc9_,_loc10_);
            }
         }
         this.showButton("save_branding_configuration",false);
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_247);
            }
            this.var_247.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_247);
         }
      }
   }
}
