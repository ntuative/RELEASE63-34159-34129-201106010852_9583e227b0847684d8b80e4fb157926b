package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_45 != null)
         {
            var_50 = var_45.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var_247 = var_45.findChildByTag("catalog");
         if(var_247 != null)
         {
            var_247.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      {
         var _loc2_:IWindowContainer = var_50.getListItemByName("trackname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_50.getListItemByName("creatorname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_420)
         {
            this.var_1690 = param1.songId;
         }
         if(param1.songId == this.var_1690)
         {
            this._songName = param1.songName;
            this.var_2261 = param1.songAuthor;
            this.updateNowPlaying(this.var_1690 >= 0);
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:ITextWindow = var_50.getListItemByName("now_playing_text") as ITextWindow;
         if(_loc2_ != null)
         {
            if(param1)
            {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2261;
         }
         else
         {
