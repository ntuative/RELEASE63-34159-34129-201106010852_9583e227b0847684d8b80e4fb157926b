package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_2531 = param1.petRace;
         this.var_46 = param1.image;
         this.var_2272 = param1.isOwnPet;
         this.var_2278 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1231 = param1.level;
         this.var_2276 = param1.levelMax;
         this.var_2273 = param1.experience;
         this.var_2277 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2275 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2274 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2247 = param1.roomIndex;
