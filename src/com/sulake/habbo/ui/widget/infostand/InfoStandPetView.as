package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1488:int = 152;
      
      private static const const_1497:int = 16;
      
      private static const const_664:int = 4;
      
      private static const const_1496:uint = 14342874;
      
      private static const const_1495:uint = 3815994;
      
      private static const const_1490:uint = 2085362;
      
      private static const const_1500:uint = 39616;
      
      private static const const_1501:uint = 10513106;
      
      private static const const_1499:uint = 8734654;
      
      private static const const_1498:uint = 9094430;
      
      private static const const_1494:uint = 6200576;
      
      private static const const_1493:String = "happiness";
      
      private static const const_1492:String = "experience";
      
      private static const const_1489:String = "energy";
      
      private static const const_1491:int = 250;
      
      private static const const_1064:int = 25;
      ...
      private var var_101:IWindowContainer;
      
      private var var_50:IItemListWindow;
      
      private var var_206:PetCommandTool;
      ...
      {
         if(this.var_50 == null || this.var_45 == null || this.var_101 == null)
         {
            return;
         }
         this.var_101.width = this.var_101.width;
         this.var_101.visible = this.var_101.width > 0;
         this.var_50.height = this.var_50.scrollableRegion.height;
         this.var_45.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_45.width,this.var_101.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_45.width < this.var_101.width)
         {
         ...
         {
            this.var_101.x = this._window.width - this.var_101.width;
            this.var_45.x = 0;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1493,param1.nutrition,param1.nutritionMax,const_1500,const_1490);
         this.updateStateElement(const_1492,param1.experience,param1.experienceMax,const_1499,const_1501);
         this.updateStateElement(const_1489,param1.energy,param1.energyMax,const_1494,const_1498);
         ...
         this.updateWindow();
         this.var_528 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_206 && this.var_206.isVisible() && param1.isOwnPet)
         {
            this.var_206.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_206.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1488,const_1497,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1496);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1495);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_664,_loc7_.width - 2,_loc7_.height - 2 - const_664);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_664);
      ...
      private function openTrainView() : void
      {
         if(this.var_206 == null)
         {
            this.var_206 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_528) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_206.showWindow(true);
            this.var_206.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_45 != null)
         {
            this.var_50 = this.var_45.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_45.findChildByTag("close");
         if(_loc3_ != null)
         {
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClose);
         }
         this.var_101 = this._window.getListItemByName("button_list") as IWindowContainer;
         if(this.var_101 == null)
         {
            return;
         }
         var _loc4_:* = [];
         this.var_101.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
         for each(_loc5_ in _loc4_)
         {
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClicked);
         }
         _loc6_ = this.var_45.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_45.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_45.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_45.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         for each(_loc10_ in _loc4_)
         {
            ...
            _loc10_.addEventListener(WindowEvent.const_41,this.onButtonResized);
         }
      }
      ...
      private function setLevelText(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IWindowContainer = this.var_50.getListItemByName("level_container") as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function updateStateElement(param1:String, param2:int, param3:int, param4:uint, param5:uint) : void
      {
         ...
         var _loc6_:IWindowContainer = this.var_50.getListItemByName("status_container") as IWindowContainer;
         if(_loc6_ == null)
         {
            return;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_206 && this.var_206.getPetId() == this.var_528)
               {
                  this.var_206.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1958,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_413,this._widget.petData.ownerId);
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_101.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1491;
         this.var_101.width = _loc1_;
         var _loc2_:* = [];
         this.var_101.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1064 + const_1065;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1065;
            }
         }
         this.var_101.height = _loc4_ + const_1064;
         this.updateWindow();
      }
   }
}
