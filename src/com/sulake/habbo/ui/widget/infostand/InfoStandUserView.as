package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_101:IWindowContainer;
      
      private var var_45:IBorderWindow;
      
      private var var_1048:TagListRenderer;
      
      private var var_146:IBorderWindow;
      
      private var var_2793:int;
      
      private var var_2792:Boolean = true;
      
      private const const_1095:int = 5;
      
      private const const_2268:int = 3;
      
      private const const_1586:int = 11184810;
      
      private const const_1585:int = 16777215;
      
      private const const_2266:int = 2000;
      
      private const const_2267:int = 50;
      
      private const const_2265:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1048 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2792 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_101.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         var _loc9_:IWindowContainer = this.var_50.getListItemByName("motto_container") as IWindowContainer;
         if(_loc9_)
         {
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_146.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_146.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_146.x = _loc5_.left - this.var_146.width;
         this.var_146.y = _loc5_.top + (_loc5_.height - this.var_146.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_146.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_146.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_146.x = _loc7_.left - this.var_146.width;
         this.var_146.y = _loc7_.top + (_loc7_.height - this.var_146.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_146 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_146 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1095;
      ...
      {
         var _loc3_:IWindowContainer = this.var_50.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc3_)
         {
            return;
         }
         ...
         var _loc6_:IWindowContainer = this.var_50.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1586;
            }
            else
            {
               _loc5_.textColor = this.const_1585;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1095,this.const_2267);
         _loc5_.height = Math.max(_loc5_.height,this.const_2265);
         _loc3_.height = _loc5_.height + this.const_2268;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_346,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_346,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1048.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_108);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_101.getChildByName(param1) as IRegionWindow;
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_727:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_796:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:IWindowContainer = this.var_50.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2793 > this.const_2266 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2793 = _loc6_;
               _loc3_.textColor = this.const_1585;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1586;
         }
      }
