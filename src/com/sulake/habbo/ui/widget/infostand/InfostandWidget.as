package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1995:String = "infostand_user_view";
      
      private const const_2000:String = "infostand_furni_view";
      
      private const const_1997:String = "infostand_pet_view";
      
      private const const_1999:String = "infostand_bot_view";
      
      private const const_1996:String = "infostand_jukebox_view";
      
      private const const_1998:String = "infostand_songdisk_view";
      
      private var var_1195:InfoStandFurniView;
      ...
      private var var_973:InfoStandJukeboxView;
      
      private var var_974:InfoStandSongDiskView;
      
      private var var_2513:Array;
      
      private var var_1485:InfostandUserData;
      
      private var var_689:InfostandFurniData;
      
      private var _petData:InfoStandPetData;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_163:Timer;
      
      private var _config:IHabboConfigurationManager;
      
      private var _catalog:IHabboCatalog;
      
      private const const_2255:int = 3000;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1195 = new InfoStandFurniView(this,this.const_2000,this._catalog);
         this.var_183 = new InfoStandUserView(this,this.const_1995);
         this.var_360 = new InfoStandPetView(this,this.const_1997,this._catalog);
         this.var_433 = new InfoStandBotView(this,this.const_1999);
         this.var_973 = new InfoStandJukeboxView(this,this.const_1996,this._catalog);
         this.var_974 = new InfoStandSongDiskView(this,this.const_1998,this._catalog);
         this.var_1485 = new InfostandUserData();
         this.var_689 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_163 = new Timer(this.const_2255);
         this.var_163.addEventListener(TimerEvent.TIMER,this.onUpdateTimer);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_724,this.onRoomObjectSelected);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_151,this.onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_175,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_690,this.onBadgeImage);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_398,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_724,this.onRoomObjectSelected);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_151,this.onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_175,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_690,this.onBadgeImage);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_398,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_390,this.var_360.getCurrentPetId()));
      }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1999);
         if(this.var_163)
         {
            this.var_163.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_546)
         {
         ...
         {
            this.var_1195.update(param1);
            this.selectView(this.const_2000);
         }
         if(this.var_163)
         {
            this.var_163.stop();
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_183.setTags(param1.tags,this.var_2513);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_566,param1.id,param1.category);
