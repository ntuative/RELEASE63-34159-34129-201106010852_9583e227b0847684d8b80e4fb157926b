package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1412:Point = new Point(100,30);
       
      
      private var _widget:InfostandWidget;
      
      private var var_39:IFrameWindow;
      
      private var var_436:IFrameWindow;
      ...
      private const const_2257:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_364 = new Timer(this.const_2257);
         this.var_364.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc4_:ITextWindow = this.var_39.findChildByName("pet_name") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.text = param2;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_39.findChildByName("avatar_image") as IBitmapWrapperWindow;
         if(_loc5_ != null)
         {
            if(param3 != null)
            {
         ...
         var _loc6_:CommandConfiguration = this.var_1210.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_528);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1210.getValue(this.var_528) as CommandConfiguration;
      ...
      {
         this.var_1210.remove(param1);
         this.var_1210.add(param1,param2);
         if(param1 != this.var_528)
         {
            return;
         }
      ...
      public function showWindow(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_39.visible = true;
         }
         else if(this.var_39 != null)
         {
            this.var_39.visible = false;
         }
         this.var_364.stop();
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_875,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_39 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this.var_39 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         this.var_39.setParamFlag(WindowParam.const_100,true);
         this.var_39.context.getDesktopWindow().addEventListener(WindowEvent.const_41,this.onWindowDesktopResized);
         this.var_39.procedure = this.onCommandWindowProcedure;
         this.var_39.position = const_1412;
      }
      ...
      private function updateCommandButtonsViewState(param1:CommandConfiguration) : void
      {
         ...
         var _loc2_:IWindowContainer = IWindowContainer(this.var_39.findChildByName("commands_container"));
         hideChildren(_loc2_);
         ...
         this.var_39.height = _loc2_.height + 160;
         this.var_364.stop();
      }
      ...
      private function disableAllButtons() : void
      {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_39.findChildByName("commands_container"));
         var _loc2_:int = 0;
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_436 == null)
         {
            ...
            this.var_436 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_436 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_436.x = 200;
            this.var_436.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_390,this.var_528));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_573,this.var_528,this.var_1855 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_573,this.var_528,this.var_1855 + " " + _loc5_);
      ...
      private function onWindowDesktopResized(param1:WindowEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_39 && !this.var_39.disposed)
         {
            _loc2_ = param1.window;
            _loc3_ = new Rectangle();
            this.var_39.getGlobalRectangle(_loc3_);
            if(_loc3_.x > _loc2_.width)
            {
               this.var_39.x = _loc2_.width - this.var_39.width;
               this.var_39.getGlobalRectangle(_loc3_);
            }
