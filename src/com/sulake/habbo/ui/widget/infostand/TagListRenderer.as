package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2283:int = 5;
      
      private const const_2284:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_157:Function;
      
      private var _offsetX:int;
      
      private var var_1327:int;
      
      private var var_1328:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1327 = 0;
         this.var_1328 = param2.rectangle.clone();
         this.var_1328.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1328.width)
         {
            return false;
         }
         if(this.var_1327 + param1.height > this.var_1328.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1328.width)
         {
            this._offsetX = 0;
            this.var_1327 += param1.height + this.const_2284;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1327);
         this._offsetX += param1.width + this.const_2283;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1597 != null && this.var_1597.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_157);
