package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2256:int = 1000;
      ...
      private var var_980:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_204 = new Timer(this.const_2256);
         this.var_204.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_204.stop();
            this.var_204.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_204 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_184.isActive)
         {
            ...
            this.var_979.width = _loc2_ * this.var_307;
         }
         else
         {
            this.var_979.width = 0;
            this.var_204.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_777 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_777 == null)
            {
               return;
            }
         ...
         if(!this.var_184.isActive)
         {
            this.var_777.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_777.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_777.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_980 = this._window.findChildByName("effect_hilite");
            this.var_980.visible = false;
         }
         this.setTimeLeft();
         this.var_979 = this._window.findChildByName("loader_bar");
         if(this.var_979 != null)
         {
            this.var_307 = this.var_979.width;
            this.var_204.start();
            this.onUpdate();
         }
