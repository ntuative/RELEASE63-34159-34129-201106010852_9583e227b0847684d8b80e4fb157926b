package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_977));
         }
         this._widget = null;
         if(this._window)
         {
            this._window.removeEventListener(WindowEvent.const_119,this.onViewChange);
            this._window.removeEventListener(WindowEvent.const_356,this.onViewChange);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_119,this.onViewChange);
         this._window.addEventListener(WindowEvent.const_356,this.onViewChange);
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_404,this._window));
      }
