package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_161["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_161["dance_icon"] = ["dance_white","dance_color"];
         this.var_161["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_161["effects_icon"] = ["effects_white","effects_color"];
         this.var_161["badges_icon"] = ["badges_white","badges_color"];
         this.var_161["wave_icon"] = ["wave_white","wave_color"];
         this.var_161["hc_icon"] = ["_white","_color"];
         this.var_161["settings_icon"] = ["settings_white","settings_color"];
         this.var_161["credits_icon"] = ["credits_white","credits_color"];
         this.var_161["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_161[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_161[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_161[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_161)
         {
            _loc6_ = this.var_161[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_45)
                        {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1350);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1140));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1287));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_360);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1288));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_794);
               break;
            case "news":
         ...
         HabboTracking.getInstance().trackConversionPoint("MeMenu","click",_loc3_);
      }
