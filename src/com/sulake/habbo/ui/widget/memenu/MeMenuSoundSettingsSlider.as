package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1949:MeMenuSoundSettingsView;
      ...
      {
         return param1 / this.var_1842 * (this.var_1316 - this._minValue) + this._minValue;
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1949.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_781 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_781.width,this.var_781.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_781,this.var_781.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1842 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
