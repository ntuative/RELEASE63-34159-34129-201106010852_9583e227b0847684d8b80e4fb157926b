package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1967:String = "button_ok";
      
      protected static const const_1968:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_2240:String = "widget_notification_frame";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_603)
            {
               while(this.var_603.length > 0)
               {
                  this.var_603.pop().dispose();
               }
               this.var_603 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_1968).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_1967).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_603.indexOf(param1);
            if(_loc2_ > -1)
            {
               this.var_603.splice(_loc2_,1);
            }
            param1.dispose();
         }
      }
