package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      private var var_102:PlayListEditorItem;
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_476);
            }
            return;
         }
         ...
         if(this.var_1280 >= 0 && this.var_1280 < this._items.length)
         {
            _loc2_ = this._items[this.var_1280] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_476);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1204);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            else
            {
               ...
               if(_loc4_ != -1)
               {
                  ...
                  this.var_102 = this._items[_loc4_];
                  this.var_102.select();
