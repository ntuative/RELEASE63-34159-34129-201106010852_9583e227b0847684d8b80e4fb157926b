package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_907:String = "PLSV_ADD_SONGS";
      
      public static const const_1262:String = "PLSV_START_PLAYBACK";
      
      public static const const_527:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_43 != const_527)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_452[this.var_43];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_452[const_907];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_452.add(const_527,_loc1_);
