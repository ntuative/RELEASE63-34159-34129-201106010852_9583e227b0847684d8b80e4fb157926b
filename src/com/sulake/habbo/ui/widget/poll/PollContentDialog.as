package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private var var_311:IFrameWindow;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1205;
         if(this.var_1205 < this.var_984.length)
         {
            _loc1_ = this.var_984[this.var_1205] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_984.length);
                  _loc2_.text = _loc6_;
               }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_56))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_984[this.var_1205] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_311)
         {
            ...
            this.var_311 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2) as IFrameWindow;
            this.var_311.center();
            _loc2_ = this.var_311.findChildByName("header_button_close");
            if(_loc2_ != null)
            {
               _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelPollClose);
            }
            _loc3_ = this.var_311.findChildByName("poll_cancel_confirm_button_ok");
            if(_loc3_ != null)
            {
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelPollOk);
            }
            _loc4_ = this.var_311.findChildByName("poll_cancel_confirm_button_cancel");
            if(_loc4_ != null)
            {
