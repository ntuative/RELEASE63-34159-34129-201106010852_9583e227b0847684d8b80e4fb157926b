package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1913:String = "POLL_OFFER_STATE_OK";
      
      public static const const_866:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_105:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_105)
         {
            return;
         }
         this._state = const_1913;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_758,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_557,this._id));
