package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1454:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1454 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_163.reset();
            this.var_163.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_163 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_161,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_138,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_161,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_138,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(this.var_60.scrollableRegion.height - this.var_60.height,0);
         ...
         {
            this.var_163 = new Timer(1000);
            this.var_163.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_60 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_60 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         if(this._window == null || this.var_60 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_60.numListItems)
         {
            _loc2_ = this.var_60.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_1807)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1454 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1808;
         if(_loc2_ > this.var_1454)
         {
            this.vote();
            return;
         }
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_60.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_60.numListItems)
         {
            _loc4_ = this.var_60.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
