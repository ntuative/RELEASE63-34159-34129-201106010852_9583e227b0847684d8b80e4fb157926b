package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_295:int = 0;
      
      public static const const_86:int = 39;
      
      private static const const_1091:int = 150;
      
      private static const const_1092:int = 250;
      ...
      private var var_2728:BitmapData;
      
      private var var_1978:BitmapData;
      
      private var var_2727:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2728 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1978 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2727 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1980 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1979 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2726 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2723 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_81 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_343,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_81);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_40.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_469,HabboWindowStyle.const_48,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_598:
               this.var_81.blend += param1 / const_1092;
               this._window.blend += param1 / const_1092;
               if(this._window.blend >= 1)
               {
                  this.state = const_431;
               }
               break;
            case const_1094:
               this.var_81.blend -= param1 / const_1091;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_431:
               if(this._state == const_295)
               {
                  this.state = const_598;
               }
               else
               {
                  if(this._window == null || this.var_81 == null)
                  {
                     return;
                  }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_40.height - const_86;
            this._window.width = this.var_40.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_40.height - const_86;
            this._region.width = this.var_40.width - this.var_2724;
         }
         if(this.var_81 != null)
         {
            this.var_81.rectangle = this.var_40.rectangle;
            this.var_81.height -= const_86;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2725 == this._window.width)
         {
            return;
         }
         this.var_2725 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2727;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1980;
            barX.disposesBitmap = false;
            this.var_2724 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2728,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1978,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1978,destGripRBitmap);
         ...
         this.var_81.bitmap = this.var_2723;
         this.var_81.disposesBitmap = false;
      }
