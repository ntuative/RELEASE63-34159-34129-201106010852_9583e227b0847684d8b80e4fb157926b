package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1159:int = 2;
      ...
      private var var_1449:Function;
      
      private var var_947:Function;
      ...
      {
         return this.visible && this._window.getStateFlag(WindowState.const_89);
      }
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_948)
            {
               this.var_948.addChild(this._window);
            }
