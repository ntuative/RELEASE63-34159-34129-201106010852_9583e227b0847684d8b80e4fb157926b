package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_449:uint = 3;
      
      private static const const_1407:uint = 1;
      ...
      private var var_924:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_251:Array;
      
      private var var_1419:IEventDispatcher;
      
      private var var_1145:Boolean = false;
      
      private var var_1721:ProfilerOutput;
      
      private var var_1417:ProfilerAgentTask;
      
      private var var_1418:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_924 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_449);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_449)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_924,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_284 = this._windowContextArray[const_1407];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1721)
            {
               this.var_1721 = new ProfilerOutput(context,this,this.var_924);
            }
            this.var_1721.profiler = _loc3_;
            this.var_1417 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1417);
            this.var_1418 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1418);
            this.var_1145 = true;
         }
      }
      ...
      {
         return this.var_284.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_284.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_251[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_251[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_284.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_406.length > 0)
         {
            this.var_1419.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_449 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1419.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_449)
         {
         ...
         if(WindowContext.var_406.length > 0)
         {
            WindowContext.var_406.flush();
         }
         MouseCursorControl.change();
         this.var_1419.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1677,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1672,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1753,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1845,param2.name + ": " + param2.toString());
            }
         }
      }
