package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1277:int = 2;
      
      public static const const_867:int = 3;
      ...
      private var var_54:IRoomContentLoader;
      ...
      private var var_157:IRoomManagerListener;
      
      private var var_3008:IRoomContentLoader;
      
      private var var_588:IRoomObjectFactory = null;
      
      private var var_493:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1121:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_589 = [];
         this.var_590 = [];
         events.addEventListener(RoomContentLoadedEvent.const_392,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_605,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_924,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_114.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_114.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_588 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_588 == null || this.var_493 == null)
         {
            return;
         }
         this._state = const_1698;
         if(this.var_1121 != null)
         {
            _loc1_ = this.var_1121;
            this.var_1121 = null;
            this.initialize(_loc1_,this.var_157);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         this.var_993 = 50;
         this.var_157 = param2;
         var _loc3_:Array = this.var_54.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(this.var_589.indexOf(_loc5_) < 0)
            {
               this.var_54.loadObjectContent(_loc5_,events);
               this.var_589.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1277;
         return true;
      }
      ...
      public function addObjectUpdateCategory(param1:int) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_114.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      {
         var _loc5_:int = 0;
         if(this._state < const_867)
         {
            throw new RoomManagerException();
         }
         if(this.var_114.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         this.var_114.add(String(param1),_loc3_);
      ...
      {
         return this.var_114.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_114.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!this.var_54.hasInternalContent(param3))
         {
            _loc7_ = this.var_54.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               this.var_54.loadObjectContent(param3,events);
               _loc12_ = this.var_54.getPlaceHolderType(param3);
               _loc7_ = this.var_54.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = this.var_54.getVisualizationXML(_loc12_);
            _loc9_ = this.var_54.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = this.var_54.getVisualizationType(_loc12_);
            _loc11_ = this.var_54.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_493.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_493.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_588.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_588 != null)
         {
            return this.var_588.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(this.var_54 != null)
         {
            if(this.var_54.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_808)
         {
            return;
         }
         if(this.var_54 == null)
         {
            this._state = const_808;
            return;
         }
         if(this.var_54.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_589.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_589.splice(_loc2_,1);
            }
            if(this.var_589.length == 0)
            {
               ...
               {
                  this.var_157.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_808;
            this.var_157.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_157 != null)
            {
               this.var_157.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_905.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_905.length > 0)
         {
            _loc2_ = this.var_905[0];
            this.var_905.splice(0,1);
            _loc3_ = this.var_54.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_157 != null)
               {
                  this.var_157.contentLoaded(_loc2_,false);
               }
               return;
            }
            _loc4_ = this.var_54.getGraphicAssetCollection(_loc2_);
            if(_loc4_ == null)
            {
               if(this.var_157 != null)
               {
            ...
            if(this.var_157 != null)
            {
               this.var_157.contentLoaded(_loc2_,true);
            }
            if(this.var_589.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_54 == null || this.var_493 == null)
         {
            return;
         }
         var _loc2_:XML = this.var_54.getVisualizationXML(param1);
         var _loc3_:XML = this.var_54.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = this.var_54.getGraphicAssetCollection(param1);
         if(_loc2_ == null || _loc4_ == null)
         {
            return;
         }
         var _loc5_:String = this.var_54.getVisualizationType(param1);
         var _loc6_:String = this.var_54.getLogicType(param1);
         var _loc7_:IRoomObjectVisualizationData = this.var_493.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_114.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_114.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_114.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_493.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_588.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_157 != null)
                              {
                                 this.var_157.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_114.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_114.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
