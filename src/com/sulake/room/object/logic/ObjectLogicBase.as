package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_370:IRoomObjectController;
      ...
      {
         if(this.var_370 == param1)
         {
            return;
         }
         if(this.var_370 != null)
         {
            this.var_370.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_370 = param1;
            this.var_370.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_370 != null)
            {
               this.var_370.setLocation(param1.loc);
               this.var_370.setDirection(param1.dir);
            }
         }
      }
