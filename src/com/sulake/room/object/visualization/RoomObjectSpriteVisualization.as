package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_370:IRoomObject;
      
      private var var_816:IGraphicAssetCollection;
      
      protected var var_489:int = -1;
      
      protected var var_155:int = -1;
      
      protected var var_94:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_213.length > 0)
            {
               _loc1_ = this.var_213[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_816.removeReference();
         }
         this.var_816 = param1;
         if(this.var_816 != null)
         {
            this.var_816.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_213.length > param1)
         {
            _loc2_ = this.var_213[this.var_213.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         this.var_489 = 4294967295;
         this.var_155 = 4294967295;
         this.var_94 = -1;
      }
