package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1507:int = 50;
      
      private static const const_1071:Number = 60;
      
      private static const const_1508:Number = 50;
      ...
      private var var_260:BitmapDataCache;
      
      private var var_633:RoomObjectCache;
      
      private var var_526:Array;
      
      private var var_628:Array;
      
      private var var_1493:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2563:Number = -1.0E7;
      ...
      private var var_632:Matrix;
      
      private var var_498:Number = 0.0;
      ...
      private var var_2566:Array;
      
      private var var_783:int = 0;
      
      private var var_1852:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_259 = new Sprite();
         this.var_259.mouseEnabled = false;
         this.var_103 = new Sprite();
         this.var_103.name = "canvas";
         this.var_103.mouseEnabled = false;
         this.var_259.addChild(this.var_103);
         ...
         this.var_260 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_633 = new RoomObjectCache(_loc6_);
         this.var_810 = new ColorTransform();
         this.var_632 = new Matrix();
      ...
      {
         this.var_525.x -= param1 - this.var_631;
         this.var_631 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_525.y -= param1 - this.var_629;
         this.var_629 = param1;
      }
      ...
      {
         if(param1 && !this.var_1061)
         {
            this.var_1061 = true;
            if(this.var_138 != null && !this.var_259.contains(this.var_138))
            {
               this.var_259.addChild(this.var_138);
               this.var_103.mask = this.var_138;
            }
         }
         else if(!param1 && this.var_1061)
         {
            this.var_1061 = false;
            if(this.var_138 != null && this.var_259.contains(this.var_138))
            {
               this.var_259.removeChild(this.var_138);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_259.numChildren > 0)
            {
               this.var_259.removeChildAt(0);
            }
            this.var_259 = null;
         }
         this.var_103 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_628.length)
            {
               this.cleanSprite(this.var_628[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_628 = [];
         }
      ...
      {
         this.var_633.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1853 = !this.var_1853;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1494)
         {
            return;
         }
         this.calculateUpdateInterval(param1);
         this.var_260.compress();
         ...
         if(this.var_524 != this.var_2568 || this.var_523 != this.var_2564)
         {
            _loc8_ = true;
         }
         if(this.var_103.x != this.var_631 || this.var_103.y != this.var_629)
         {
            this.var_103.x = this.var_631;
            this.var_103.y = this.var_629;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2568 = this.var_524;
         this.var_2564 = this.var_523;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1494 > 0)
         {
            _loc2_ = param1 - this.var_1494;
            if(_loc2_ > const_1071 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2562 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_784;
               if(this.var_784 == const_366 + 1)
               {
                  this.var_498 = _loc2_;
                  this.var_1852 = this.var_2567;
               }
               else if(this.var_784 > const_366 + 1)
               {
                  _loc3_ = Number(this.var_784 - const_366);
                  this.var_498 = this.var_498 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1852 = this.var_1852 * (_loc3_ - 1) / _loc3_ + Number(this.var_2567) / _loc3_;
                  if(this.var_784 > const_366 + const_1507)
                  {
                     this.var_784 = const_366;
                     if(!this.var_1209 && this.var_498 > const_1071)
                     {
                        this.var_1209 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1209 && this.var_498 < const_1508)
                     {
                        this.var_1209 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_633.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_633.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1853 && this.var_1209);
         ...
         _loc13_ += int(this.var_524 / 2);
         _loc14_ += int(this.var_523 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_631;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_629;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_631;
                     _loc17_.y = _loc20_ - this.var_629;
      ...
      {
         if(param1 < this.var_524 && param1 + param3 >= 0 && (param2 < this.var_523 && param2 + param4 >= 0))
         {
            if(!this.var_2984)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_524)
         {
            param3 -= this.var_524 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_523)
         {
            param4 -= this.var_523 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2566)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_987)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_628.length > 0)
         {
            _loc3_ = this.var_628.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_987)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_260.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_260.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_260.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_632.identity();
            if(flipH)
            {
               this.var_632.scale(-1,1);
               this.var_632.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_632.scale(1,-1);
               this.var_632.translate(0,data.height);
            }
            finalData.draw(data,this.var_632);
            if(name.length > 0)
            {
               this.var_260.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_681);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_810.redMultiplier = tR;
            this.var_810.greenMultiplier = tG;
            this.var_810.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_810);
            if(name.length > 0)
            {
               this.var_260.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1208 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1851;
         }
         this.var_1851 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1208;
         return this.var_1851;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_524 / 2;
         var _loc12_:Number = param2 - this.var_523 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1854,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_630.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_630.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2565 || param2 != this.var_2563)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_630.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_630.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_363 != null && param1 != null)
         {
            this.var_363.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_363 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_363.length)
         {
            _loc2_ = this.var_363.getKey(_loc1_);
            _loc3_ = this.var_363.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               _loc4_ = this._container.getRoomObject(_loc2_);
               if(_loc4_ != null)
               {
                  if(this.var_1493 != null)
                  {
                     this.var_1493.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
