package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1618:int = 128;
      
      private var var_1617:Boolean = false;
      
      private var var_3001:Point;
      ...
      {
         if(param1 != this.var_2091 || param2 != this.var_2090)
         {
      ...
      {
         if(this.var_1618 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_282 || param2 >= this._height)
         {
            return false;
         }
