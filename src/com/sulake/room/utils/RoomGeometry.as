package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_864:Number = 64;
      
      public static const const_1263:Number = 32;
      ...
      private var var_457:Number = 1.0;
      
      private var var_456:Number = 1.0;
      
      private var var_453:Number = 1.0;
      ...
      private var var_2996:Number = -500.0;
      
      private var var_2997:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1298 = new Vector3d();
         this.var_455 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1299 = new Vector3d();
         this.var_2012 = 1;
         this.var_2013 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2014 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_455.assign(this.var_98);
         this.var_455.x *= this.var_457;
         this.var_455.y *= this.var_456;
         this.var_455.z *= this.var_453;
         return this.var_455;
      }
      ...
      {
         if(this.var_457 != param1 * this.var_2012)
         {
            this.var_457 = param1 * this.var_2012;
            ++this.var_173;
         }
      }
      ...
      {
         if(this.var_456 != param1 * this.var_2013)
         {
            this.var_456 = param1 * this.var_2013;
            ++this.var_173;
         }
      }
      ...
      {
         if(this.var_453 != param1 * this.var_2014)
         {
            this.var_453 = param1 * this.var_2014;
            ++this.var_173;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_98.x;
         var _loc3_:Number = this.var_98.y;
         var _loc4_:Number = this.var_98.z;
         this.var_98.assign(param1);
         this.var_98.x /= this.var_457;
         this.var_98.y /= this.var_456;
         this.var_98.z /= this.var_453;
         if(this.var_98.x != _loc2_ || this.var_98.y != _loc3_ || this.var_98.z != _loc4_)
         {
            ++this.var_173;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_454.x;
         var _loc3_:Number = this.var_454.y;
         var _loc4_:Number = this.var_454.z;
         this.var_454.assign(param1);
         this._direction.assign(param1);
         if(this.var_454.x != _loc2_ || this.var_454.y != _loc3_ || this.var_454.z != _loc4_)
         {
            ++this.var_173;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_158.assign(_loc25_);
            this.var_1298.assign(this.var_158);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_159.assign(_loc19_);
            this.var_158.assign(_loc20_);
            this.var_1298.assign(this.var_158);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_553 != null)
         {
            ...
            this.var_553.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_553.add(_loc3_,_loc4_);
            ++this.var_173;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_553 != null)
         {
            ...
            return this.var_553.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1299.assign(_loc22_);
         }
         else
         {
            this.var_1299.assign(_loc17_);
         }
         ++this.var_173;
      }
      ...
      {
         if(param1 == null || this.var_158 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_158,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_158);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_98);
         _loc2_.x *= this.var_457;
         _loc2_.y *= this.var_456;
         _loc2_.z *= this.var_453;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1299);
         if(_loc3_ < this.var_2996 || _loc3_ > this.var_2997)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_98);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_457;
            _loc2_.y *= this.var_456;
            _loc2_.z *= this.var_453;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1299);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_159,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_98.x * this.var_457,this.var_98.y * this.var_456,this.var_98.z * this.var_453);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_158;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_457,param2.y * this.var_456,param2.z * this.var_453);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_457,param3.y * this.var_456,param3.z * this.var_453);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_457,param4.y * this.var_456,param4.z * this.var_453);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1263;
         }
         else
         {
            this.scale = const_864;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_864;
      }
