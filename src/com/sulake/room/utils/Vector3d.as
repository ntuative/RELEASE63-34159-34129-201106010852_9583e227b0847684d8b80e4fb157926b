package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_159 * this.var_159 + this.var_158 * this.var_158);
         }
         return this._length;
      }
      ...
      {
         this._x = -this._x;
         this.var_159 = -this.var_159;
         this.var_158 = -this.var_158;
      }
      ...
      {
         return "(" + [this._x,this.var_159,this.var_158].join(",") + ")";
      }
   }
}
